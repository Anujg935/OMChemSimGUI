...
def main():
	comp = ['Hydrogen', 'Acetylene']
	MatStm1 = MatStm(name='MatStm1',CompNames=comp,T=330,P=101325,MolFlow=90,CompMolFrac=[0.6,0.4])
	MatStm2 = MatStm(name='MatStm2',CompNames=comp,T=270,P=101325,MolFlow=100,CompMolFrac=[0.5,0.5])
	MatStm3 = MatStm(name='MatStm3',CompNames=comp,T=290,P=101325,MolFlow=80,CompMolFrac=[0.1,0.9])
