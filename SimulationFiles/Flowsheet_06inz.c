...
vars: {MatStm2._totMolFlo[3], MatStm2._compMolFrac[2,1], MatStm2._compMolFrac[3,2], Cooler1._outT, MatStm2._compMolFrac[3,1], MatStm2._compMolFrac[2,2]}
...
equation index: 180
type: SIMPLE_ASSIGN
Cooler1._heatRem = 200000.0
*/
void Flowsheet_eqFunction_180(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,180};
  data->localData[0]->realVars[5] /* Cooler1.heatRem variable */ = 200000.0;
  TRACE_POP
}
OMC_DISABLE_OPT
void Flowsheet_functionInitialEquations_0(DATA *data, threadData_t *threadData)
