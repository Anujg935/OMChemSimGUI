...
equation index: 16
type: SIMPLE_ASSIGN
MatStm2._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm2.comp[2].VP[1], MatStm2.comp[2].VP[2], MatStm2.comp[2].VP[3], MatStm2.comp[2].VP[4], MatStm2.comp[2].VP[5], MatStm2.comp[2].VP[6]}, 321.0)
*/
void Flowsheet_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[104] /* MatStm2.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp0, 321.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_17(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[96] /* MatStm2.K[2] variable */ = (9.869232667160129e-006) * (data->localData[0]->realVars[104] /* MatStm2.Psat[2] variable */);
  TRACE_POP
}
...
equation index: 18
type: SIMPLE_ASSIGN
MatStm2._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm2.comp[1].VP[1], MatStm2.comp[1].VP[2], MatStm2.comp[1].VP[3], MatStm2.comp[1].VP[4], MatStm2.comp[1].VP[5], MatStm2.comp[1].VP[6]}, 321.0)
*/
void Flowsheet_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[103] /* MatStm2.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp1, 321.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_19(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[95] /* MatStm2.K[1] variable */ = (9.869232667160129e-006) * (data->localData[0]->realVars[103] /* MatStm2.Psat[1] variable */);
  TRACE_POP
}
...
void Flowsheet_eqFunction_20(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[123] /* MatStm2.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[407], tmp2, tmp3, data->simulationInfo->realParameter[417], 321.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[121] /* MatStm2.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[407], tmp4, tmp5, data->simulationInfo->realParameter[417], 321.0);
  TRACE_POP
}
...
equation index: 22
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm2.comp[2].VapCp[1], MatStm2.comp[2].VapCp[2], MatStm2.comp[2].VapCp[3], MatStm2.comp[2].VapCp[4], MatStm2.comp[2].VapCp[5], MatStm2.comp[2].VapCp[6]}, 321.0)
*/
void Flowsheet_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[147] /* MatStm2.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp6, 321.0);
  TRACE_POP
}
...
equation index: 23
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm2.comp[2].LiqCp[1], MatStm2.comp[2].LiqCp[2], MatStm2.comp[2].LiqCp[3], MatStm2.comp[2].LiqCp[4], MatStm2.comp[2].LiqCp[5], MatStm2.comp[2].LiqCp[6]}, 321.0)
*/
void Flowsheet_eqFunction_23(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[145] /* MatStm2.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp7, 321.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[122] /* MatStm2.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[406], tmp8, tmp9, data->simulationInfo->realParameter[416], 321.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_25(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[120] /* MatStm2.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[406], tmp10, tmp11, data->simulationInfo->realParameter[416], 321.0);
  TRACE_POP
}
...
equation index: 26
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm2.comp[1].VapCp[1], MatStm2.comp[1].VapCp[2], MatStm2.comp[1].VapCp[3], MatStm2.comp[1].VapCp[4], MatStm2.comp[1].VapCp[5], MatStm2.comp[1].VapCp[6]}, 321.0)
*/
void Flowsheet_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[146] /* MatStm2.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp12, 321.0);
  TRACE_POP
}
...
equation index: 27
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm2.comp[1].LiqCp[1], MatStm2.comp[1].LiqCp[2], MatStm2.comp[1].LiqCp[3], MatStm2.comp[1].LiqCp[4], MatStm2.comp[1].LiqCp[5], MatStm2.comp[1].LiqCp[6]}, 321.0)
*/
void Flowsheet_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[144] /* MatStm2.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp13, 321.0);
  TRACE_POP
}
...
equation index: 28
type: SIMPLE_ASSIGN
MatStm1._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm1.comp[2].VP[1], MatStm1.comp[2].VP[2], MatStm1.comp[2].VP[3], MatStm1.comp[2].VP[4], MatStm1.comp[2].VP[5], MatStm1.comp[2].VP[6]}, 280.0)
*/
void Flowsheet_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[14] /* MatStm1.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp14, 280.0);
  TRACE_POP
}
...
equation index: 30
type: SIMPLE_ASSIGN
MatStm1._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm1.comp[1].VP[1], MatStm1.comp[1].VP[2], MatStm1.comp[1].VP[3], MatStm1.comp[1].VP[4], MatStm1.comp[1].VP[5], MatStm1.comp[1].VP[6]}, 280.0)
*/
void Flowsheet_eqFunction_30(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[13] /* MatStm1.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp15, 280.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_32(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[33] /* MatStm1.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[249], tmp16, tmp17, data->simulationInfo->realParameter[259], 280.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_33(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[31] /* MatStm1.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[249], tmp18, tmp19, data->simulationInfo->realParameter[259], 280.0);
  TRACE_POP
}
...
equation index: 34
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm1.comp[2].VapCp[1], MatStm1.comp[2].VapCp[2], MatStm1.comp[2].VapCp[3], MatStm1.comp[2].VapCp[4], MatStm1.comp[2].VapCp[5], MatStm1.comp[2].VapCp[6]}, 280.0)
*/
void Flowsheet_eqFunction_34(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[57] /* MatStm1.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp20, 280.0);
  TRACE_POP
}
...
equation index: 35
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm1.comp[2].LiqCp[1], MatStm1.comp[2].LiqCp[2], MatStm1.comp[2].LiqCp[3], MatStm1.comp[2].LiqCp[4], MatStm1.comp[2].LiqCp[5], MatStm1.comp[2].LiqCp[6]}, 280.0)
*/
void Flowsheet_eqFunction_35(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[55] /* MatStm1.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp21, 280.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[32] /* MatStm1.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[248], tmp22, tmp23, data->simulationInfo->realParameter[258], 280.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_37(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[30] /* MatStm1.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[248], tmp24, tmp25, data->simulationInfo->realParameter[258], 280.0);
  TRACE_POP
}
...
equation index: 38
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm1.comp[1].VapCp[1], MatStm1.comp[1].VapCp[2], MatStm1.comp[1].VapCp[3], MatStm1.comp[1].VapCp[4], MatStm1.comp[1].VapCp[5], MatStm1.comp[1].VapCp[6]}, 280.0)
*/
void Flowsheet_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[56] /* MatStm1.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp26, 280.0);
  TRACE_POP
}
...
equation index: 39
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm1.comp[1].LiqCp[1], MatStm1.comp[1].LiqCp[2], MatStm1.comp[1].LiqCp[3], MatStm1.comp[1].LiqCp[4], MatStm1.comp[1].LiqCp[5], MatStm1.comp[1].LiqCp[6]}, 280.0)
*/
void Flowsheet_eqFunction_39(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[54] /* MatStm1.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp27, 280.0);
  TRACE_POP
}
...
equation index: 40
type: SIMPLE_ASSIGN
MatStm1._compMolFrac[1,1] = 0.2
*/
void Flowsheet_eqFunction_40(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,40};
  data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */ = 0.2;
  TRACE_POP
}
...
equation index: 41
type: SIMPLE_ASSIGN
MatStm1._compMolFlo[1,1] = 80.0 * MatStm1.compMolFrac[1,1]
*/
void Flowsheet_eqFunction_41(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,41};
  data->localData[0]->realVars[40] /* MatStm1.compMolFlo[1,1] variable */ = (80.0) * (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
void Flowsheet_eqFunction_42(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[16] /* MatStm1.compMasFlo[1,1] variable */ = (data->localData[0]->realVars[40] /* MatStm1.compMolFlo[1,1] variable */) * (data->simulationInfo->realParameter[242]);
  TRACE_POP
}
...
equation index: 43
type: SIMPLE_ASSIGN
MatStm1._compMolFrac[1,2] = 0.8
*/
void Flowsheet_eqFunction_43(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,43};
  data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */ = 0.8;
  TRACE_POP
}
...
equation index: 44
type: SIMPLE_ASSIGN
MatStm1._compMolFlo[1,2] = 80.0 * MatStm1.compMolFrac[1,2]
*/
void Flowsheet_eqFunction_44(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,44};
  data->localData[0]->realVars[41] /* MatStm1.compMolFlo[1,2] variable */ = (80.0) * (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
void Flowsheet_eqFunction_45(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[17] /* MatStm1.compMasFlo[1,2] variable */ = (data->localData[0]->realVars[41] /* MatStm1.compMolFlo[1,2] variable */) * (data->simulationInfo->realParameter[243]);
  TRACE_POP
}
...
equation index: 46
type: SIMPLE_ASSIGN
MatStm1._Pbubl = MatStm1.compMolFrac[1,1] * exp(MatStm1.comp[1].VP[2] + MatStm1.comp[1].VP[3] / 280.0 + MatStm1.comp[1].VP[4] * 5.634789603169249 + MatStm1.comp[1].VP[5] * 280.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp(MatStm1.comp[2].VP[2] + MatStm1.comp[2].VP[3] / 280.0 + MatStm1.comp[2].VP[4] * 5.634789603169249 + MatStm1.comp[2].VP[5] * 280.0 ^ MatStm1.comp[2].VP[6])
*/
void Flowsheet_eqFunction_46(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */ = (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) * (exp(data->simulationInfo->realParameter[267] + DIVISION_SIM(data->simulationInfo->realParameter[268],280.0,"280.0",equationIndexes) + (data->simulationInfo->realParameter[269]) * (5.634789603169249) + (data->simulationInfo->realParameter[270]) * (tmp30))) + (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) * (exp(data->simulationInfo->realParameter[273] + DIVISION_SIM(data->simulationInfo->realParameter[274],280.0,"280.0",equationIndexes) + (data->simulationInfo->realParameter[275]) * (5.634789603169249) + (data->simulationInfo->realParameter[276]) * (tmp37)));
  TRACE_POP
}
...
equation index: 47
type: SIMPLE_ASSIGN
MatStm1._Pdew = 1.0 / (MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 280.0 - MatStm1.comp[1].VP[4] * 5.634789603169249 - MatStm1.comp[1].VP[5] * 280.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 280.0 - MatStm1.comp[2].VP[4] * 5.634789603169249 - MatStm1.comp[2].VP[5] * 280.0 ^ MatStm1.comp[2].VP[6]))
*/
void Flowsheet_eqFunction_47(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[12] /* MatStm1.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[267]) - (DIVISION_SIM(data->simulationInfo->realParameter[268],280.0,"280.0",equationIndexes)) - ((data->simulationInfo->realParameter[269]) * (5.634789603169249)) - ((data->simulationInfo->realParameter[270]) * (tmp44)))) + (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[273]) - (DIVISION_SIM(data->simulationInfo->realParameter[274],280.0,"280.0",equationIndexes)) - ((data->simulationInfo->realParameter[275]) * (5.634789603169249)) - ((data->simulationInfo->realParameter[276]) * (tmp51)))),"MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 280.0 - MatStm1.comp[1].VP[4] * 5.634789603169249 - MatStm1.comp[1].VP[5] * 280.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 280.0 - MatStm1.comp[2].VP[4] * 5.634789603169249 - MatStm1.comp[2].VP[5] * 280.0 ^ MatStm1.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
void Flowsheet_eqFunction_48(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */ = 0.2;
  TRACE_POP
}
...
equation index: 49
type: SIMPLE_ASSIGN
MatStm2._compMolFlo[1,1] = 70.0 * MatStm2.compMolFrac[1,1]
*/
void Flowsheet_eqFunction_49(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,49};
  data->localData[0]->realVars[130] /* MatStm2.compMolFlo[1,1] variable */ = (70.0) * (data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
equation index: 51
type: SIMPLE_ASSIGN
MatStm3._compMolFrac[1,1] = 0.5333333333333333 * MatStm1.compMolFrac[1,1] + 0.4666666666666667 * MatStm2.compMolFrac[1,1]
*/
void Flowsheet_eqFunction_51(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,51};
  data->localData[0]->realVars[226] /* MatStm3.compMolFrac[1,1] variable */ = (0.5333333333333333) * (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) + (0.4666666666666667) * (data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
void Flowsheet_eqFunction_52(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */ = 0.8;
  TRACE_POP
}
...
equation index: 53
type: SIMPLE_ASSIGN
MatStm2._compMolFlo[1,2] = 70.0 * MatStm2.compMolFrac[1,2]
*/
void Flowsheet_eqFunction_53(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,53};
  data->localData[0]->realVars[131] /* MatStm2.compMolFlo[1,2] variable */ = (70.0) * (data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
equation index: 55
type: SIMPLE_ASSIGN
MatStm2._Pbubl = MatStm2.compMolFrac[1,1] * exp(MatStm2.comp[1].VP[2] + MatStm2.comp[1].VP[3] / 321.0 + MatStm2.comp[1].VP[4] * 5.771441123130016 + MatStm2.comp[1].VP[5] * 321.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp(MatStm2.comp[2].VP[2] + MatStm2.comp[2].VP[3] / 321.0 + MatStm2.comp[2].VP[4] * 5.771441123130016 + MatStm2.comp[2].VP[5] * 321.0 ^ MatStm2.comp[2].VP[6])
*/
void Flowsheet_eqFunction_55(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp69;
  tmp56 = 321.0;
  tmp57 = data->simulationInfo->realParameter[429];
  ...
  tmp64 = data->simulationInfo->realParameter[435];
  ...
  data->localData[0]->realVars[101] /* MatStm2.Pbubl variable */ = (data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */) * (exp(data->simulationInfo->realParameter[425] + DIVISION_SIM(data->simulationInfo->realParameter[426],321.0,"321.0",equationIndexes) + (data->simulationInfo->realParameter[427]) * (5.771441123130016) + (data->simulationInfo->realParameter[428]) * (tmp58))) + (data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */) * (exp(data->simulationInfo->realParameter[431] + DIVISION_SIM(data->simulationInfo->realParameter[432],321.0,"321.0",equationIndexes) + (data->simulationInfo->realParameter[433]) * (5.771441123130016) + (data->simulationInfo->realParameter[434]) * (tmp65)));
  TRACE_POP
}
...
equation index: 56
type: SIMPLE_ASSIGN
MatStm2._Pdew = 1.0 / (MatStm2.compMolFrac[1,1] * exp((-MatStm2.comp[1].VP[2]) - MatStm2.comp[1].VP[3] / 321.0 - MatStm2.comp[1].VP[4] * 5.771441123130016 - MatStm2.comp[1].VP[5] * 321.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp((-MatStm2.comp[2].VP[2]) - MatStm2.comp[2].VP[3] / 321.0 - MatStm2.comp[2].VP[4] * 5.771441123130016 - MatStm2.comp[2].VP[5] * 321.0 ^ MatStm2.comp[2].VP[6]))
*/
void Flowsheet_eqFunction_56(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp83;
  tmp70 = 321.0;
  tmp71 = data->simulationInfo->realParameter[429];
  ...
  tmp78 = data->simulationInfo->realParameter[435];
  ...
  data->localData[0]->realVars[102] /* MatStm2.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[425]) - (DIVISION_SIM(data->simulationInfo->realParameter[426],321.0,"321.0",equationIndexes)) - ((data->simulationInfo->realParameter[427]) * (5.771441123130016)) - ((data->simulationInfo->realParameter[428]) * (tmp72)))) + (data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[431]) - (DIVISION_SIM(data->simulationInfo->realParameter[432],321.0,"321.0",equationIndexes)) - ((data->simulationInfo->realParameter[433]) * (5.771441123130016)) - ((data->simulationInfo->realParameter[434]) * (tmp79)))),"MatStm2.compMolFrac[1,1] * exp((-MatStm2.comp[1].VP[2]) - MatStm2.comp[1].VP[3] / 321.0 - MatStm2.comp[1].VP[4] * 5.771441123130016 - MatStm2.comp[1].VP[5] * 321.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp((-MatStm2.comp[2].VP[2]) - MatStm2.comp[2].VP[3] / 321.0 - MatStm2.comp[2].VP[4] * 5.771441123130016 - MatStm2.comp[2].VP[5] * 321.0 ^ MatStm2.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
equation index: 57
type: SIMPLE_ASSIGN
MatStm3._compMolFrac[1,2] = 0.5333333333333333 * MatStm1.compMolFrac[1,2] + 0.4666666666666667 * MatStm2.compMolFrac[1,2]
*/
void Flowsheet_eqFunction_57(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,57};
  data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,2] variable */ = (0.5333333333333333) * (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) + (0.4666666666666667) * (data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */);
  TRACE_POP
}

void Flowsheet_eqFunction_58(DATA*, threadData_t*);
void Flowsheet_eqFunction_59(DATA*, threadData_t*);
...
vars: {MatStm1._totMolFlo[2], MatStm1._compMolFrac[2,1], MatStm1._compMolFrac[2,2], MatStm1._compMolFrac[3,1], MatStm1._compMolFrac[3,2]}
eqns: {58, 59, 60, 61, 62, 63, 64, 69, 68, 67, 66, 65}
*/
void Flowsheet_eqFunction_82(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[0] = data->localData[0]->realVars[90] /* MatStm1.totMolFlo[2] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[1] = data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[2] = data->localData[0]->realVars[49] /* MatStm1.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[3] = data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[4] = data->localData[0]->realVars[51] /* MatStm1.compMolFrac[3,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[90] /* MatStm1.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[0];
  data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[1];
  data->localData[0]->realVars[49] /* MatStm1.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[2];
  data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[3];
  data->localData[0]->realVars[51] /* MatStm1.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[4];
  TRACE_POP
}
...
void Flowsheet_eqFunction_111(DATA *data, threadData_t *threadData)
{
  ...
  if (retValue > 0){
    ...
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving linear system 111 failed at time=%.15g.\nFor more information please use -lv LOG_LS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
eqns: {112, 113, 114, 115, 116, 117, 118, 123, 122, 121, 120, 119}
*/
void Flowsheet_eqFunction_136(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 136 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[0] = data->localData[0]->realVars[181] /* MatStm2.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[1] = data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[2] = data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[3] = data->localData[0]->realVars[138] /* MatStm2.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[4] = data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,2] variable */;
  retValue = solve_nonlinear_system(data, threadData, 1);
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,136};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 136 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
  data->localData[0]->realVars[181] /* MatStm2.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[0];
  data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[1];
  data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[2];
  data->localData[0]->realVars[138] /* MatStm2.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[3];
  data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[4];
  TRACE_POP
}
...
vars: {MatStm3._totMolFlo[3], MatStm3._compMolFrac[2,2], MatStm3._compMolFrac[3,2], MatStm3._compMolFrac[2,1], MatStm3._compMolFrac[3,1], MatStm3._T}
...
void Flowsheet_eqFunction_198(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[0] = data->localData[0]->realVars[271] /* MatStm3.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[1] = data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[2] = data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[3] = data->localData[0]->realVars[228] /* MatStm3.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[4] = data->localData[0]->realVars[230] /* MatStm3.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[5] = data->localData[0]->realVars[195] /* MatStm3.T variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[271] /* MatStm3.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[0];
  data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[1];
  data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[2];
  data->localData[0]->realVars[228] /* MatStm3.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[3];
  data->localData[0]->realVars[230] /* MatStm3.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[4];
  data->localData[0]->realVars[195] /* MatStm3.T variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[5];
  TRACE_POP
}
...
void Flowsheet_eqFunction_219(DATA *data, threadData_t *threadData)
{
  ...
  if(!(((tmp8 > 0) && (tmp7 > tmp9)) || ((tmp8 < 0) && (tmp7 < tmp9))))
  {
    ...
    for($Pi = ((modelica_integer) 1); in_range_integer($Pi, tmp7, tmp9); $Pi += tmp8)
    {
      ...
      create_index_spec(&tmp5, 1, (1), (int*)0, 'W');
      real_array_create(&tmp6, (modelica_real*)&data->localData[0]->realVars[187] /* MatStm3.MW[1] variable */, 1, 3);
      indexed_assign_real_array(tmp4, &tmp6, &tmp5);
    }
  }
  TRACE_POP
...
void Flowsheet_eqFunction_226(DATA *data, threadData_t *threadData)
{
  ...
  /* write solution */
  data->localData[0]->realVars[204] /* MatStm3.compMasFrac[2,1] variable */ = aux_x[0];
...
equation index: 227
type: SIMPLE_ASSIGN
MatStm3._totMolFlo[1] = 150.0
*/
void Flowsheet_eqFunction_227(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,227};
  data->localData[0]->realVars[269] /* MatStm3.totMolFlo[1] variable */ = 150.0;
  TRACE_POP
}
...
void Flowsheet_eqFunction_228(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[190] /* MatStm3.P variable */ = 101325.0;
  TRACE_POP
}
...
void Flowsheet_eqFunction_272(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[15] /* MatStm1.T variable */ = 280.0;
  TRACE_POP
}
...
equation index: 273
type: SIMPLE_ASSIGN
MatStm1._totMolFlo[1] = 80.0
*/
void Flowsheet_eqFunction_273(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,273};
  data->localData[0]->realVars[89] /* MatStm1.totMolFlo[1] variable */ = 80.0;
  TRACE_POP
}
...
void Flowsheet_eqFunction_274(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[100] /* MatStm2.P variable */ = 101325.0;
  TRACE_POP
}
...
void Flowsheet_eqFunction_275(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[105] /* MatStm2.T variable */ = 321.0;
  TRACE_POP
}
...
equation index: 276
type: SIMPLE_ASSIGN
MatStm2._totMolFlo[1] = 70.0
*/
void Flowsheet_eqFunction_276(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,276};
  data->localData[0]->realVars[179] /* MatStm2.totMolFlo[1] variable */ = 70.0;
  TRACE_POP
}
OMC_DISABLE_OPT
void Flowsheet_functionInitialEquations_0(DATA *data, threadData_t *threadData)
