...
void Flowsheet_eqFunction_20(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[214] /* MatStm3.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[565], tmp2, tmp3, data->simulationInfo->realParameter[575], 290.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[212] /* MatStm3.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[565], tmp4, tmp5, data->simulationInfo->realParameter[575], 290.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[213] /* MatStm3.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[564], tmp8, tmp9, data->simulationInfo->realParameter[574], 290.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_25(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[211] /* MatStm3.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[564], tmp10, tmp11, data->simulationInfo->realParameter[574], 290.0);
  TRACE_POP
}
...
equation index: 28
type: SIMPLE_ASSIGN
MatStm1._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm1.comp[2].VP[1], MatStm1.comp[2].VP[2], MatStm1.comp[2].VP[3], MatStm1.comp[2].VP[4], MatStm1.comp[2].VP[5], MatStm1.comp[2].VP[6]}, 330.0)
*/
void Flowsheet_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[14] /* MatStm1.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp14, 330.0);
  TRACE_POP
}
...
equation index: 30
type: SIMPLE_ASSIGN
MatStm1._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm1.comp[1].VP[1], MatStm1.comp[1].VP[2], MatStm1.comp[1].VP[3], MatStm1.comp[1].VP[4], MatStm1.comp[1].VP[5], MatStm1.comp[1].VP[6]}, 330.0)
*/
void Flowsheet_eqFunction_30(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[13] /* MatStm1.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp15, 330.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_32(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[33] /* MatStm1.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[249], tmp16, tmp17, data->simulationInfo->realParameter[259], 330.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_33(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[31] /* MatStm1.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[249], tmp18, tmp19, data->simulationInfo->realParameter[259], 330.0);
  TRACE_POP
}
...
equation index: 34
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm1.comp[2].VapCp[1], MatStm1.comp[2].VapCp[2], MatStm1.comp[2].VapCp[3], MatStm1.comp[2].VapCp[4], MatStm1.comp[2].VapCp[5], MatStm1.comp[2].VapCp[6]}, 330.0)
*/
void Flowsheet_eqFunction_34(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[57] /* MatStm1.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp20, 330.0);
  TRACE_POP
}
...
equation index: 35
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm1.comp[2].LiqCp[1], MatStm1.comp[2].LiqCp[2], MatStm1.comp[2].LiqCp[3], MatStm1.comp[2].LiqCp[4], MatStm1.comp[2].LiqCp[5], MatStm1.comp[2].LiqCp[6]}, 330.0)
*/
void Flowsheet_eqFunction_35(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[55] /* MatStm1.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp21, 330.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[32] /* MatStm1.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[248], tmp22, tmp23, data->simulationInfo->realParameter[258], 330.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_37(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[30] /* MatStm1.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[248], tmp24, tmp25, data->simulationInfo->realParameter[258], 330.0);
  TRACE_POP
}
...
equation index: 38
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm1.comp[1].VapCp[1], MatStm1.comp[1].VapCp[2], MatStm1.comp[1].VapCp[3], MatStm1.comp[1].VapCp[4], MatStm1.comp[1].VapCp[5], MatStm1.comp[1].VapCp[6]}, 330.0)
*/
void Flowsheet_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[56] /* MatStm1.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp26, 330.0);
  TRACE_POP
}
...
equation index: 39
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm1.comp[1].LiqCp[1], MatStm1.comp[1].LiqCp[2], MatStm1.comp[1].LiqCp[3], MatStm1.comp[1].LiqCp[4], MatStm1.comp[1].LiqCp[5], MatStm1.comp[1].LiqCp[6]}, 330.0)
*/
void Flowsheet_eqFunction_39(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[54] /* MatStm1.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp27, 330.0);
  TRACE_POP
}
...
equation index: 40
type: SIMPLE_ASSIGN
MatStm3._compMolFrac[1,1] = 0.1
*/
void Flowsheet_eqFunction_40(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,40};
  data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,1] variable */ = 0.1;
  TRACE_POP
}
...
void Flowsheet_eqFunction_41(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[221] /* MatStm3.compMolFlo[1,1] variable */ = (80.0) * (data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
void Flowsheet_eqFunction_42(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[197] /* MatStm3.compMasFlo[1,1] variable */ = (data->localData[0]->realVars[221] /* MatStm3.compMolFlo[1,1] variable */) * (data->simulationInfo->realParameter[558]);
  TRACE_POP
}
...
equation index: 43
type: SIMPLE_ASSIGN
MatStm3._compMolFrac[1,2] = 0.9
*/
void Flowsheet_eqFunction_43(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,43};
  data->localData[0]->realVars[228] /* MatStm3.compMolFrac[1,2] variable */ = 0.9;
  TRACE_POP
}
...
void Flowsheet_eqFunction_44(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[222] /* MatStm3.compMolFlo[1,2] variable */ = (80.0) * (data->localData[0]->realVars[228] /* MatStm3.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
void Flowsheet_eqFunction_45(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[198] /* MatStm3.compMasFlo[1,2] variable */ = (data->localData[0]->realVars[222] /* MatStm3.compMolFlo[1,2] variable */) * (data->simulationInfo->realParameter[559]);
  TRACE_POP
}
...
void Flowsheet_eqFunction_46(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp41;
  tmp28 = 290.0;
  tmp29 = data->simulationInfo->realParameter[587];
  ...
  data->localData[0]->realVars[192] /* MatStm3.Pbubl variable */ = (data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,1] variable */) * (exp(data->simulationInfo->realParameter[583] + DIVISION_SIM(data->simulationInfo->realParameter[584],290.0,"290.0",equationIndexes) + (data->simulationInfo->realParameter[585]) * (5.66988092298052) + (data->simulationInfo->realParameter[586]) * (tmp30))) + (data->localData[0]->realVars[228] /* MatStm3.compMolFrac[1,2] variable */) * (exp(data->simulationInfo->realParameter[589] + DIVISION_SIM(data->simulationInfo->realParameter[590],290.0,"290.0",equationIndexes) + (data->simulationInfo->realParameter[591]) * (5.66988092298052) + (data->simulationInfo->realParameter[592]) * (tmp37)));
  TRACE_POP
}
...
void Flowsheet_eqFunction_47(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp55;
  tmp42 = 290.0;
  tmp43 = data->simulationInfo->realParameter[587];
  ...
  tmp50 = data->simulationInfo->realParameter[593];
  ...
  data->localData[0]->realVars[193] /* MatStm3.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[583]) - (DIVISION_SIM(data->simulationInfo->realParameter[584],290.0,"290.0",equationIndexes)) - ((data->simulationInfo->realParameter[585]) * (5.66988092298052)) - ((data->simulationInfo->realParameter[586]) * (tmp44)))) + (data->localData[0]->realVars[228] /* MatStm3.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[589]) - (DIVISION_SIM(data->simulationInfo->realParameter[590],290.0,"290.0",equationIndexes)) - ((data->simulationInfo->realParameter[591]) * (5.66988092298052)) - ((data->simulationInfo->realParameter[592]) * (tmp51)))),"MatStm3.compMolFrac[1,1] * exp((-MatStm3.comp[1].VP[2]) - MatStm3.comp[1].VP[3] / 290.0 - MatStm3.comp[1].VP[4] * 5.66988092298052 - MatStm3.comp[1].VP[5] * 290.0 ^ MatStm3.comp[1].VP[6]) + MatStm3.compMolFrac[1,2] * exp((-MatStm3.comp[2].VP[2]) - MatStm3.comp[2].VP[3] / 290.0 - MatStm3.comp[2].VP[4] * 5.66988092298052 - MatStm3.comp[2].VP[5] * 290.0 ^ MatStm3.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
equation index: 49
type: SIMPLE_ASSIGN
MatStm1._compMolFlo[1,1] = 90.0 * MatStm1.compMolFrac[1,1]
*/
void Flowsheet_eqFunction_49(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,49};
  data->localData[0]->realVars[40] /* MatStm1.compMolFlo[1,1] variable */ = (90.0) * (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
equation index: 51
type: SIMPLE_ASSIGN
MatStm2._compMolFrac[1,1] = 0.4705882352941176 * MatStm3.compMolFrac[1,1] + 0.5294117647058824 * MatStm1.compMolFrac[1,1]
*/
void Flowsheet_eqFunction_51(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,51};
  data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */ = (0.4705882352941176) * (data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,1] variable */) + (0.5294117647058824) * (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
equation index: 53
type: SIMPLE_ASSIGN
MatStm1._compMolFlo[1,2] = 90.0 * MatStm1.compMolFrac[1,2]
*/
void Flowsheet_eqFunction_53(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,53};
  data->localData[0]->realVars[41] /* MatStm1.compMolFlo[1,2] variable */ = (90.0) * (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
equation index: 55
type: SIMPLE_ASSIGN
MatStm1._Pbubl = MatStm1.compMolFrac[1,1] * exp(MatStm1.comp[1].VP[2] + MatStm1.comp[1].VP[3] / 330.0 + MatStm1.comp[1].VP[4] * 5.799092654460526 + MatStm1.comp[1].VP[5] * 330.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp(MatStm1.comp[2].VP[2] + MatStm1.comp[2].VP[3] / 330.0 + MatStm1.comp[2].VP[4] * 5.799092654460526 + MatStm1.comp[2].VP[5] * 330.0 ^ MatStm1.comp[2].VP[6])
*/
void Flowsheet_eqFunction_55(DATA *data, threadData_t *threadData)
{
  ...
  tmp64 = data->simulationInfo->realParameter[277];
  ...
  data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */ = (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) * (exp(data->simulationInfo->realParameter[267] + DIVISION_SIM(data->simulationInfo->realParameter[268],330.0,"330.0",equationIndexes) + (data->simulationInfo->realParameter[269]) * (5.799092654460526) + (data->simulationInfo->realParameter[270]) * (tmp58))) + (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) * (exp(data->simulationInfo->realParameter[273] + DIVISION_SIM(data->simulationInfo->realParameter[274],330.0,"330.0",equationIndexes) + (data->simulationInfo->realParameter[275]) * (5.799092654460526) + (data->simulationInfo->realParameter[276]) * (tmp65)));
  TRACE_POP
}
...
equation index: 56
type: SIMPLE_ASSIGN
MatStm1._Pdew = 1.0 / (MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 330.0 - MatStm1.comp[1].VP[4] * 5.799092654460526 - MatStm1.comp[1].VP[5] * 330.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 330.0 - MatStm1.comp[2].VP[4] * 5.799092654460526 - MatStm1.comp[2].VP[5] * 330.0 ^ MatStm1.comp[2].VP[6]))
*/
void Flowsheet_eqFunction_56(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp83;
  tmp70 = 330.0;
  tmp71 = data->simulationInfo->realParameter[271];
  ...
  tmp78 = data->simulationInfo->realParameter[277];
  ...
  data->localData[0]->realVars[12] /* MatStm1.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[267]) - (DIVISION_SIM(data->simulationInfo->realParameter[268],330.0,"330.0",equationIndexes)) - ((data->simulationInfo->realParameter[269]) * (5.799092654460526)) - ((data->simulationInfo->realParameter[270]) * (tmp72)))) + (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[273]) - (DIVISION_SIM(data->simulationInfo->realParameter[274],330.0,"330.0",equationIndexes)) - ((data->simulationInfo->realParameter[275]) * (5.799092654460526)) - ((data->simulationInfo->realParameter[276]) * (tmp79)))),"MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 330.0 - MatStm1.comp[1].VP[4] * 5.799092654460526 - MatStm1.comp[1].VP[5] * 330.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 330.0 - MatStm1.comp[2].VP[4] * 5.799092654460526 - MatStm1.comp[2].VP[5] * 330.0 ^ MatStm1.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
equation index: 57
type: SIMPLE_ASSIGN
MatStm2._compMolFrac[1,2] = 0.4705882352941176 * MatStm3.compMolFrac[1,2] + 0.5294117647058824 * MatStm1.compMolFrac[1,2]
*/
void Flowsheet_eqFunction_57(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,57};
  data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */ = (0.4705882352941176) * (data->localData[0]->realVars[228] /* MatStm3.compMolFrac[1,2] variable */) + (0.5294117647058824) * (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
void Flowsheet_eqFunction_140(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[1] = data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[2] = data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[3] = data->localData[0]->realVars[232] /* MatStm3.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[4] = data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */;
  ...
  data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[1];
  data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[2];
  data->localData[0]->realVars[232] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[3];
  data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[4];
  TRACE_POP
}
...
vars: {MatStm2._totMolFlo[2], MatStm2._T, MatStm2._compMolFrac[3,2], MatStm2._compMolFrac[2,1], MatStm2._compMolFrac[3,1], MatStm2._compMolFrac[2,2]}
...
void Flowsheet_eqFunction_198(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[0] = data->localData[0]->realVars[180] /* MatStm2.totMolFlo[2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[1] = data->localData[0]->realVars[105] /* MatStm2.T variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[2] = data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[3] = data->localData[0]->realVars[138] /* MatStm2.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[4] = data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[5] = data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[180] /* MatStm2.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[0];
  data->localData[0]->realVars[105] /* MatStm2.T variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[1];
  data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[2];
  data->localData[0]->realVars[138] /* MatStm2.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[3];
  data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[4];
  data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[5];
  TRACE_POP
}
...
void Flowsheet_eqFunction_210(DATA *data, threadData_t *threadData)
{
  ...
  /* write solution */
  data->localData[0]->realVars[114] /* MatStm2.compMasFrac[2,1] variable */ = aux_x[0];
  data->localData[0]->realVars[112] /* MatStm2.compMasFrac[1,1] variable */ = aux_x[1];
  data->localData[0]->realVars[116] /* MatStm2.compMasFrac[3,1] variable */ = aux_x[2];
...
equation index: 227
type: SIMPLE_ASSIGN
MatStm2._totMolFlo[1] = 170.0
*/
void Flowsheet_eqFunction_227(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,227};
  data->localData[0]->realVars[179] /* MatStm2.totMolFlo[1] variable */ = 170.0;
  TRACE_POP
}
...
void Flowsheet_eqFunction_273(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[270] /* MatStm3.totMolFlo[1] variable */ = 80.0;
  TRACE_POP
}
...
void Flowsheet_eqFunction_275(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[15] /* MatStm1.T variable */ = 330.0;
  TRACE_POP
}
...
equation index: 276
type: SIMPLE_ASSIGN
MatStm1._totMolFlo[1] = 90.0
*/
void Flowsheet_eqFunction_276(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,276};
  data->localData[0]->realVars[89] /* MatStm1.totMolFlo[1] variable */ = 90.0;
  TRACE_POP
}
OMC_DISABLE_OPT
void Flowsheet_functionInitialEquations_0(DATA *data, threadData_t *threadData)
