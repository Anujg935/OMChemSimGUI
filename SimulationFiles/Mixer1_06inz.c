...
equation index: 16
type: SIMPLE_ASSIGN
MatStm3._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm3.comp[2].VP[1], MatStm3.comp[2].VP[2], MatStm3.comp[2].VP[3], MatStm3.comp[2].VP[4], MatStm3.comp[2].VP[5], MatStm3.comp[2].VP[6]}, 320.0)
*/
void Mixer1_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[195] /* MatStm3.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp0, 320.0);
  TRACE_POP
}
...
equation index: 18
type: SIMPLE_ASSIGN
MatStm3._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm3.comp[1].VP[1], MatStm3.comp[1].VP[2], MatStm3.comp[1].VP[3], MatStm3.comp[1].VP[4], MatStm3.comp[1].VP[5], MatStm3.comp[1].VP[6]}, 320.0)
*/
void Mixer1_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[194] /* MatStm3.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp1, 320.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_20(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[214] /* MatStm3.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[486], tmp2, tmp3, data->simulationInfo->realParameter[496], 320.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[212] /* MatStm3.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[486], tmp4, tmp5, data->simulationInfo->realParameter[496], 320.0);
  TRACE_POP
}
...
equation index: 22
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm3.comp[2].VapCp[1], MatStm3.comp[2].VapCp[2], MatStm3.comp[2].VapCp[3], MatStm3.comp[2].VapCp[4], MatStm3.comp[2].VapCp[5], MatStm3.comp[2].VapCp[6]}, 320.0)
*/
void Mixer1_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[238] /* MatStm3.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp6, 320.0);
  TRACE_POP
}
...
equation index: 23
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm3.comp[2].LiqCp[1], MatStm3.comp[2].LiqCp[2], MatStm3.comp[2].LiqCp[3], MatStm3.comp[2].LiqCp[4], MatStm3.comp[2].LiqCp[5], MatStm3.comp[2].LiqCp[6]}, 320.0)
*/
void Mixer1_eqFunction_23(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[236] /* MatStm3.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp7, 320.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[213] /* MatStm3.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[485], tmp8, tmp9, data->simulationInfo->realParameter[495], 320.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_25(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[211] /* MatStm3.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[485], tmp10, tmp11, data->simulationInfo->realParameter[495], 320.0);
  TRACE_POP
}
...
equation index: 26
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm3.comp[1].VapCp[1], MatStm3.comp[1].VapCp[2], MatStm3.comp[1].VapCp[3], MatStm3.comp[1].VapCp[4], MatStm3.comp[1].VapCp[5], MatStm3.comp[1].VapCp[6]}, 320.0)
*/
void Mixer1_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[237] /* MatStm3.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp12, 320.0);
  TRACE_POP
}
...
equation index: 27
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm3.comp[1].LiqCp[1], MatStm3.comp[1].LiqCp[2], MatStm3.comp[1].LiqCp[3], MatStm3.comp[1].LiqCp[4], MatStm3.comp[1].LiqCp[5], MatStm3.comp[1].LiqCp[6]}, 320.0)
*/
void Mixer1_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[235] /* MatStm3.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp13, 320.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[14] /* MatStm1.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp14, 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_30(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[13] /* MatStm1.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp15, 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_32(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[33] /* MatStm1.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[170], tmp16, tmp17, data->simulationInfo->realParameter[180], 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_33(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[31] /* MatStm1.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[170], tmp18, tmp19, data->simulationInfo->realParameter[180], 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_34(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[57] /* MatStm1.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp20, 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_35(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[55] /* MatStm1.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp21, 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[32] /* MatStm1.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[169], tmp22, tmp23, data->simulationInfo->realParameter[179], 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_37(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[30] /* MatStm1.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[169], tmp24, tmp25, data->simulationInfo->realParameter[179], 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[56] /* MatStm1.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp26, 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_39(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[54] /* MatStm1.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp27, 310.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_47(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[12] /* MatStm1.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[188]) - (DIVISION_SIM(data->simulationInfo->realParameter[189],310.0,"310.0",equationIndexes)) - ((data->simulationInfo->realParameter[190]) * (5.736572297479192)) - ((data->simulationInfo->realParameter[191]) * (tmp44)))) + (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[194]) - (DIVISION_SIM(data->simulationInfo->realParameter[195],310.0,"310.0",equationIndexes)) - ((data->simulationInfo->realParameter[196]) * (5.736572297479192)) - ((data->simulationInfo->realParameter[197]) * (tmp51)))),"MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 310.0 - MatStm1.comp[1].VP[4] * 5.736572297479192 - MatStm1.comp[1].VP[5] * 310.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 310.0 - MatStm1.comp[2].VP[4] * 5.736572297479192 - MatStm1.comp[2].VP[5] * 310.0 ^ MatStm1.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
equation index: 51
type: SIMPLE_ASSIGN
MatStm2._compMolFrac[1,1] = 0.5 * (MatStm1.compMolFrac[1,1] + MatStm3.compMolFrac[1,1])
*/
void Mixer1_eqFunction_51(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,51};
  data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */ = (0.5) * (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */ + data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
equation index: 55
type: SIMPLE_ASSIGN
MatStm3._Pbubl = MatStm3.compMolFrac[1,1] * exp(MatStm3.comp[1].VP[2] + 0.003125 * MatStm3.comp[1].VP[3] + MatStm3.comp[1].VP[4] * 5.768320995793772 + MatStm3.comp[1].VP[5] * 320.0 ^ MatStm3.comp[1].VP[6]) + MatStm3.compMolFrac[1,2] * exp(MatStm3.comp[2].VP[2] + 0.003125 * MatStm3.comp[2].VP[3] + MatStm3.comp[2].VP[4] * 5.768320995793772 + MatStm3.comp[2].VP[5] * 320.0 ^ MatStm3.comp[2].VP[6])
*/
...
equation index: 56
type: SIMPLE_ASSIGN
MatStm3._Pdew = 1.0 / (MatStm3.compMolFrac[1,1] * exp((-MatStm3.comp[1].VP[2]) - 0.003125 * MatStm3.comp[1].VP[3] - MatStm3.comp[1].VP[4] * 5.768320995793772 - MatStm3.comp[1].VP[5] * 320.0 ^ MatStm3.comp[1].VP[6]) + MatStm3.compMolFrac[1,2] * exp((-MatStm3.comp[2].VP[2]) - 0.003125 * MatStm3.comp[2].VP[3] - MatStm3.comp[2].VP[4] * 5.768320995793772 - MatStm3.comp[2].VP[5] * 320.0 ^ MatStm3.comp[2].VP[6]))
*/
void Mixer1_eqFunction_56(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[193] /* MatStm3.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[504]) - ((0.003125) * (data->simulationInfo->realParameter[505])) - ((data->simulationInfo->realParameter[506]) * (5.768320995793772)) - ((data->simulationInfo->realParameter[507]) * (tmp72)))) + (data->localData[0]->realVars[228] /* MatStm3.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[510]) - ((0.003125) * (data->simulationInfo->realParameter[511])) - ((data->simulationInfo->realParameter[512]) * (5.768320995793772)) - ((data->simulationInfo->realParameter[513]) * (tmp79)))),"MatStm3.compMolFrac[1,1] * exp((-MatStm3.comp[1].VP[2]) - 0.003125 * MatStm3.comp[1].VP[3] - MatStm3.comp[1].VP[4] * 5.768320995793772 - MatStm3.comp[1].VP[5] * 320.0 ^ MatStm3.comp[1].VP[6]) + MatStm3.compMolFrac[1,2] * exp((-MatStm3.comp[2].VP[2]) - 0.003125 * MatStm3.comp[2].VP[3] - MatStm3.comp[2].VP[4] * 5.768320995793772 - MatStm3.comp[2].VP[5] * 320.0 ^ MatStm3.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
equation index: 57
type: SIMPLE_ASSIGN
MatStm2._compMolFrac[1,2] = 0.5 * (MatStm1.compMolFrac[1,2] + MatStm3.compMolFrac[1,2])
*/
void Mixer1_eqFunction_57(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,57};
  data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */ = (0.5) * (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */ + data->localData[0]->realVars[228] /* MatStm3.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
void Mixer1_eqFunction_180(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[0] = data->localData[0]->realVars[181] /* MatStm2.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[1] = data->localData[0]->realVars[138] /* MatStm2.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[2] = data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[3] = data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[4] = data->localData[0]->realVars[105] /* MatStm2.T variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[5] = data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[181] /* MatStm2.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[0];
  data->localData[0]->realVars[138] /* MatStm2.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[1];
  data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[2];
  data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[3];
  data->localData[0]->realVars[105] /* MatStm2.T variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[4];
  data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[5];
  TRACE_POP
}
...
void Mixer1_eqFunction_219(DATA *data, threadData_t *threadData)
{
  ...
  if(!(((tmp16 > 0) && (tmp15 > tmp17)) || ((tmp16 < 0) && (tmp15 < tmp17))))
  {
    ...
    for($Pi = ((modelica_integer) 1); in_range_integer($Pi, tmp15, tmp17); $Pi += tmp16)
    {
      ...
      real_array_create(&tmp14, (modelica_real*)&data->localData[0]->realVars[188] /* MatStm3.MW[1] variable */, 1, 3);
...
void Mixer1_eqFunction_226(DATA *data, threadData_t *threadData)
{
  ...
  /* write solution */
  data->localData[0]->realVars[206] /* MatStm3.compMasFrac[2,2] variable */ = aux_x[0];
  data->localData[0]->realVars[208] /* MatStm3.compMasFrac[3,2] variable */ = aux_x[1];
  data->localData[0]->realVars[205] /* MatStm3.compMasFrac[2,1] variable */ = aux_x[2];
  data->localData[0]->realVars[207] /* MatStm3.compMasFrac[3,1] variable */ = aux_x[3];
  data->localData[0]->realVars[203] /* MatStm3.compMasFrac[1,1] variable */ = aux_x[4];
  TRACE_POP
}
...
void Mixer1_eqFunction_227(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[179] /* MatStm2.totMolFlo[1] variable */ = 200.0;
  TRACE_POP
}
...
void Mixer1_eqFunction_275(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[196] /* MatStm3.T variable */ = 320.0;
  TRACE_POP
}
