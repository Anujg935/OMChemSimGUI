...
equation index: 16
type: SIMPLE_ASSIGN
MatStm2._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm2.comp[2].VP[1], MatStm2.comp[2].VP[2], MatStm2.comp[2].VP[3], MatStm2.comp[2].VP[4], MatStm2.comp[2].VP[5], MatStm2.comp[2].VP[6]}, 290.0)
*/
void Mixer1_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[105] /* MatStm2.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp0, 290.0);
  TRACE_POP
}
...
equation index: 17
type: SIMPLE_ASSIGN
MatStm2._K[2] = 9.881422924901186e-006 * MatStm2.Psat[2]
*/
void Mixer1_eqFunction_17(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,17};
  data->localData[0]->realVars[97] /* MatStm2.K[2] variable */ = (9.881422924901186e-006) * (data->localData[0]->realVars[105] /* MatStm2.Psat[2] variable */);
  TRACE_POP
}
...
equation index: 18
type: SIMPLE_ASSIGN
MatStm2._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm2.comp[1].VP[1], MatStm2.comp[1].VP[2], MatStm2.comp[1].VP[3], MatStm2.comp[1].VP[4], MatStm2.comp[1].VP[5], MatStm2.comp[1].VP[6]}, 290.0)
*/
void Mixer1_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[104] /* MatStm2.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp1, 290.0);
  TRACE_POP
}
...
equation index: 19
type: SIMPLE_ASSIGN
MatStm2._K[1] = 9.881422924901186e-006 * MatStm2.Psat[1]
*/
void Mixer1_eqFunction_19(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,19};
  data->localData[0]->realVars[96] /* MatStm2.K[1] variable */ = (9.881422924901186e-006) * (data->localData[0]->realVars[104] /* MatStm2.Psat[1] variable */);
  TRACE_POP
}
...
void Mixer1_eqFunction_20(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[124] /* MatStm2.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[328], tmp2, tmp3, data->simulationInfo->realParameter[338], 290.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[122] /* MatStm2.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[328], tmp4, tmp5, data->simulationInfo->realParameter[338], 290.0);
  TRACE_POP
}
...
equation index: 22
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm2.comp[2].VapCp[1], MatStm2.comp[2].VapCp[2], MatStm2.comp[2].VapCp[3], MatStm2.comp[2].VapCp[4], MatStm2.comp[2].VapCp[5], MatStm2.comp[2].VapCp[6]}, 290.0)
*/
void Mixer1_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[148] /* MatStm2.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp6, 290.0);
  TRACE_POP
}
...
equation index: 23
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm2.comp[2].LiqCp[1], MatStm2.comp[2].LiqCp[2], MatStm2.comp[2].LiqCp[3], MatStm2.comp[2].LiqCp[4], MatStm2.comp[2].LiqCp[5], MatStm2.comp[2].LiqCp[6]}, 290.0)
*/
void Mixer1_eqFunction_23(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[146] /* MatStm2.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp7, 290.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[123] /* MatStm2.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[327], tmp8, tmp9, data->simulationInfo->realParameter[337], 290.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_25(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[121] /* MatStm2.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[327], tmp10, tmp11, data->simulationInfo->realParameter[337], 290.0);
  TRACE_POP
}
...
equation index: 26
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm2.comp[1].VapCp[1], MatStm2.comp[1].VapCp[2], MatStm2.comp[1].VapCp[3], MatStm2.comp[1].VapCp[4], MatStm2.comp[1].VapCp[5], MatStm2.comp[1].VapCp[6]}, 290.0)
*/
void Mixer1_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[147] /* MatStm2.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp12, 290.0);
  TRACE_POP
}
...
equation index: 27
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm2.comp[1].LiqCp[1], MatStm2.comp[1].LiqCp[2], MatStm2.comp[1].LiqCp[3], MatStm2.comp[1].LiqCp[4], MatStm2.comp[1].LiqCp[5], MatStm2.comp[1].LiqCp[6]}, 290.0)
*/
void Mixer1_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[145] /* MatStm2.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp13, 290.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[195] /* MatStm3.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp14, 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_30(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[194] /* MatStm3.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp15, 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_32(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[214] /* MatStm3.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[486], tmp16, tmp17, data->simulationInfo->realParameter[496], 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_33(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[212] /* MatStm3.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[486], tmp18, tmp19, data->simulationInfo->realParameter[496], 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_34(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[238] /* MatStm3.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp20, 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_35(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[236] /* MatStm3.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp21, 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[213] /* MatStm3.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[485], tmp22, tmp23, data->simulationInfo->realParameter[495], 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_37(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[211] /* MatStm3.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[485], tmp24, tmp25, data->simulationInfo->realParameter[495], 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[237] /* MatStm3.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp26, 300.0);
  TRACE_POP
}
...
void Mixer1_eqFunction_39(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[235] /* MatStm3.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp27, 300.0);
  TRACE_POP
}
...
equation index: 40
type: SIMPLE_ASSIGN
MatStm3._compMolFrac[1,1] = 0.2
*/
void Mixer1_eqFunction_40(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,40};
  data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,1] variable */ = 0.2;
  TRACE_POP
}
...
equation index: 43
type: SIMPLE_ASSIGN
MatStm3._compMolFrac[1,2] = 0.8
*/
void Mixer1_eqFunction_43(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,43};
  data->localData[0]->realVars[228] /* MatStm3.compMolFrac[1,2] variable */ = 0.8;
  TRACE_POP
}
...
equation index: 48
type: SIMPLE_ASSIGN
MatStm2._compMolFrac[1,1] = 0.3
*/
void Mixer1_eqFunction_48(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,48};
  data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,1] variable */ = 0.3;
  TRACE_POP
}
...
equation index: 52
type: SIMPLE_ASSIGN
MatStm2._compMolFrac[1,2] = 0.7
*/
void Mixer1_eqFunction_52(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,52};
  data->localData[0]->realVars[138] /* MatStm2.compMolFrac[1,2] variable */ = 0.7;
  TRACE_POP
}
...
equation index: 55
type: SIMPLE_ASSIGN
MatStm2._Pbubl = MatStm2.compMolFrac[1,1] * exp(MatStm2.comp[1].VP[2] + MatStm2.comp[1].VP[3] / 290.0 + MatStm2.comp[1].VP[4] * 5.66988092298052 + MatStm2.comp[1].VP[5] * 290.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp(MatStm2.comp[2].VP[2] + MatStm2.comp[2].VP[3] / 290.0 + MatStm2.comp[2].VP[4] * 5.66988092298052 + MatStm2.comp[2].VP[5] * 290.0 ^ MatStm2.comp[2].VP[6])
*/
...
equation index: 56
type: SIMPLE_ASSIGN
MatStm2._Pdew = 1.0 / (MatStm2.compMolFrac[1,1] * exp((-MatStm2.comp[1].VP[2]) - MatStm2.comp[1].VP[3] / 290.0 - MatStm2.comp[1].VP[4] * 5.66988092298052 - MatStm2.comp[1].VP[5] * 290.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp((-MatStm2.comp[2].VP[2]) - MatStm2.comp[2].VP[3] / 290.0 - MatStm2.comp[2].VP[4] * 5.66988092298052 - MatStm2.comp[2].VP[5] * 290.0 ^ MatStm2.comp[2].VP[6]))
*/
void Mixer1_eqFunction_56(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[103] /* MatStm2.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[346]) - (DIVISION_SIM(data->simulationInfo->realParameter[347],290.0,"290.0",equationIndexes)) - ((data->simulationInfo->realParameter[348]) * (5.66988092298052)) - ((data->simulationInfo->realParameter[349]) * (tmp72)))) + (data->localData[0]->realVars[138] /* MatStm2.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[352]) - (DIVISION_SIM(data->simulationInfo->realParameter[353],290.0,"290.0",equationIndexes)) - ((data->simulationInfo->realParameter[354]) * (5.66988092298052)) - ((data->simulationInfo->realParameter[355]) * (tmp79)))),"MatStm2.compMolFrac[1,1] * exp((-MatStm2.comp[1].VP[2]) - MatStm2.comp[1].VP[3] / 290.0 - MatStm2.comp[1].VP[4] * 5.66988092298052 - MatStm2.comp[1].VP[5] * 290.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp((-MatStm2.comp[2].VP[2]) - MatStm2.comp[2].VP[3] / 290.0 - MatStm2.comp[2].VP[4] * 5.66988092298052 - MatStm2.comp[2].VP[5] * 290.0 ^ MatStm2.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
void Mixer1_eqFunction_86(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[0] = data->localData[0]->realVars[272] /* MatStm3.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[1] = data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[2] = data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[3] = data->localData[0]->realVars[232] /* MatStm3.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[4] = data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[272] /* MatStm3.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[0];
  data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[1];
  data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[2];
  data->localData[0]->realVars[232] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[3];
  data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[4];
  TRACE_POP
}
...
void Mixer1_eqFunction_140(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[0] = data->localData[0]->realVars[181] /* MatStm2.totMolFlo[2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[1] = data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[2] = data->localData[0]->realVars[140] /* MatStm2.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[3] = data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[4] = data->localData[0]->realVars[142] /* MatStm2.compMolFrac[3,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[181] /* MatStm2.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[0];
  data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[1];
  data->localData[0]->realVars[140] /* MatStm2.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[2];
  data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[3];
  data->localData[0]->realVars[142] /* MatStm2.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[4];
  TRACE_POP
}
...
void Mixer1_eqFunction_180(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[5] = data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */;
  ...
  data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[5];
  TRACE_POP
}
...
void Mixer1_eqFunction_219(DATA *data, threadData_t *threadData)
{
  ...
  if(!(((tmp16 > 0) && (tmp15 > tmp17)) || ((tmp16 < 0) && (tmp15 < tmp17))))
  {
    ...
    for($Pi = ((modelica_integer) 1); in_range_integer($Pi, tmp15, tmp17); $Pi += tmp16)
    {
      ...
      real_array_create(&tmp14, (modelica_real*)&data->localData[0]->realVars[98] /* MatStm2.MW[1] variable */, 1, 3);
...
void Mixer1_eqFunction_226(DATA *data, threadData_t *threadData)
{
  ...
  /* write solution */
  data->localData[0]->realVars[116] /* MatStm2.compMasFrac[2,2] variable */ = aux_x[0];
  data->localData[0]->realVars[118] /* MatStm2.compMasFrac[3,2] variable */ = aux_x[1];
  data->localData[0]->realVars[115] /* MatStm2.compMasFrac[2,1] variable */ = aux_x[2];
  data->localData[0]->realVars[117] /* MatStm2.compMasFrac[3,1] variable */ = aux_x[3];
...
void Mixer1_eqFunction_228(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[10] /* MatStm1.P variable */ = 101262.5;
  TRACE_POP
}
...
void Mixer1_eqFunction_272(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[196] /* MatStm3.T variable */ = 300.0;
  TRACE_POP
}
...
void Mixer1_eqFunction_274(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[101] /* MatStm2.P variable */ = 101200.0;
  TRACE_POP
}
...
void Mixer1_eqFunction_275(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[106] /* MatStm2.T variable */ = 290.0;
  TRACE_POP
}
