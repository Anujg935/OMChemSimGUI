...
{
  static const char *res[] = {"101262.5 >= MatStm1.Pbubl",
  "101262.5 >= MatStm1.Pdew"};
...
int Mixer1_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  tmp438 = GreaterEqZC(101262.5, data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */, data->simulationInfo->storedRelations[0]);
  gout[0] = (tmp438) ? 1 : -1;
  tmp439 = GreaterEqZC(101262.5, data->localData[0]->realVars[12] /* MatStm1.Pdew variable */, data->simulationInfo->storedRelations[1]);
  gout[1] = (tmp439) ? 1 : -1;
...
{
  const char *res[] = {"101262.5 >= MatStm1.Pbubl",
  "101262.5 >= MatStm1.Pdew"};
  return res[i];
}
...
int Mixer1_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    tmp440 = GreaterEqZC(101262.5, data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */, data->simulationInfo->storedRelations[0]);
    data->simulationInfo->relations[0] = tmp440;
    tmp441 = GreaterEqZC(101262.5, data->localData[0]->realVars[12] /* MatStm1.Pdew variable */, data->simulationInfo->storedRelations[1]);
    data->simulationInfo->relations[1] = tmp441;
  } else {
    data->simulationInfo->relations[0] = (101262.5 >= data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */);
    data->simulationInfo->relations[1] = (101262.5 >= data->localData[0]->realVars[12] /* MatStm1.Pdew variable */);
  }
