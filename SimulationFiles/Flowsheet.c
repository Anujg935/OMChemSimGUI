...
void Flowsheet_eqFunction_207(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[1] = data->localData[0]->realVars[57] /* MatStm1.compMolFrac[3,2] variable */;
  ...
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[4] = data->localData[0]->realVars[55] /* MatStm1.compMolFrac[2,2] variable */;
  ...
  data->localData[0]->realVars[57] /* MatStm1.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[1];
  ...
  data->localData[0]->realVars[55] /* MatStm1.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[4];
  TRACE_POP
}
/*
equation index: 208
...
equation index: 210
type: SIMPLE_ASSIGN
Cooler1._inVapPhasMolFrac = (-MatStm1.liqPhasMolFrac) - -1.0
*/
void Flowsheet_eqFunction_210(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,210};
  data->localData[0]->realVars[6] /* Cooler1.inVapPhasMolFrac variable */ = (-data->localData[0]->realVars[71] /* MatStm1.liqPhasMolFrac variable */) - (-1.0);
  TRACE_POP
}
/*
equation index: 211
...
equation index: 217
type: SIMPLE_ASSIGN
MatStm1._phasMolEnth[1] = MatStm1.liqPhasMolFrac * MatStm1.phasMolEnth[2] + Cooler1.inVapPhasMolFrac * MatStm1.phasMolEnth[3]
*/
void Flowsheet_eqFunction_217(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,217};
  data->localData[0]->realVars[74] /* MatStm1.phasMolEnth[1] variable */ = (data->localData[0]->realVars[71] /* MatStm1.liqPhasMolFrac variable */) * (data->localData[0]->realVars[75] /* MatStm1.phasMolEnth[2] variable */) + (data->localData[0]->realVars[6] /* Cooler1.inVapPhasMolFrac variable */) * (data->localData[0]->realVars[76] /* MatStm1.phasMolEnth[3] variable */);
  TRACE_POP
}
/*
equation index: 218
...
equation index: 220
type: SIMPLE_ASSIGN
MatStm3._phasMolEnth[1] = MatStm1.phasMolEnth[1] - 200.0 * Cooler1.eff
*/
void Flowsheet_eqFunction_220(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,220};
  data->localData[0]->realVars[162] /* MatStm3.phasMolEnth[1] variable */ = data->localData[0]->realVars[74] /* MatStm1.phasMolEnth[1] variable */ - ((200.0) * (data->simulationInfo->realParameter[158]));
  TRACE_POP
}
/*
equation index: 221
...
equation index: 222
type: SIMPLE_ASSIGN
MatStm1._phasMolSpHeat[1] = MatStm1.liqPhasMolFrac * MatStm1.phasMolSpHeat[2] + Cooler1.inVapPhasMolFrac * MatStm1.phasMolSpHeat[3]
*/
void Flowsheet_eqFunction_222(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,222};
  data->localData[0]->realVars[80] /* MatStm1.phasMolSpHeat[1] variable */ = (data->localData[0]->realVars[71] /* MatStm1.liqPhasMolFrac variable */) * (data->localData[0]->realVars[81] /* MatStm1.phasMolSpHeat[2] variable */) + (data->localData[0]->realVars[6] /* Cooler1.inVapPhasMolFrac variable */) * (data->localData[0]->realVars[82] /* MatStm1.phasMolSpHeat[3] variable */);
  TRACE_POP
}
/*
equation index: 223
...
equation index: 228
type: SIMPLE_ASSIGN
MatStm1._phasMolEntr[1] = MatStm1.liqPhasMolFrac * MatStm1.phasMolEntr[2] + Cooler1.inVapPhasMolFrac * MatStm1.phasMolEntr[3]
*/
void Flowsheet_eqFunction_228(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,228};
  data->localData[0]->realVars[77] /* MatStm1.phasMolEntr[1] variable */ = (data->localData[0]->realVars[71] /* MatStm1.liqPhasMolFrac variable */) * (data->localData[0]->realVars[78] /* MatStm1.phasMolEntr[2] variable */) + (data->localData[0]->realVars[6] /* Cooler1.inVapPhasMolFrac variable */) * (data->localData[0]->realVars[79] /* MatStm1.phasMolEntr[3] variable */);
  TRACE_POP
}
/*
equation index: 229
...
void Flowsheet_eqFunction_232(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[92] /* MatStm1.totMasFlo[1] variable */ = (100.0) * (data->localData[0]->realVars[13] /* MatStm1.MW[1] variable */);
  TRACE_POP
}
/*
equation index: 233
...
void Flowsheet_eqFunction_238(DATA *data, threadData_t *threadData)
{
  ...
  int retValue;
  double aux_x[5] = { data->localData[1]->realVars[31] /* MatStm1.compMasFrac[2,2] variable */,data->localData[1]->realVars[33] /* MatStm1.compMasFrac[3,2] variable */,data->localData[1]->realVars[28] /* MatStm1.compMasFrac[1,1] variable */,data->localData[1]->realVars[32] /* MatStm1.compMasFrac[3,1] variable */,data->localData[1]->realVars[30] /* MatStm1.compMasFrac[2,1] variable */ };
  if(ACTIVE_STREAM(LOG_DT))
  {
  ...
  data->localData[0]->realVars[32] /* MatStm1.compMasFrac[3,1] variable */ = aux_x[3];
...
void Flowsheet_eqFunction_239(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[141] /* MatStm3.compMolFrac[1,2] variable */ = data->localData[0]->realVars[53] /* MatStm1.compMolFrac[1,2] variable */;
  TRACE_POP
}
/*
equation index: 240
...
void Flowsheet_eqFunction_240(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[135] /* MatStm3.compMolFlo[1,2] variable */ = (100.0) * (data->localData[0]->realVars[141] /* MatStm3.compMolFrac[1,2] variable */);
  TRACE_POP
}
/*
equation index: 241
...
void Flowsheet_eqFunction_241(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[111] /* MatStm3.compMasFlo[1,2] variable */ = (data->localData[0]->realVars[135] /* MatStm3.compMolFlo[1,2] variable */) * (data->simulationInfo->realParameter[482]);
  TRACE_POP
}
/*
equation index: 242
...
void Flowsheet_eqFunction_242(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[123] /* MatStm3.compMolEnth[1,2] variable */ = (data->localData[0]->realVars[141] /* MatStm3.compMolFrac[1,2] variable */) * (data->localData[0]->realVars[162] /* MatStm3.phasMolEnth[1] variable */);
  TRACE_POP
}
/*
equation index: 243
...
void Flowsheet_eqFunction_243(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[140] /* MatStm3.compMolFrac[1,1] variable */ = data->localData[0]->realVars[52] /* MatStm1.compMolFrac[1,1] variable */;
  TRACE_POP
}
/*
equation index: 244
...
void Flowsheet_eqFunction_244(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[134] /* MatStm3.compMolFlo[1,1] variable */ = (100.0) * (data->localData[0]->realVars[140] /* MatStm3.compMolFrac[1,1] variable */);
  TRACE_POP
}
/*
equation index: 245
...
void Flowsheet_eqFunction_245(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[110] /* MatStm3.compMasFlo[1,1] variable */ = (data->localData[0]->realVars[134] /* MatStm3.compMolFlo[1,1] variable */) * (data->simulationInfo->realParameter[481]);
  TRACE_POP
}
/*
equation index: 246
...
void Flowsheet_eqFunction_246(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[122] /* MatStm3.compMolEnth[1,1] variable */ = (data->localData[0]->realVars[140] /* MatStm3.compMolFrac[1,1] variable */) * (data->localData[0]->realVars[162] /* MatStm3.phasMolEnth[1] variable */);
  TRACE_POP
}
...
vars: {MatStm3._totMolFlo[2], Cooler1._outT, MatStm3._compMolFrac[2,1], MatStm3._compMolFrac[3,1], MatStm3._compMolFrac[3,2], MatStm3._compMolFrac[2,2]}
...
void Flowsheet_eqFunction_277(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[0] = data->localData[0]->realVars[183] /* MatStm3.totMolFlo[2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[1] = data->localData[0]->realVars[8] /* Cooler1.outT variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[2] = data->localData[0]->realVars[142] /* MatStm3.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[3] = data->localData[0]->realVars[144] /* MatStm3.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[4] = data->localData[0]->realVars[145] /* MatStm3.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[5] = data->localData[0]->realVars[143] /* MatStm3.compMolFrac[2,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[183] /* MatStm3.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[0];
  data->localData[0]->realVars[8] /* Cooler1.outT variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[1];
  data->localData[0]->realVars[142] /* MatStm3.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[2];
  data->localData[0]->realVars[144] /* MatStm3.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[3];
  data->localData[0]->realVars[145] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[4];
  data->localData[0]->realVars[143] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[5];
  TRACE_POP
}
/*
equation index: 278
...
void Flowsheet_eqFunction_278(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[113] /* MatStm3.compMasFlo[2,2] variable */ = (data->localData[0]->realVars[137] /* MatStm3.compMolFlo[2,2] variable */) * (data->simulationInfo->realParameter[482]);
  TRACE_POP
}
/*
equation index: 279
...
void Flowsheet_eqFunction_279(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[115] /* MatStm3.compMasFlo[3,2] variable */ = (data->localData[0]->realVars[139] /* MatStm3.compMolFlo[3,2] variable */) * (data->simulationInfo->realParameter[482]);
  TRACE_POP
}
/*
equation index: 280
type: SIMPLE_ASSIGN
Cooler1._tempDrop = 300.0 - Cooler1.outT
*/
void Flowsheet_eqFunction_280(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,280};
  data->localData[0]->realVars[10] /* Cooler1.tempDrop variable */ = 300.0 - data->localData[0]->realVars[8] /* Cooler1.outT variable */;
  TRACE_POP
}
/*
equation index: 281
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm3.comp[1].LiqCp[1], MatStm3.comp[1].LiqCp[2], MatStm3.comp[1].LiqCp[3], MatStm3.comp[1].LiqCp[4], MatStm3.comp[1].LiqCp[5], MatStm3.comp[1].LiqCp[6]}, Cooler1.outT)
*/
void Flowsheet_eqFunction_281(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[148] /* MatStm3.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp0, data->localData[0]->realVars[8] /* Cooler1.outT variable */);
  TRACE_POP
}
/*
equation index: 282
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm3.comp[1].VapCp[1], MatStm3.comp[1].VapCp[2], MatStm3.comp[1].VapCp[3], MatStm3.comp[1].VapCp[4], MatStm3.comp[1].VapCp[5], MatStm3.comp[1].VapCp[6]}, Cooler1.outT)
*/
void Flowsheet_eqFunction_282(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[150] /* MatStm3.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp1, data->localData[0]->realVars[8] /* Cooler1.outT variable */);
  TRACE_POP
}
/*
equation index: 283
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm3.comp[2].LiqCp[1], MatStm3.comp[2].LiqCp[2], MatStm3.comp[2].LiqCp[3], MatStm3.comp[2].LiqCp[4], MatStm3.comp[2].LiqCp[5], MatStm3.comp[2].LiqCp[6]}, Cooler1.outT)
*/
void Flowsheet_eqFunction_283(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[149] /* MatStm3.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp2, data->localData[0]->realVars[8] /* Cooler1.outT variable */);
  TRACE_POP
}
/*
equation index: 284
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm3.comp[2].VapCp[1], MatStm3.comp[2].VapCp[2], MatStm3.comp[2].VapCp[3], MatStm3.comp[2].VapCp[4], MatStm3.comp[2].VapCp[5], MatStm3.comp[2].VapCp[6]}, Cooler1.outT)
*/
void Flowsheet_eqFunction_284(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[151] /* MatStm3.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp3, data->localData[0]->realVars[8] /* Cooler1.outT variable */);
  TRACE_POP
}
/*
equation index: 285
...
void Flowsheet_eqFunction_285(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[131] /* MatStm3.compMolEntr[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_SId(threadData, data->simulationInfo->realParameter[400], tmp4, tmp5, data->simulationInfo->realParameter[496], data->simulationInfo->realParameter[498], data->localData[0]->realVars[8] /* Cooler1.outT variable */, data->localData[0]->realVars[7] /* Cooler1.outP variable */, data->localData[0]->realVars[143] /* MatStm3.compMolFrac[2,2] variable */, data->localData[0]->realVars[145] /* MatStm3.compMolFrac[3,2] variable */ ,&data->localData[0]->realVars[133] /* MatStm3.compMolEntr[3,2] variable */);
  TRACE_POP
}
/*
equation index: 286
...
void Flowsheet_eqFunction_286(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[112] /* MatStm3.compMasFlo[2,1] variable */ = (data->localData[0]->realVars[136] /* MatStm3.compMolFlo[2,1] variable */) * (data->simulationInfo->realParameter[481]);
  TRACE_POP
}
/*
equation index: 287
...
void Flowsheet_eqFunction_287(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[114] /* MatStm3.compMasFlo[3,1] variable */ = (data->localData[0]->realVars[138] /* MatStm3.compMolFlo[3,1] variable */) * (data->simulationInfo->realParameter[481]);
  TRACE_POP
}
/*
equation index: 288
...
void Flowsheet_eqFunction_288(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[170] /* MatStm3.phasMolSpHeat[3] variable */ = (data->localData[0]->realVars[144] /* MatStm3.compMolFrac[3,1] variable */) * (data->localData[0]->realVars[150] /* MatStm3.compMolSpHeat[3,1] variable */) + (data->localData[0]->realVars[145] /* MatStm3.compMolFrac[3,2] variable */) * (data->localData[0]->realVars[151] /* MatStm3.compMolSpHeat[3,2] variable */);
  TRACE_POP
}
/*
equation index: 289
...
void Flowsheet_eqFunction_289(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[169] /* MatStm3.phasMolSpHeat[2] variable */ = (data->localData[0]->realVars[142] /* MatStm3.compMolFrac[2,1] variable */) * (data->localData[0]->realVars[148] /* MatStm3.compMolSpHeat[2,1] variable */) + (data->localData[0]->realVars[143] /* MatStm3.compMolFrac[2,2] variable */) * (data->localData[0]->realVars[149] /* MatStm3.compMolSpHeat[2,2] variable */);
  TRACE_POP
}
/*
equation index: 290
type: SIMPLE_ASSIGN
MatStm3._phasMolSpHeat[1] = MatStm3.liqPhasMolFrac * MatStm3.phasMolSpHeat[2] + Cooler1.outVapPhasMolFrac * MatStm3.phasMolSpHeat[3]
*/
void Flowsheet_eqFunction_290(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,290};
  data->localData[0]->realVars[168] /* MatStm3.phasMolSpHeat[1] variable */ = (data->localData[0]->realVars[159] /* MatStm3.liqPhasMolFrac variable */) * (data->localData[0]->realVars[169] /* MatStm3.phasMolSpHeat[2] variable */) + (data->localData[0]->realVars[9] /* Cooler1.outVapPhasMolFrac variable */) * (data->localData[0]->realVars[170] /* MatStm3.phasMolSpHeat[3] variable */);
  TRACE_POP
}
/*
equation index: 291
...
void Flowsheet_eqFunction_291(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[147] /* MatStm3.compMolSpHeat[1,2] variable */ = (data->localData[0]->realVars[141] /* MatStm3.compMolFrac[1,2] variable */) * (data->localData[0]->realVars[168] /* MatStm3.phasMolSpHeat[1] variable */);
  TRACE_POP
}
/*
equation index: 292
...
void Flowsheet_eqFunction_293(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[167] /* MatStm3.phasMolEntr[3] variable */ = (data->localData[0]->realVars[144] /* MatStm3.compMolFrac[3,1] variable */) * (data->localData[0]->realVars[132] /* MatStm3.compMolEntr[3,1] variable */) + (data->localData[0]->realVars[145] /* MatStm3.compMolFrac[3,2] variable */) * (data->localData[0]->realVars[133] /* MatStm3.compMolEntr[3,2] variable */);
  TRACE_POP
}
/*
equation index: 294
...
void Flowsheet_eqFunction_294(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[166] /* MatStm3.phasMolEntr[2] variable */ = (data->localData[0]->realVars[142] /* MatStm3.compMolFrac[2,1] variable */) * (data->localData[0]->realVars[130] /* MatStm3.compMolEntr[2,1] variable */) + (data->localData[0]->realVars[143] /* MatStm3.compMolFrac[2,2] variable */) * (data->localData[0]->realVars[131] /* MatStm3.compMolEntr[2,2] variable */);
  TRACE_POP
}
/*
equation index: 295
type: SIMPLE_ASSIGN
MatStm3._phasMolEntr[1] = MatStm3.liqPhasMolFrac * MatStm3.phasMolEntr[2] + Cooler1.outVapPhasMolFrac * MatStm3.phasMolEntr[3]
*/
void Flowsheet_eqFunction_295(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,295};
  data->localData[0]->realVars[165] /* MatStm3.phasMolEntr[1] variable */ = (data->localData[0]->realVars[159] /* MatStm3.liqPhasMolFrac variable */) * (data->localData[0]->realVars[166] /* MatStm3.phasMolEntr[2] variable */) + (data->localData[0]->realVars[9] /* Cooler1.outVapPhasMolFrac variable */) * (data->localData[0]->realVars[167] /* MatStm3.phasMolEntr[3] variable */);
  TRACE_POP
}
/*
equation index: 296
...
void Flowsheet_eqFunction_296(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[129] /* MatStm3.compMolEntr[1,2] variable */ = (data->localData[0]->realVars[141] /* MatStm3.compMolFrac[1,2] variable */) * (data->localData[0]->realVars[165] /* MatStm3.phasMolEntr[1] variable */);
  TRACE_POP
}
/*
equation index: 297
...
void Flowsheet_eqFunction_297(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[146] /* MatStm3.compMolSpHeat[1,1] variable */ = (data->localData[0]->realVars[140] /* MatStm3.compMolFrac[1,1] variable */) * (data->localData[0]->realVars[168] /* MatStm3.phasMolSpHeat[1] variable */);
  TRACE_POP
}
/*
equation index: 298
...
void Flowsheet_eqFunction_298(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[128] /* MatStm3.compMolEntr[1,1] variable */ = (data->localData[0]->realVars[140] /* MatStm3.compMolFrac[1,1] variable */) * (data->localData[0]->realVars[165] /* MatStm3.phasMolEntr[1] variable */);
  TRACE_POP
}
/*
equation index: 299
...
void Flowsheet_eqFunction_299(DATA *data, threadData_t *threadData)
{
  ...
  if(!(((tmp12 > 0) && (tmp11 > tmp13)) || ((tmp12 < 0) && (tmp11 < tmp13))))
  {
    ...
    for($Pi = ((modelica_integer) 1); in_range_integer($Pi, tmp11, tmp13); $Pi += tmp12)
    {
      ...
      real_array_create(&tmp10, (modelica_real*)&data->localData[0]->realVars[103] /* MatStm3.MW[1] variable */, 1, 3);
...
void Flowsheet_eqFunction_300(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[181] /* MatStm3.totMasFlo[2] variable */ = (data->localData[0]->realVars[183] /* MatStm3.totMolFlo[2] variable */) * (data->localData[0]->realVars[104] /* MatStm3.MW[2] variable */);
  TRACE_POP
}
/*
equation index: 301
...
void Flowsheet_eqFunction_301(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[182] /* MatStm3.totMasFlo[3] variable */ = (data->localData[0]->realVars[184] /* MatStm3.totMolFlo[3] variable */) * (data->localData[0]->realVars[105] /* MatStm3.MW[3] variable */);
  TRACE_POP
}
/*
equation index: 302
...
void Flowsheet_eqFunction_302(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[180] /* MatStm3.totMasFlo[1] variable */ = (100.0) * (data->localData[0]->realVars[103] /* MatStm3.MW[1] variable */);
  TRACE_POP
}
/*
equation index: 303
...
void Flowsheet_eqFunction_303(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[185] /* MatStm3.vapPhasMasFrac variable */ = DIVISION_SIM(data->localData[0]->realVars[182] /* MatStm3.totMasFlo[3] variable */,data->localData[0]->realVars[180] /* MatStm3.totMasFlo[1] variable */,"MatStm3.totMasFlo[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 304
...
void Flowsheet_eqFunction_304(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[117] /* MatStm3.compMasFrac[1,2] variable */ = DIVISION_SIM(data->localData[0]->realVars[111] /* MatStm3.compMasFlo[1,2] variable */,data->localData[0]->realVars[180] /* MatStm3.totMasFlo[1] variable */,"MatStm3.totMasFlo[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 305
...
void Flowsheet_eqFunction_305(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[158] /* MatStm3.liqPhasMasFrac variable */ = DIVISION_SIM(data->localData[0]->realVars[181] /* MatStm3.totMasFlo[2] variable */,data->localData[0]->realVars[180] /* MatStm3.totMasFlo[1] variable */,"MatStm3.totMasFlo[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 306
...
<row>
  <cell>if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then MatStm3.compMasFlo[1,1] else 0.0</cell>
  <cell>if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then MatStm3.compMasFlo[2,1] else 0.0</cell>
  <cell>if Cooler1.outP >= MatStm3.Pbubl then -MatStm3.compMasFrac[1,2] else if Cooler1.outP >= MatStm3.Pdew then MatStm3.compMasFlo[3,2] else -MatStm3.compMasFrac[1,2]</cell>
  <cell>if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then MatStm3.compMasFlo[2,2] else 0.0</cell>
  <cell>if Cooler1.outP >= MatStm3.Pbubl then MatStm3.compMasFlo[1,1] else if Cooler1.outP >= MatStm3.Pdew then MatStm3.compMasFlo[3,1] else MatStm3.compMasFlo[1,1]</cell>
</row>
<matrix>
  <cell row="0" col="0">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 1.0 else -0.0)</residual>
  </cell><cell row="0" col="1">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then -MatStm3.totMasFlo[1] else 0.0)</residual>
  </cell><cell row="0" col="4">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then -0.0 else 1.0)</residual>
  </cell><cell row="1" col="2">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then -0.0 else 1.0)</residual>
  </cell><cell row="1" col="3">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 1.0 else -0.0)</residual>
  </cell><cell row="1" col="4">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then -MatStm3.totMasFlo[2] else 0.0)</residual>
  </cell><cell row="2" col="2">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 1.0 else -0.0)</residual>
  </cell><cell row="2" col="3">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then -MatStm3.totMasFlo[3] else 1.0)</residual>
  </cell><cell row="3" col="0">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then -0.0 else 1.0)</residual>
  </cell><cell row="3" col="1">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then -1.0 else if Cooler1.outP >= MatStm3.Pdew then -0.0 else -1.0)</residual>
  </cell><cell row="3" col="2">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 0.0 else if Cooler1.outP >= MatStm3.Pdew then -MatStm3.totMasFlo[2] else 0.0)</residual>
  </cell><cell row="3" col="4">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then 1.0 else -0.0)</residual>
  </cell><cell row="4" col="0">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then -0.0 else if Cooler1.outP >= MatStm3.Pdew then -MatStm3.totMasFlo[3] else -0.0)</residual>
  </cell><cell row="4" col="1">
    <residual>-(if Cooler1.outP >= MatStm3.Pbubl then -MatStm3.totMasFlo[1] else if Cooler1.outP >= MatStm3.Pdew then -0.0 else -MatStm3.totMasFlo[1])</residual>
  </cell>
</matrix>
*/
OMC_DISABLE_OPT
void Flowsheet_eqFunction_306(DATA *data, threadData_t *threadData)
{
  ...
  /* Linear equation system */
  int retValue;
  double aux_x[5] = { data->localData[1]->realVars[120] /* MatStm3.compMasFrac[3,1] variable */,data->localData[1]->realVars[116] /* MatStm3.compMasFrac[1,1] variable */,data->localData[1]->realVars[119] /* MatStm3.compMasFrac[2,2] variable */,data->localData[1]->realVars[121] /* MatStm3.compMasFrac[3,2] variable */,data->localData[1]->realVars[118] /* MatStm3.compMasFrac[2,1] variable */ };
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving linear system 306 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  ...
  if (retValue > 0){
    ...
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving linear system 306 failed at time=%.15g.\nFor more information please use -lv LOG_LS.", data->localData[0]->timeValue);
  }
  /* write solution */
  data->localData[0]->realVars[120] /* MatStm3.compMasFrac[3,1] variable */ = aux_x[0];
  data->localData[0]->realVars[116] /* MatStm3.compMasFrac[1,1] variable */ = aux_x[1];
  data->localData[0]->realVars[119] /* MatStm3.compMasFrac[2,2] variable */ = aux_x[2];
  data->localData[0]->realVars[121] /* MatStm3.compMasFrac[3,2] variable */ = aux_x[3];
  data->localData[0]->realVars[118] /* MatStm3.compMasFrac[2,1] variable */ = aux_x[4];
  TRACE_POP
}
...
void Flowsheet_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{806491e9-b453-46ee-bf01-c239b02e0533}";
