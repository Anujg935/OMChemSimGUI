...
equation index: 220
type: SIMPLE_ASSIGN
MatStm2._phasMolEnth[1] = MatStm1.phasMolEnth[1] - 2000.0 * Cooler1.eff
*/
void Flowsheet_eqFunction_220(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,220};
  data->localData[0]->realVars[162] /* MatStm2.phasMolEnth[1] variable */ = data->localData[0]->realVars[74] /* MatStm1.phasMolEnth[1] variable */ - ((2000.0) * (data->simulationInfo->realParameter[158]));
  TRACE_POP
}
/*
equation index: 221
...
void Flowsheet_eqFunction_240(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[135] /* MatStm2.compMolFlo[1,2] variable */ = (100.0) * (data->localData[0]->realVars[141] /* MatStm2.compMolFrac[1,2] variable */);
  TRACE_POP
}
/*
equation index: 241
...
void Flowsheet_eqFunction_244(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[134] /* MatStm2.compMolFlo[1,1] variable */ = (100.0) * (data->localData[0]->realVars[140] /* MatStm2.compMolFrac[1,1] variable */);
  TRACE_POP
}
/*
equation index: 245
...
vars: {MatStm2._totMolFlo[2], Cooler1._outT, MatStm2._compMolFrac[2,1], MatStm2._compMolFrac[3,1], MatStm2._compMolFrac[3,2], MatStm2._compMolFrac[2,2]}
...
void Flowsheet_eqFunction_281(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[148] /* MatStm2.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp0, data->localData[0]->realVars[8] /* Cooler1.outT variable */);
  TRACE_POP
}
/*
equation index: 282
...
void Flowsheet_eqFunction_282(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[150] /* MatStm2.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp1, data->localData[0]->realVars[8] /* Cooler1.outT variable */);
  TRACE_POP
}
/*
equation index: 283
...
void Flowsheet_eqFunction_283(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[149] /* MatStm2.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp2, data->localData[0]->realVars[8] /* Cooler1.outT variable */);
  TRACE_POP
}
/*
equation index: 284
...
void Flowsheet_eqFunction_284(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[151] /* MatStm2.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp3, data->localData[0]->realVars[8] /* Cooler1.outT variable */);
  TRACE_POP
}
/*
equation index: 285
...
void Flowsheet_eqFunction_295(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[165] /* MatStm2.phasMolEntr[1] variable */ = (data->localData[0]->realVars[159] /* MatStm2.liqPhasMolFrac variable */) * (data->localData[0]->realVars[166] /* MatStm2.phasMolEntr[2] variable */) + (data->localData[0]->realVars[9] /* Cooler1.outVapPhasMolFrac variable */) * (data->localData[0]->realVars[167] /* MatStm2.phasMolEntr[3] variable */);
  TRACE_POP
}
/*
equation index: 296
...
void Flowsheet_eqFunction_302(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[180] /* MatStm2.totMasFlo[1] variable */ = (100.0) * (data->localData[0]->realVars[103] /* MatStm2.MW[1] variable */);
  TRACE_POP
}
/*
equation index: 303
...
void Flowsheet_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{3b86b7c8-f6b1-4b6b-a020-1990fea7f8bf}";
