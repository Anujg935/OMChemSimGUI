...
void Flowsheet_eqFunction_266(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[159] /* MatStm2.liqPhasMolFrac variable */ = (0.01) * (data->localData[0]->realVars[183] /* MatStm2.totMolFlo[2] variable */);
  TRACE_POP
}
/*
equation index: 267
...
void Flowsheet_eqFunction_268(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[184] /* MatStm2.totMolFlo[3] variable */ = 100.0 - ((100.0) * (data->localData[0]->realVars[159] /* MatStm2.liqPhasMolFrac variable */));
  TRACE_POP
}
/*
equation index: 269
...
void residualFunc277(void** dataIn, const double* xloc, double* res, const int* iflag)
{
  ...
  {
    RELATIONHYSTERESIS(tmp5, data->localData[0]->realVars[7] /* Cooler1.outP variable */, data->localData[0]->realVars[107] /* MatStm2.Pdew variable */, 1, GreaterEq);
  ...
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[7] /* Cooler1.outP variable */, data->localData[0]->realVars[106] /* MatStm2.Pbubl variable */, 0, GreaterEq);
