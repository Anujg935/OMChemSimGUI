...
static void mixer1_eqFunction_451(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->realVarsData[102].attribute /* MatStm4.Pdew variable */.start = (0.5) * (data->simulationInfo->realParameter[323] + data->simulationInfo->realParameter[324]);
    data->localData[0]->realVars[102] /* MatStm4.Pdew variable */ = data->modelData->realVarsData[102].attribute /* MatStm4.Pdew variable */.start;
    infoStreamPrint(LOG_INIT, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[102].info /* MatStm4.Pdew */.name, (modelica_real) data->localData[0]->realVars[102] /* MatStm4.Pdew variable */);
  TRACE_POP
}
...
static void mixer1_eqFunction_452(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->realVarsData[101].attribute /* MatStm4.Pbubl variable */.start = (0.5) * (data->simulationInfo->realParameter[323] + data->simulationInfo->realParameter[324]);
    data->localData[0]->realVars[101] /* MatStm4.Pbubl variable */ = data->modelData->realVarsData[101].attribute /* MatStm4.Pbubl variable */.start;
    infoStreamPrint(LOG_INIT, 0, "updated start value: %s(start=%g)", data->modelData->realVarsData[101].info /* MatStm4.Pbubl */.name, (modelica_real) data->localData[0]->realVars[101] /* MatStm4.Pbubl variable */);
  TRACE_POP
}
OMC_DISABLE_OPT
