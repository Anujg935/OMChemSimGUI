...
equation index: 220
type: SIMPLE_ASSIGN
MatStm3._phasMolEnth[1] = MatStm1.phasMolEnth[1] + 100.0 * Heater1.eff
*/
void heater1_eqFunction_220(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,220};
  data->localData[0]->realVars[162] /* MatStm3.phasMolEnth[1] variable */ = data->localData[0]->realVars[74] /* MatStm1.phasMolEnth[1] variable */ + (100.0) * (data->simulationInfo->realParameter[237]);
  TRACE_POP
}
/*
equation index: 221
...
void heater1_eqFunction_240(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[135] /* MatStm3.compMolFlo[1,2] variable */ = (200.0) * (data->localData[0]->realVars[141] /* MatStm3.compMolFrac[1,2] variable */);
  TRACE_POP
}
/*
equation index: 241
...
void heater1_eqFunction_244(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[134] /* MatStm3.compMolFlo[1,1] variable */ = (200.0) * (data->localData[0]->realVars[140] /* MatStm3.compMolFrac[1,1] variable */);
  TRACE_POP
}
/*
equation index: 245
...
vars: {MatStm3._totMolFlo[3], Heater1._outT, MatStm3._compMolFrac[3,1], MatStm3._compMolFrac[2,1], MatStm3._compMolFrac[2,2], MatStm3._compMolFrac[3,2]}
...
void heater1_eqFunction_277(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[0] = data->localData[0]->realVars[184] /* MatStm3.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[1] = data->localData[0]->realVars[8] /* Heater1.outT variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[2] = data->localData[0]->realVars[144] /* MatStm3.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[3] = data->localData[0]->realVars[142] /* MatStm3.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[4] = data->localData[0]->realVars[143] /* MatStm3.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[5] = data->localData[0]->realVars[145] /* MatStm3.compMolFrac[3,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[184] /* MatStm3.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[0];
  data->localData[0]->realVars[8] /* Heater1.outT variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[1];
  data->localData[0]->realVars[144] /* MatStm3.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[2];
  data->localData[0]->realVars[142] /* MatStm3.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[3];
  data->localData[0]->realVars[143] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[4];
  data->localData[0]->realVars[145] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[5];
  TRACE_POP
}
/*
equation index: 278
...
equation index: 282
type: SIMPLE_ASSIGN
Heater1._tempInc = Heater1.outT - 310.0
*/
void heater1_eqFunction_282(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,282};
  data->localData[0]->realVars[10] /* Heater1.tempInc variable */ = data->localData[0]->realVars[8] /* Heater1.outT variable */ - 310.0;
  TRACE_POP
}
/*
equation index: 283
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm3.comp[1].LiqCp[1], MatStm3.comp[1].LiqCp[2], MatStm3.comp[1].LiqCp[3], MatStm3.comp[1].LiqCp[4], MatStm3.comp[1].LiqCp[5], MatStm3.comp[1].LiqCp[6]}, Heater1.outT)
*/
void heater1_eqFunction_283(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[148] /* MatStm3.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp0, data->localData[0]->realVars[8] /* Heater1.outT variable */);
  TRACE_POP
}
/*
equation index: 284
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm3.comp[1].VapCp[1], MatStm3.comp[1].VapCp[2], MatStm3.comp[1].VapCp[3], MatStm3.comp[1].VapCp[4], MatStm3.comp[1].VapCp[5], MatStm3.comp[1].VapCp[6]}, Heater1.outT)
*/
void heater1_eqFunction_284(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[150] /* MatStm3.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp1, data->localData[0]->realVars[8] /* Heater1.outT variable */);
  TRACE_POP
}
/*
equation index: 285
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm3.comp[2].LiqCp[1], MatStm3.comp[2].LiqCp[2], MatStm3.comp[2].LiqCp[3], MatStm3.comp[2].LiqCp[4], MatStm3.comp[2].LiqCp[5], MatStm3.comp[2].LiqCp[6]}, Heater1.outT)
*/
void heater1_eqFunction_285(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[149] /* MatStm3.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp2, data->localData[0]->realVars[8] /* Heater1.outT variable */);
  TRACE_POP
}
/*
equation index: 286
type: SIMPLE_ASSIGN
MatStm3._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm3.comp[2].VapCp[1], MatStm3.comp[2].VapCp[2], MatStm3.comp[2].VapCp[3], MatStm3.comp[2].VapCp[4], MatStm3.comp[2].VapCp[5], MatStm3.comp[2].VapCp[6]}, Heater1.outT)
*/
void heater1_eqFunction_286(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[151] /* MatStm3.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp3, data->localData[0]->realVars[8] /* Heater1.outT variable */);
  TRACE_POP
}
/*
equation index: 287
...
equation index: 290
type: SIMPLE_ASSIGN
MatStm3._phasMolSpHeat[1] = MatStm3.liqPhasMolFrac * MatStm3.phasMolSpHeat[2] + Heater1.outVapPhasMolFrac * MatStm3.phasMolSpHeat[3]
*/
void heater1_eqFunction_290(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,290};
  data->localData[0]->realVars[168] /* MatStm3.phasMolSpHeat[1] variable */ = (data->localData[0]->realVars[159] /* MatStm3.liqPhasMolFrac variable */) * (data->localData[0]->realVars[169] /* MatStm3.phasMolSpHeat[2] variable */) + (data->localData[0]->realVars[9] /* Heater1.outVapPhasMolFrac variable */) * (data->localData[0]->realVars[170] /* MatStm3.phasMolSpHeat[3] variable */);
  TRACE_POP
}
/*
equation index: 291
...
equation index: 295
type: SIMPLE_ASSIGN
MatStm3._phasMolEntr[1] = MatStm3.liqPhasMolFrac * MatStm3.phasMolEntr[2] + Heater1.outVapPhasMolFrac * MatStm3.phasMolEntr[3]
*/
void heater1_eqFunction_295(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,295};
  data->localData[0]->realVars[165] /* MatStm3.phasMolEntr[1] variable */ = (data->localData[0]->realVars[159] /* MatStm3.liqPhasMolFrac variable */) * (data->localData[0]->realVars[166] /* MatStm3.phasMolEntr[2] variable */) + (data->localData[0]->realVars[9] /* Heater1.outVapPhasMolFrac variable */) * (data->localData[0]->realVars[167] /* MatStm3.phasMolEntr[3] variable */);
  TRACE_POP
}
/*
equation index: 296
...
void heater1_eqFunction_299(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[180] /* MatStm3.totMasFlo[1] variable */ = (200.0) * (data->localData[0]->realVars[103] /* MatStm3.MW[1] variable */);
  TRACE_POP
}
/*
equation index: 300
...
void heater1_eqFunction_304(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[119] /* MatStm3.compMasFrac[2,2] variable */ = aux_x[1];
  data->localData[0]->realVars[120] /* MatStm3.compMasFrac[3,1] variable */ = aux_x[2];
  data->localData[0]->realVars[116] /* MatStm3.compMasFrac[1,1] variable */ = aux_x[3];
...
void heater1_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{9d2039b2-898d-4d64-8dc6-208c3f6389d0}";
