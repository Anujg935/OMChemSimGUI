...
void mixer1_eqFunction_283(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */ = (0.01) * (data->localData[0]->realVars[182] /* MatStm2.totMolFlo[3] variable */);
  TRACE_POP
}
/*
equation index: 284
...
void mixer1_eqFunction_284(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[156] /* MatStm2.liqPhasMolFrac variable */ = 1.0 - data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */;
  TRACE_POP
}
/*
equation index: 285
...
void mixer1_eqFunction_285(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[181] /* MatStm2.totMolFlo[2] variable */ = (100.0) * (data->localData[0]->realVars[156] /* MatStm2.liqPhasMolFrac variable */);
  TRACE_POP
}
/*
equation index: 286
...
void residualFunc305(void** dataIn, const double* xloc, double* res, const int* iflag)
{
  ...
  data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */ = xloc[4];
  /* backup outputs */
  /* pre body */
  /* local constraints */
  ...
  else
  {
    ...
    tmp3 = (tmp1?data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,1] variable */ - ((data->localData[0]->realVars[96] /* MatStm2.K[1] variable */) * (data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */)):data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */);
  }
  res[1] = tmp3;
  ...
  if(tmp7)
  {
    tmp8 = data->localData[0]->realVars[142] /* MatStm2.compMolFrac[3,2] variable */;
  }
  else
  {
    tmp6 = GreaterEq(101325.0,data->localData[0]->realVars[103] /* MatStm2.Pdew variable */);
    tmp8 = (tmp6?data->localData[0]->realVars[142] /* MatStm2.compMolFrac[3,2] variable */ - ((data->localData[0]->realVars[97] /* MatStm2.K[2] variable */) * (data->localData[0]->realVars[140] /* MatStm2.compMolFrac[2,2] variable */)):data->localData[0]->realVars[140] /* MatStm2.compMolFrac[2,2] variable */);
  }
  res[3] = tmp8;

  res[4] = data->localData[0]->realVars[135] /* MatStm2.compMolFlo[3,1] variable */ + data->localData[0]->realVars[133] /* MatStm2.compMolFlo[2,1] variable */ - data->localData[0]->realVars[131] /* MatStm2.compMolFlo[1,1] variable */;
  /* restore known outputs */
  TRACE_POP
}
...
void getIterationVarsNLS305(struct DATA *inData, double *array)
{
  ...
  array[4] = data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */;
}
