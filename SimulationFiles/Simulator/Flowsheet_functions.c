...
modelica_real omc_Simulator_Files_Thermodynamic__Functions_Dens(threadData_t *threadData, real_array _LiqDen, modelica_real _TC, modelica_real _T, modelica_real _P)
{
  ...
  if((_T < _TC))
  {
    if(((*real_array_element_addr1(&_LiqDen, 1, /* modelica_integer */ ((modelica_integer) 1))) == 105.0))
    {
      ...
      _density = (1000.0) * (((*real_array_element_addr1(&_LiqDen, 1, /* modelica_integer */ ((modelica_integer) 2)))) * (tmp12));
    }
    else
    {
      if(((*real_array_element_addr1(&_LiqDen, 1, /* modelica_integer */ ((modelica_integer) 1))) == 106.0))
      {
        ...
        _density = (1000.0) * (((*real_array_element_addr1(&_LiqDen, 1, /* modelica_integer */ ((modelica_integer) 2)))) * (tmp21));
      }
    }
  }
  else
...
modelica_metatype boxptr_Simulator_Files_Thermodynamic__Functions_Dens(threadData_t *threadData, modelica_metatype _LiqDen, modelica_metatype _TC, modelica_metatype _T, modelica_metatype _P)
{
  ...
  modelica_real tmp3;
  modelica_real _density;
  modelica_metatype out_density;
  tmp1 = mmc_unbox_real(_TC);
  tmp2 = mmc_unbox_real(_T);
  tmp3 = mmc_unbox_real(_P);
  _density = omc_Simulator_Files_Thermodynamic__Functions_Dens(threadData, *((base_array_t*)_LiqDen), tmp1, tmp2, tmp3);
  out_density = mmc_mk_rcon(_density);
  return out_density;
}
