...
void mixer1_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[105] /* MatStm3.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp0, 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_17(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[97] /* MatStm3.K[2] variable */ = (9.869232667160129e-006) * (data->localData[0]->realVars[105] /* MatStm3.Psat[2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[104] /* MatStm3.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp1, 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_19(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[96] /* MatStm3.K[1] variable */ = (9.869232667160129e-006) * (data->localData[0]->realVars[104] /* MatStm3.Psat[1] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_20(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[124] /* MatStm3.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[328], tmp2, tmp3, data->simulationInfo->realParameter[338], 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[122] /* MatStm3.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[328], tmp4, tmp5, data->simulationInfo->realParameter[338], 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[148] /* MatStm3.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp6, 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_23(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[146] /* MatStm3.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp7, 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[123] /* MatStm3.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[327], tmp8, tmp9, data->simulationInfo->realParameter[337], 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_25(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[121] /* MatStm3.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[327], tmp10, tmp11, data->simulationInfo->realParameter[337], 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[147] /* MatStm3.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp12, 310.0);
  TRACE_POP
}
...
void mixer1_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[145] /* MatStm3.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp13, 310.0);
  TRACE_POP
}
...
equation index: 28
type: SIMPLE_ASSIGN
MatStm4._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm4.comp[2].VP[1], MatStm4.comp[2].VP[2], MatStm4.comp[2].VP[3], MatStm4.comp[2].VP[4], MatStm4.comp[2].VP[5], MatStm4.comp[2].VP[6]}, 320.0)
*/
void mixer1_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[195] /* MatStm4.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp14, 320.0);
  TRACE_POP
}
...
void mixer1_eqFunction_29(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[187] /* MatStm4.K[2] variable */ = (9.869232667160129e-006) * (data->localData[0]->realVars[195] /* MatStm4.Psat[2] variable */);
  TRACE_POP
}
...
equation index: 30
type: SIMPLE_ASSIGN
MatStm4._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm4.comp[1].VP[1], MatStm4.comp[1].VP[2], MatStm4.comp[1].VP[3], MatStm4.comp[1].VP[4], MatStm4.comp[1].VP[5], MatStm4.comp[1].VP[6]}, 320.0)
*/
void mixer1_eqFunction_30(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[194] /* MatStm4.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp15, 320.0);
  TRACE_POP
}
...
void mixer1_eqFunction_31(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[186] /* MatStm4.K[1] variable */ = (9.869232667160129e-006) * (data->localData[0]->realVars[194] /* MatStm4.Psat[1] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_32(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[214] /* MatStm4.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[486], tmp16, tmp17, data->simulationInfo->realParameter[496], 320.0);
  TRACE_POP
}
...
void mixer1_eqFunction_33(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[212] /* MatStm4.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[486], tmp18, tmp19, data->simulationInfo->realParameter[496], 320.0);
  TRACE_POP
}
...
equation index: 34
type: SIMPLE_ASSIGN
MatStm4._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm4.comp[2].VapCp[1], MatStm4.comp[2].VapCp[2], MatStm4.comp[2].VapCp[3], MatStm4.comp[2].VapCp[4], MatStm4.comp[2].VapCp[5], MatStm4.comp[2].VapCp[6]}, 320.0)
*/
void mixer1_eqFunction_34(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[238] /* MatStm4.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp20, 320.0);
  TRACE_POP
}
...
equation index: 35
type: SIMPLE_ASSIGN
MatStm4._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm4.comp[2].LiqCp[1], MatStm4.comp[2].LiqCp[2], MatStm4.comp[2].LiqCp[3], MatStm4.comp[2].LiqCp[4], MatStm4.comp[2].LiqCp[5], MatStm4.comp[2].LiqCp[6]}, 320.0)
*/
void mixer1_eqFunction_35(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[236] /* MatStm4.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp21, 320.0);
  TRACE_POP
}
...
void mixer1_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[213] /* MatStm4.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[485], tmp22, tmp23, data->simulationInfo->realParameter[495], 320.0);
  TRACE_POP
}
...
void mixer1_eqFunction_37(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[211] /* MatStm4.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[485], tmp24, tmp25, data->simulationInfo->realParameter[495], 320.0);
  TRACE_POP
}
...
equation index: 38
type: SIMPLE_ASSIGN
MatStm4._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm4.comp[1].VapCp[1], MatStm4.comp[1].VapCp[2], MatStm4.comp[1].VapCp[3], MatStm4.comp[1].VapCp[4], MatStm4.comp[1].VapCp[5], MatStm4.comp[1].VapCp[6]}, 320.0)
*/
void mixer1_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[237] /* MatStm4.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp26, 320.0);
  TRACE_POP
}
...
equation index: 39
type: SIMPLE_ASSIGN
MatStm4._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm4.comp[1].LiqCp[1], MatStm4.comp[1].LiqCp[2], MatStm4.comp[1].LiqCp[3], MatStm4.comp[1].LiqCp[4], MatStm4.comp[1].LiqCp[5], MatStm4.comp[1].LiqCp[6]}, 320.0)
*/
void mixer1_eqFunction_39(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[235] /* MatStm4.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp27, 320.0);
  TRACE_POP
}
...
equation index: 40
type: SIMPLE_ASSIGN
MatStm4._compMolFrac[1,1] = 0.6
*/
void mixer1_eqFunction_40(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,40};
  data->localData[0]->realVars[227] /* MatStm4.compMolFrac[1,1] variable */ = 0.6;
  TRACE_POP
}
...
void mixer1_eqFunction_43(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[228] /* MatStm4.compMolFrac[1,2] variable */ = 0.4;
  TRACE_POP
}
...
equation index: 46
type: SIMPLE_ASSIGN
MatStm4._Pbubl = MatStm4.compMolFrac[1,1] * exp(MatStm4.comp[1].VP[2] + 0.003125 * MatStm4.comp[1].VP[3] + MatStm4.comp[1].VP[4] * 5.768320995793772 + MatStm4.comp[1].VP[5] * 320.0 ^ MatStm4.comp[1].VP[6]) + MatStm4.compMolFrac[1,2] * exp(MatStm4.comp[2].VP[2] + 0.003125 * MatStm4.comp[2].VP[3] + MatStm4.comp[2].VP[4] * 5.768320995793772 + MatStm4.comp[2].VP[5] * 320.0 ^ MatStm4.comp[2].VP[6])
*/
void mixer1_eqFunction_46(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[192] /* MatStm4.Pbubl variable */ = (data->localData[0]->realVars[227] /* MatStm4.compMolFrac[1,1] variable */) * (exp(data->simulationInfo->realParameter[504] + (0.003125) * (data->simulationInfo->realParameter[505]) + (data->simulationInfo->realParameter[506]) * (5.768320995793772) + (data->simulationInfo->realParameter[507]) * (tmp30))) + (data->localData[0]->realVars[228] /* MatStm4.compMolFrac[1,2] variable */) * (exp(data->simulationInfo->realParameter[510] + (0.003125) * (data->simulationInfo->realParameter[511]) + (data->simulationInfo->realParameter[512]) * (5.768320995793772) + (data->simulationInfo->realParameter[513]) * (tmp37)));
  TRACE_POP
}
...
equation index: 47
type: SIMPLE_ASSIGN
MatStm4._Pdew = 1.0 / (MatStm4.compMolFrac[1,1] * exp((-MatStm4.comp[1].VP[2]) - 0.003125 * MatStm4.comp[1].VP[3] - MatStm4.comp[1].VP[4] * 5.768320995793772 - MatStm4.comp[1].VP[5] * 320.0 ^ MatStm4.comp[1].VP[6]) + MatStm4.compMolFrac[1,2] * exp((-MatStm4.comp[2].VP[2]) - 0.003125 * MatStm4.comp[2].VP[3] - MatStm4.comp[2].VP[4] * 5.768320995793772 - MatStm4.comp[2].VP[5] * 320.0 ^ MatStm4.comp[2].VP[6]))
*/
void mixer1_eqFunction_47(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[193] /* MatStm4.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[227] /* MatStm4.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[504]) - ((0.003125) * (data->simulationInfo->realParameter[505])) - ((data->simulationInfo->realParameter[506]) * (5.768320995793772)) - ((data->simulationInfo->realParameter[507]) * (tmp44)))) + (data->localData[0]->realVars[228] /* MatStm4.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[510]) - ((0.003125) * (data->simulationInfo->realParameter[511])) - ((data->simulationInfo->realParameter[512]) * (5.768320995793772)) - ((data->simulationInfo->realParameter[513]) * (tmp51)))),"MatStm4.compMolFrac[1,1] * exp((-MatStm4.comp[1].VP[2]) - 0.003125 * MatStm4.comp[1].VP[3] - MatStm4.comp[1].VP[4] * 5.768320995793772 - MatStm4.comp[1].VP[5] * 320.0 ^ MatStm4.comp[1].VP[6]) + MatStm4.compMolFrac[1,2] * exp((-MatStm4.comp[2].VP[2]) - 0.003125 * MatStm4.comp[2].VP[3] - MatStm4.comp[2].VP[4] * 5.768320995793772 - MatStm4.comp[2].VP[5] * 320.0 ^ MatStm4.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
void mixer1_eqFunction_48(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[137] /* MatStm3.compMolFrac[1,1] variable */ = 0.5;
  TRACE_POP
}
...
equation index: 51
type: SIMPLE_ASSIGN
MatStm1._compMolFrac[1,1] = 0.5 * (MatStm4.compMolFrac[1,1] + MatStm3.compMolFrac[1,1])
*/
void mixer1_eqFunction_51(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,51};
  data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */ = (0.5) * (data->localData[0]->realVars[227] /* MatStm4.compMolFrac[1,1] variable */ + data->localData[0]->realVars[137] /* MatStm3.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_52(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[138] /* MatStm3.compMolFrac[1,2] variable */ = 0.5;
  TRACE_POP
}
...
equation index: 57
type: SIMPLE_ASSIGN
MatStm1._compMolFrac[1,2] = 0.5 * (MatStm4.compMolFrac[1,2] + MatStm3.compMolFrac[1,2])
*/
void mixer1_eqFunction_57(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,57};
  data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */ = (0.5) * (data->localData[0]->realVars[228] /* MatStm4.compMolFrac[1,2] variable */ + data->localData[0]->realVars[138] /* MatStm3.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
vars: {MatStm4._totMolFlo[3], MatStm4._compMolFrac[3,1], MatStm4._compMolFrac[2,1], MatStm4._compMolFrac[3,2], MatStm4._compMolFrac[2,2]}
...
void mixer1_eqFunction_86(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[0] = data->localData[0]->realVars[272] /* MatStm4.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[1] = data->localData[0]->realVars[231] /* MatStm4.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[2] = data->localData[0]->realVars[229] /* MatStm4.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[3] = data->localData[0]->realVars[232] /* MatStm4.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[4] = data->localData[0]->realVars[230] /* MatStm4.compMolFrac[2,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[272] /* MatStm4.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[0];
  data->localData[0]->realVars[231] /* MatStm4.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[1];
  data->localData[0]->realVars[229] /* MatStm4.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[2];
  data->localData[0]->realVars[232] /* MatStm4.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[3];
  data->localData[0]->realVars[230] /* MatStm4.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[4];
  TRACE_POP
}
...
void mixer1_eqFunction_91(DATA *data, threadData_t *threadData)
{
  ...
  array_alloc_scalar_real_array(&tmp0, 6, (modelica_real)data->simulationInfo->realParameter[521], (modelica_real)data->simulationInfo->realParameter[522], (modelica_real)data->simulationInfo->realParameter[523], (modelica_real)data->simulationInfo->realParameter[524], (modelica_real)data->simulationInfo->realParameter[525], (modelica_real)data->simulationInfo->realParameter[526]);
  array_alloc_scalar_real_array(&tmp1, 6, (modelica_real)data->simulationInfo->realParameter[421], (modelica_real)data->simulationInfo->realParameter[422], (modelica_real)data->simulationInfo->realParameter[423], (modelica_real)data->simulationInfo->realParameter[424], (modelica_real)data->simulationInfo->realParameter[425], (modelica_real)data->simulationInfo->realParameter[426]);
  data->localData[0]->realVars[218] /* MatStm4.compMolEntr[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_SId(threadData, data->simulationInfo->realParameter[398], tmp0, tmp1, data->simulationInfo->realParameter[494], data->simulationInfo->realParameter[496], 320.0, 101325.0, data->localData[0]->realVars[230] /* MatStm4.compMolFrac[2,2] variable */, data->localData[0]->realVars[232] /* MatStm4.compMolFrac[3,2] variable */ ,&data->localData[0]->realVars[220] /* MatStm4.compMolEntr[3,2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_115(DATA *data, threadData_t *threadData)
{
  ...
  int retValue;
  double aux_x[5] = { data->localData[1]->realVars[205] /* MatStm4.compMasFrac[2,1] variable */,data->localData[1]->realVars[207] /* MatStm4.compMasFrac[3,1] variable */,data->localData[1]->realVars[203] /* MatStm4.compMasFrac[1,1] variable */,data->localData[1]->realVars[206] /* MatStm4.compMasFrac[2,2] variable */,data->localData[1]->realVars[208] /* MatStm4.compMasFrac[3,2] variable */ };
  if(ACTIVE_STREAM(LOG_DT))
  {
  ...
  /* write solution */
  data->localData[0]->realVars[205] /* MatStm4.compMasFrac[2,1] variable */ = aux_x[0];
  data->localData[0]->realVars[207] /* MatStm4.compMasFrac[3,1] variable */ = aux_x[1];
  data->localData[0]->realVars[203] /* MatStm4.compMasFrac[1,1] variable */ = aux_x[2];
  data->localData[0]->realVars[206] /* MatStm4.compMasFrac[2,2] variable */ = aux_x[3];
  data->localData[0]->realVars[208] /* MatStm4.compMasFrac[3,2] variable */ = aux_x[4];
  TRACE_POP
}
...
void mixer1_eqFunction_140(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[0] = data->localData[0]->realVars[181] /* MatStm3.totMolFlo[2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[1] = data->localData[0]->realVars[139] /* MatStm3.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[2] = data->localData[0]->realVars[140] /* MatStm3.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[3] = data->localData[0]->realVars[141] /* MatStm3.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[4] = data->localData[0]->realVars[142] /* MatStm3.compMolFrac[3,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[181] /* MatStm3.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[0];
  data->localData[0]->realVars[139] /* MatStm3.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[1];
  data->localData[0]->realVars[140] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[2];
  data->localData[0]->realVars[141] /* MatStm3.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[3];
  data->localData[0]->realVars[142] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[4];
  TRACE_POP
}
...
void mixer1_eqFunction_213(DATA *data, threadData_t *threadData)
{
  ...
  array_alloc_scalar_real_array(&tmp10, 6, (modelica_real)data->simulationInfo->realParameter[363], (modelica_real)data->simulationInfo->realParameter[364], (modelica_real)data->simulationInfo->realParameter[365], (modelica_real)data->simulationInfo->realParameter[366], (modelica_real)data->simulationInfo->realParameter[367], (modelica_real)data->simulationInfo->realParameter[368]);
  array_alloc_scalar_real_array(&tmp11, 6, (modelica_real)data->simulationInfo->realParameter[263], (modelica_real)data->simulationInfo->realParameter[264], (modelica_real)data->simulationInfo->realParameter[265], (modelica_real)data->simulationInfo->realParameter[266], (modelica_real)data->simulationInfo->realParameter[267], (modelica_real)data->simulationInfo->realParameter[268]);
  data->localData[0]->realVars[128] /* MatStm3.compMolEntr[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_SId(threadData, data->simulationInfo->realParameter[240], tmp10, tmp11, data->simulationInfo->realParameter[336], data->simulationInfo->realParameter[338], 310.0, 101325.0, data->localData[0]->realVars[140] /* MatStm3.compMolFrac[2,2] variable */, data->localData[0]->realVars[142] /* MatStm3.compMolFrac[3,2] variable */ ,&data->localData[0]->realVars[130] /* MatStm3.compMolEntr[3,2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_219(DATA *data, threadData_t *threadData)
{
  ...
  if(!(((tmp16 > 0) && (tmp15 > tmp17)) || ((tmp16 < 0) && (tmp15 < tmp17))))
  {
    ...
    for($Pi = ((modelica_integer) 1); in_range_integer($Pi, tmp15, tmp17); $Pi += tmp16)
    {
      ...
      real_array_create(&tmp14, (modelica_real*)&data->localData[0]->realVars[98] /* MatStm3.MW[1] variable */, 1, 3);
...
void mixer1_eqFunction_226(DATA *data, threadData_t *threadData)
{
  ...
  /* write solution */
  data->localData[0]->realVars[116] /* MatStm3.compMasFrac[2,2] variable */ = aux_x[0];
  data->localData[0]->realVars[118] /* MatStm3.compMasFrac[3,2] variable */ = aux_x[1];
  data->localData[0]->realVars[115] /* MatStm3.compMasFrac[2,1] variable */ = aux_x[2];
  data->localData[0]->realVars[117] /* MatStm3.compMasFrac[3,1] variable */ = aux_x[3];
  data->localData[0]->realVars[113] /* MatStm3.compMasFrac[1,1] variable */ = aux_x[4];
  TRACE_POP
}
...
void mixer1_eqFunction_271(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[191] /* MatStm4.P variable */ = 101325.0;
  TRACE_POP
}
...
void mixer1_eqFunction_272(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[196] /* MatStm4.T variable */ = 320.0;
  TRACE_POP
}
...
void mixer1_eqFunction_274(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[101] /* MatStm3.P variable */ = 101325.0;
  TRACE_POP
}
...
void mixer1_eqFunction_275(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[106] /* MatStm3.T variable */ = 310.0;
  TRACE_POP
}
