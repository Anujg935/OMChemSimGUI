...
equation index: 16
type: SIMPLE_ASSIGN
MatStm2._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm2.comp[2].VP[1], MatStm2.comp[2].VP[2], MatStm2.comp[2].VP[3], MatStm2.comp[2].VP[4], MatStm2.comp[2].VP[5], MatStm2.comp[2].VP[6]}, 361.0)
*/
void mixer1_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[104] /* MatStm2.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp0, 361.0);
  TRACE_POP
}
...
equation index: 18
type: SIMPLE_ASSIGN
MatStm2._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm2.comp[1].VP[1], MatStm2.comp[1].VP[2], MatStm2.comp[1].VP[3], MatStm2.comp[1].VP[4], MatStm2.comp[1].VP[5], MatStm2.comp[1].VP[6]}, 361.0)
*/
void mixer1_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[103] /* MatStm2.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp1, 361.0);
  TRACE_POP
}
...
void mixer1_eqFunction_20(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[123] /* MatStm2.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[328], tmp2, tmp3, data->simulationInfo->realParameter[338], 361.0);
  TRACE_POP
}
...
void mixer1_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[121] /* MatStm2.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[328], tmp4, tmp5, data->simulationInfo->realParameter[338], 361.0);
  TRACE_POP
}
...
equation index: 22
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm2.comp[2].VapCp[1], MatStm2.comp[2].VapCp[2], MatStm2.comp[2].VapCp[3], MatStm2.comp[2].VapCp[4], MatStm2.comp[2].VapCp[5], MatStm2.comp[2].VapCp[6]}, 361.0)
*/
void mixer1_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[147] /* MatStm2.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp6, 361.0);
  TRACE_POP
}
...
equation index: 23
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm2.comp[2].LiqCp[1], MatStm2.comp[2].LiqCp[2], MatStm2.comp[2].LiqCp[3], MatStm2.comp[2].LiqCp[4], MatStm2.comp[2].LiqCp[5], MatStm2.comp[2].LiqCp[6]}, 361.0)
*/
void mixer1_eqFunction_23(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[145] /* MatStm2.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp7, 361.0);
  TRACE_POP
}
...
void mixer1_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[122] /* MatStm2.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[327], tmp8, tmp9, data->simulationInfo->realParameter[337], 361.0);
  TRACE_POP
}
...
void mixer1_eqFunction_25(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[120] /* MatStm2.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[327], tmp10, tmp11, data->simulationInfo->realParameter[337], 361.0);
  TRACE_POP
}
...
equation index: 26
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm2.comp[1].VapCp[1], MatStm2.comp[1].VapCp[2], MatStm2.comp[1].VapCp[3], MatStm2.comp[1].VapCp[4], MatStm2.comp[1].VapCp[5], MatStm2.comp[1].VapCp[6]}, 361.0)
*/
void mixer1_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[146] /* MatStm2.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp12, 361.0);
  TRACE_POP
}
...
equation index: 27
type: SIMPLE_ASSIGN
MatStm2._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm2.comp[1].LiqCp[1], MatStm2.comp[1].LiqCp[2], MatStm2.comp[1].LiqCp[3], MatStm2.comp[1].LiqCp[4], MatStm2.comp[1].LiqCp[5], MatStm2.comp[1].LiqCp[6]}, 361.0)
*/
void mixer1_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[144] /* MatStm2.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp13, 361.0);
  TRACE_POP
}
...
equation index: 28
type: SIMPLE_ASSIGN
MatStm1._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm1.comp[2].VP[1], MatStm1.comp[2].VP[2], MatStm1.comp[2].VP[3], MatStm1.comp[2].VP[4], MatStm1.comp[2].VP[5], MatStm1.comp[2].VP[6]}, 341.0)
*/
void mixer1_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[14] /* MatStm1.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp14, 341.0);
  TRACE_POP
}
...
equation index: 30
type: SIMPLE_ASSIGN
MatStm1._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm1.comp[1].VP[1], MatStm1.comp[1].VP[2], MatStm1.comp[1].VP[3], MatStm1.comp[1].VP[4], MatStm1.comp[1].VP[5], MatStm1.comp[1].VP[6]}, 341.0)
*/
void mixer1_eqFunction_30(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[13] /* MatStm1.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp15, 341.0);
  TRACE_POP
}
...
void mixer1_eqFunction_32(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[33] /* MatStm1.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[170], tmp16, tmp17, data->simulationInfo->realParameter[180], 341.0);
  TRACE_POP
}
...
void mixer1_eqFunction_33(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[31] /* MatStm1.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[170], tmp18, tmp19, data->simulationInfo->realParameter[180], 341.0);
  TRACE_POP
}
...
equation index: 34
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm1.comp[2].VapCp[1], MatStm1.comp[2].VapCp[2], MatStm1.comp[2].VapCp[3], MatStm1.comp[2].VapCp[4], MatStm1.comp[2].VapCp[5], MatStm1.comp[2].VapCp[6]}, 341.0)
*/
void mixer1_eqFunction_34(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[57] /* MatStm1.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp20, 341.0);
  TRACE_POP
}
...
equation index: 35
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm1.comp[2].LiqCp[1], MatStm1.comp[2].LiqCp[2], MatStm1.comp[2].LiqCp[3], MatStm1.comp[2].LiqCp[4], MatStm1.comp[2].LiqCp[5], MatStm1.comp[2].LiqCp[6]}, 341.0)
*/
void mixer1_eqFunction_35(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[55] /* MatStm1.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp21, 341.0);
  TRACE_POP
}
...
void mixer1_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[32] /* MatStm1.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[169], tmp22, tmp23, data->simulationInfo->realParameter[179], 341.0);
  TRACE_POP
}
...
void mixer1_eqFunction_37(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[30] /* MatStm1.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[169], tmp24, tmp25, data->simulationInfo->realParameter[179], 341.0);
  TRACE_POP
}
...
equation index: 38
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm1.comp[1].VapCp[1], MatStm1.comp[1].VapCp[2], MatStm1.comp[1].VapCp[3], MatStm1.comp[1].VapCp[4], MatStm1.comp[1].VapCp[5], MatStm1.comp[1].VapCp[6]}, 341.0)
*/
void mixer1_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[56] /* MatStm1.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp26, 341.0);
  TRACE_POP
}
...
equation index: 39
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm1.comp[1].LiqCp[1], MatStm1.comp[1].LiqCp[2], MatStm1.comp[1].LiqCp[3], MatStm1.comp[1].LiqCp[4], MatStm1.comp[1].LiqCp[5], MatStm1.comp[1].LiqCp[6]}, 341.0)
*/
void mixer1_eqFunction_39(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[54] /* MatStm1.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp27, 341.0);
  TRACE_POP
}
...
void mixer1_eqFunction_40(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */ = 0.6;
  TRACE_POP
}
...
void mixer1_eqFunction_41(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[40] /* MatStm1.compMolFlo[1,1] variable */ = (100.0) * (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_43(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */ = 0.4;
  TRACE_POP
}
...
void mixer1_eqFunction_44(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[41] /* MatStm1.compMolFlo[1,2] variable */ = (100.0) * (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
equation index: 46
type: SIMPLE_ASSIGN
MatStm1._Pbubl = MatStm1.compMolFrac[1,1] * exp(MatStm1.comp[1].VP[2] + MatStm1.comp[1].VP[3] / 341.0 + MatStm1.comp[1].VP[4] * 5.831882477283517 + MatStm1.comp[1].VP[5] * 341.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp(MatStm1.comp[2].VP[2] + MatStm1.comp[2].VP[3] / 341.0 + MatStm1.comp[2].VP[4] * 5.831882477283517 + MatStm1.comp[2].VP[5] * 341.0 ^ MatStm1.comp[2].VP[6])
*/
...
equation index: 47
type: SIMPLE_ASSIGN
MatStm1._Pdew = 1.0 / (MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 341.0 - MatStm1.comp[1].VP[4] * 5.831882477283517 - MatStm1.comp[1].VP[5] * 341.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 341.0 - MatStm1.comp[2].VP[4] * 5.831882477283517 - MatStm1.comp[2].VP[5] * 341.0 ^ MatStm1.comp[2].VP[6]))
*/
void mixer1_eqFunction_47(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[12] /* MatStm1.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[188]) - (DIVISION_SIM(data->simulationInfo->realParameter[189],341.0,"341.0",equationIndexes)) - ((data->simulationInfo->realParameter[190]) * (5.831882477283517)) - ((data->simulationInfo->realParameter[191]) * (tmp44)))) + (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[194]) - (DIVISION_SIM(data->simulationInfo->realParameter[195],341.0,"341.0",equationIndexes)) - ((data->simulationInfo->realParameter[196]) * (5.831882477283517)) - ((data->simulationInfo->realParameter[197]) * (tmp51)))),"MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 341.0 - MatStm1.comp[1].VP[4] * 5.831882477283517 - MatStm1.comp[1].VP[5] * 341.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 341.0 - MatStm1.comp[2].VP[4] * 5.831882477283517 - MatStm1.comp[2].VP[5] * 341.0 ^ MatStm1.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
void mixer1_eqFunction_49(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[130] /* MatStm2.compMolFlo[1,1] variable */ = (100.0) * (data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
equation index: 51
type: SIMPLE_ASSIGN
MatStm3._compMolFrac[1,1] = 0.5 * (MatStm1.compMolFrac[1,1] + MatStm2.compMolFrac[1,1])
*/
void mixer1_eqFunction_51(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,51};
  data->localData[0]->realVars[226] /* MatStm3.compMolFrac[1,1] variable */ = (0.5) * (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */ + data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_53(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[131] /* MatStm2.compMolFlo[1,2] variable */ = (100.0) * (data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
equation index: 55
type: SIMPLE_ASSIGN
MatStm2._Pbubl = MatStm2.compMolFrac[1,1] * exp(MatStm2.comp[1].VP[2] + MatStm2.comp[1].VP[3] / 361.0 + MatStm2.comp[1].VP[4] * 5.888877958332881 + MatStm2.comp[1].VP[5] * 361.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp(MatStm2.comp[2].VP[2] + MatStm2.comp[2].VP[3] / 361.0 + MatStm2.comp[2].VP[4] * 5.888877958332881 + MatStm2.comp[2].VP[5] * 361.0 ^ MatStm2.comp[2].VP[6])
*/
void mixer1_eqFunction_55(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[101] /* MatStm2.Pbubl variable */ = (data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */) * (exp(data->simulationInfo->realParameter[346] + DIVISION_SIM(data->simulationInfo->realParameter[347],361.0,"361.0",equationIndexes) + (data->simulationInfo->realParameter[348]) * (5.888877958332881) + (data->simulationInfo->realParameter[349]) * (tmp58))) + (data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */) * (exp(data->simulationInfo->realParameter[352] + DIVISION_SIM(data->simulationInfo->realParameter[353],361.0,"361.0",equationIndexes) + (data->simulationInfo->realParameter[354]) * (5.888877958332881) + (data->simulationInfo->realParameter[355]) * (tmp65)));
  TRACE_POP
}
...
equation index: 56
type: SIMPLE_ASSIGN
MatStm2._Pdew = 1.0 / (MatStm2.compMolFrac[1,1] * exp((-MatStm2.comp[1].VP[2]) - MatStm2.comp[1].VP[3] / 361.0 - MatStm2.comp[1].VP[4] * 5.888877958332881 - MatStm2.comp[1].VP[5] * 361.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp((-MatStm2.comp[2].VP[2]) - MatStm2.comp[2].VP[3] / 361.0 - MatStm2.comp[2].VP[4] * 5.888877958332881 - MatStm2.comp[2].VP[5] * 361.0 ^ MatStm2.comp[2].VP[6]))
*/
void mixer1_eqFunction_56(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[102] /* MatStm2.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[346]) - (DIVISION_SIM(data->simulationInfo->realParameter[347],361.0,"361.0",equationIndexes)) - ((data->simulationInfo->realParameter[348]) * (5.888877958332881)) - ((data->simulationInfo->realParameter[349]) * (tmp72)))) + (data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[352]) - (DIVISION_SIM(data->simulationInfo->realParameter[353],361.0,"361.0",equationIndexes)) - ((data->simulationInfo->realParameter[354]) * (5.888877958332881)) - ((data->simulationInfo->realParameter[355]) * (tmp79)))),"MatStm2.compMolFrac[1,1] * exp((-MatStm2.comp[1].VP[2]) - MatStm2.comp[1].VP[3] / 361.0 - MatStm2.comp[1].VP[4] * 5.888877958332881 - MatStm2.comp[1].VP[5] * 361.0 ^ MatStm2.comp[1].VP[6]) + MatStm2.compMolFrac[1,2] * exp((-MatStm2.comp[2].VP[2]) - MatStm2.comp[2].VP[3] / 361.0 - MatStm2.comp[2].VP[4] * 5.888877958332881 - MatStm2.comp[2].VP[5] * 361.0 ^ MatStm2.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
equation index: 57
type: SIMPLE_ASSIGN
MatStm3._compMolFrac[1,2] = 0.5 * (MatStm1.compMolFrac[1,2] + MatStm2.compMolFrac[1,2])
*/
void mixer1_eqFunction_57(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,57};
  data->localData[0]->realVars[227] /* MatStm3.compMolFrac[1,2] variable */ = (0.5) * (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */ + data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_86(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[0] = data->localData[0]->realVars[91] /* MatStm1.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[1] = data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[2] = data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[3] = data->localData[0]->realVars[51] /* MatStm1.compMolFrac[3,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[91] /* MatStm1.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[0];
  data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[1];
  data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[2];
  data->localData[0]->realVars[51] /* MatStm1.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[3];
...
void mixer1_eqFunction_115(DATA *data, threadData_t *threadData)
{
  ...
  int retValue;
  double aux_x[5] = { data->localData[1]->realVars[24] /* MatStm1.compMasFrac[2,1] variable */,data->localData[1]->realVars[26] /* MatStm1.compMasFrac[3,1] variable */,data->localData[1]->realVars[22] /* MatStm1.compMasFrac[1,1] variable */,data->localData[1]->realVars[25] /* MatStm1.compMasFrac[2,2] variable */,data->localData[1]->realVars[27] /* MatStm1.compMasFrac[3,2] variable */ };
  if(ACTIVE_STREAM(LOG_DT))
  {
  ...
  /* write solution */
  data->localData[0]->realVars[24] /* MatStm1.compMasFrac[2,1] variable */ = aux_x[0];
...
void mixer1_eqFunction_140(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[0] = data->localData[0]->realVars[180] /* MatStm2.totMolFlo[2] variable */;
  ...
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[3] = data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[4] = data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[180] /* MatStm2.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[0];
  ...
  data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[3];
  data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[4];
  TRACE_POP
}
...
vars: {MatStm3._totMolFlo[3], MatStm3._compMolFrac[2,1], MatStm3._compMolFrac[3,2], MatStm3._compMolFrac[2,2], MatStm3._T, MatStm3._compMolFrac[3,1]}
...
void mixer1_eqFunction_180(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[1] = data->localData[0]->realVars[228] /* MatStm3.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[2] = data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[3] = data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[4] = data->localData[0]->realVars[195] /* MatStm3.T variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[5] = data->localData[0]->realVars[230] /* MatStm3.compMolFrac[3,1] variable */;
  ...
  data->localData[0]->realVars[228] /* MatStm3.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[1];
  data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[2];
  data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[3];
  data->localData[0]->realVars[195] /* MatStm3.T variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[4];
  data->localData[0]->realVars[230] /* MatStm3.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[5];
  TRACE_POP
}
...
void mixer1_eqFunction_192(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[205] /* MatStm3.compMasFrac[2,2] variable */ = aux_x[2];
...
void mixer1_eqFunction_219(DATA *data, threadData_t *threadData)
{
  ...
  if(!(((tmp16 > 0) && (tmp15 > tmp17)) || ((tmp16 < 0) && (tmp15 < tmp17))))
  {
    ...
    for($Pi = ((modelica_integer) 1); in_range_integer($Pi, tmp15, tmp17); $Pi += tmp16)
    {
      ...
      real_array_create(&tmp14, (modelica_real*)&data->localData[0]->realVars[97] /* MatStm2.MW[1] variable */, 1, 3);
...
void mixer1_eqFunction_226(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[116] /* MatStm2.compMasFrac[3,1] variable */ = aux_x[3];
  data->localData[0]->realVars[112] /* MatStm2.compMasFrac[1,1] variable */ = aux_x[4];
  TRACE_POP
}
...
void mixer1_eqFunction_227(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[269] /* MatStm3.totMolFlo[1] variable */ = 200.0;
  TRACE_POP
}
...
void mixer1_eqFunction_272(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[15] /* MatStm1.T variable */ = 341.0;
  TRACE_POP
}
...
void mixer1_eqFunction_273(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[89] /* MatStm1.totMolFlo[1] variable */ = 100.0;
  TRACE_POP
}
...
void mixer1_eqFunction_275(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[105] /* MatStm2.T variable */ = 361.0;
  TRACE_POP
}
...
void mixer1_eqFunction_276(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[179] /* MatStm2.totMolFlo[1] variable */ = 100.0;
  TRACE_POP
}
OMC_DISABLE_OPT
void mixer1_functionInitialEquations_0(DATA *data, threadData_t *threadData)
