...
equation index: 220
type: SIMPLE_ASSIGN
MatStm2._phasMolEnth[1] = MatStm1.phasMolEnth[1] - 200.0 * Cooler1.eff
*/
void cooler1_eqFunction_220(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,220};
  data->localData[0]->realVars[162] /* MatStm2.phasMolEnth[1] variable */ = data->localData[0]->realVars[74] /* MatStm1.phasMolEnth[1] variable */ - ((200.0) * (data->simulationInfo->realParameter[158]));
  TRACE_POP
}
/*
equation index: 221
...
void cooler1_eqFunction_277(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[0] = data->localData[0]->realVars[184] /* MatStm2.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[1] = data->localData[0]->realVars[8] /* Cooler1.outT variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[2] = data->localData[0]->realVars[144] /* MatStm2.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[3] = data->localData[0]->realVars[142] /* MatStm2.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[4] = data->localData[0]->realVars[143] /* MatStm2.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[5] = data->localData[0]->realVars[145] /* MatStm2.compMolFrac[3,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[184] /* MatStm2.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[0];
  data->localData[0]->realVars[8] /* Cooler1.outT variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[1];
  data->localData[0]->realVars[144] /* MatStm2.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[2];
  data->localData[0]->realVars[142] /* MatStm2.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[3];
  data->localData[0]->realVars[143] /* MatStm2.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[4];
  data->localData[0]->realVars[145] /* MatStm2.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[5];
  TRACE_POP
}
/*
equation index: 278
...
equation index: 282
type: SIMPLE_ASSIGN
Cooler1._tempDrop = 310.0 - Cooler1.outT
*/
void cooler1_eqFunction_282(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,282};
  data->localData[0]->realVars[10] /* Cooler1.tempDrop variable */ = 310.0 - data->localData[0]->realVars[8] /* Cooler1.outT variable */;
  TRACE_POP
}
/*
equation index: 283
...
void cooler1_eqFunction_304(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[119] /* MatStm2.compMasFrac[2,2] variable */ = aux_x[1];
  data->localData[0]->realVars[120] /* MatStm2.compMasFrac[3,1] variable */ = aux_x[2];
  data->localData[0]->realVars[116] /* MatStm2.compMasFrac[1,1] variable */ = aux_x[3];
...
void cooler1_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{473cc7d9-af45-45db-bd1c-c3ffc85ab8b8}";
