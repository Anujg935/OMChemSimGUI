...
CPPFLAGS= -I"C:/OpenModelica1.13.264bit//include/omc/c" -I. -DOPENMODELICA_XML_FROM_FILE_AT_RUNTIME -DOMC_MODEL_PREFIX=flash1 -DOMC_NUM_MIXED_SYSTEMS=0 -DOMC_NUM_LINEAR_SYSTEMS=6 -DOMC_NUM_NONLINEAR_SYSTEMS=8 -DOMC_NDELAY_EXPRESSIONS=0 -DOMC_NVAR_STRING=0
...
MAINFILE=flash1.c
MAINOBJ=flash1.o
CFILES=flash1_functions.c flash1_records.c \
flash1_01exo.c flash1_02nls.c flash1_03lsy.c flash1_04set.c flash1_05evt.c flash1_06inz.c flash1_07dly.c \
flash1_08bnd.c flash1_09alg.c flash1_10asr.c flash1_11mix.c flash1_12jac.c flash1_13opt.c flash1_14lnz.c \
flash1_15syn.c flash1_16dae.c flash1_17inl.c 

OFILES=$(CFILES:.c=.o)
GENERATEDFILES=$(MAINFILE) flash1.makefile flash1_literals.h flash1_functions.h $(CFILES)

.PHONY: omc_main_target clean bundle

# This is to make sure that flash1_*.c are always compiled.
.PHONY: $(CFILES)

omc_main_target: $(MAINOBJ) flash1_functions.h flash1_literals.h $(OFILES)
	$(CC) -I. -o flash1$(EXEEXT) $(MAINOBJ) $(OFILES) $(CPPFLAGS) $(DIREXTRA)   $(CFLAGS) $(CPPFLAGS) $(LDFLAGS)
clean:
	@rm -f flash1_records.o $(MAINOBJ)

bundle:
	@tar -cvf flash1_Files.tar $(GENERATEDFILES)