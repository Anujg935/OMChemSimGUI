...
void mixer1_eqFunction_74(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* MatStm3.compMolFlo.$pDERNLSJac0.dummyVarNLSJac0[3,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[50] /* MatStm3.compMolFrac[3,1] variable */) * (jacobian->seedVars[0] /* MatStm3.totMolFlo.SeedNLSJac0[3] SEED_VAR */) + (jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac0[3,1] SEED_VAR */) * (data->localData[0]->realVars[91] /* MatStm3.totMolFlo[3] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_75(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm3.compMolFlo.$pDERNLSJac0.dummyVarNLSJac0[3,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[51] /* MatStm3.compMolFrac[3,2] variable */) * (jacobian->seedVars[0] /* MatStm3.totMolFlo.SeedNLSJac0[3] SEED_VAR */) + (jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac0[3,2] SEED_VAR */) * (data->localData[0]->realVars[91] /* MatStm3.totMolFlo[3] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_79(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* MatStm3.compMolFlo.$pDERNLSJac0.dummyVarNLSJac0[2,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[48] /* MatStm3.compMolFrac[2,1] variable */) * (jacobian->tmpVars[4] /* MatStm3.totMolFlo.$pDERNLSJac0.dummyVarNLSJac0[2] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */) * (data->localData[0]->realVars[90] /* MatStm3.totMolFlo[2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_80(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* MatStm3.compMolFlo.$pDERNLSJac0.dummyVarNLSJac0[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[49] /* MatStm3.compMolFrac[2,2] variable */) * (jacobian->tmpVars[4] /* MatStm3.totMolFlo.$pDERNLSJac0.dummyVarNLSJac0[2] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */) * (data->localData[0]->realVars[90] /* MatStm3.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 81
type: SIMPLE_ASSIGN
$res1._$pDERNLSJac0._dummyVarNLSJac0 = if 101325.0 >= MatStm3.Pbubl then MatStm3.compMolFrac.SeedNLSJac0[3,2] else if 101325.0 >= MatStm3.Pdew then MatStm3.compMolFrac.SeedNLSJac0[3,2] - MatStm3.K[2] * MatStm3.compMolFrac.SeedNLSJac0[2,2] else MatStm3.compMolFrac.SeedNLSJac0[2,2]
*/
void mixer1_eqFunction_81(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  else
  {
    ...
    tmp3 = (tmp1?jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac0[3,2] SEED_VAR */ - ((data->localData[0]->realVars[6] /* MatStm3.K[2] variable */) * (jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */)):jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */);
  }
...
equation index: 85
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac0._dummyVarNLSJac0 = if 101325.0 >= MatStm3.Pbubl then MatStm3.compMolFrac.SeedNLSJac0[3,1] else if 101325.0 >= MatStm3.Pdew then MatStm3.compMolFrac.SeedNLSJac0[3,1] - MatStm3.K[1] * MatStm3.compMolFrac.SeedNLSJac0[2,1] else MatStm3.compMolFrac.SeedNLSJac0[2,1]
*/
void mixer1_eqFunction_85(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  else
  {
    ...
    tmp8 = (tmp6?jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac0[3,1] SEED_VAR */ - ((data->localData[0]->realVars[5] /* MatStm3.K[1] variable */) * (jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */)):jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */);
  }
...
void mixer1_eqFunction_128(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[229] /* MatStm5.compMolFrac[2,1] variable */) * (jacobian->seedVars[0] /* MatStm5.totMolFlo.SeedNLSJac1[2] SEED_VAR */) + (jacobian->seedVars[1] /* MatStm5.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */) * (data->localData[0]->realVars[271] /* MatStm5.totMolFlo[2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_129(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[230] /* MatStm5.compMolFrac[2,2] variable */) * (jacobian->seedVars[0] /* MatStm5.totMolFlo.SeedNLSJac1[2] SEED_VAR */) + (jacobian->seedVars[2] /* MatStm5.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */) * (data->localData[0]->realVars[271] /* MatStm5.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 132
type: SIMPLE_ASSIGN
MatStm5._totMolFlo._$pDERNLSJac1._dummyVarNLSJac1[3] = 100.0 * Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2]
*/
void mixer1_eqFunction_132(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* MatStm5.totMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3] JACOBIAN_DIFF_VAR */ = (100.0) * (jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2] JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void mixer1_eqFunction_133(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[231] /* MatStm5.compMolFrac[3,1] variable */) * (jacobian->tmpVars[4] /* MatStm5.totMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[3] /* MatStm5.compMolFrac.SeedNLSJac1[3,1] SEED_VAR */) * (data->localData[0]->realVars[272] /* MatStm5.totMolFlo[3] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_134(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[232] /* MatStm5.compMolFrac[3,2] variable */) * (jacobian->tmpVars[4] /* MatStm5.totMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[4] /* MatStm5.compMolFrac.SeedNLSJac1[3,2] SEED_VAR */) * (data->localData[0]->realVars[272] /* MatStm5.totMolFlo[3] variable */);
  TRACE_POP
}
...
equation index: 135
type: SIMPLE_ASSIGN
$res1._$pDERNLSJac1._dummyVarNLSJac1 = MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,2] + MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,2]
*/
void mixer1_eqFunction_135(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[0] /* $res1.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_VAR */ = jacobian->tmpVars[6] /* MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,2] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[1] /* MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,2] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 136
type: SIMPLE_ASSIGN
$res2._$pDERNLSJac1._dummyVarNLSJac1 = if 101325.0 >= MatStm5.Pbubl then MatStm5.compMolFrac.SeedNLSJac1[3,2] else if 101325.0 >= MatStm5.Pdew then MatStm5.compMolFrac.SeedNLSJac1[3,2] - MatStm5.K[2] * MatStm5.compMolFrac.SeedNLSJac1[2,2] else MatStm5.compMolFrac.SeedNLSJac1[2,2]
*/
void mixer1_eqFunction_136(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp12;
  tmp9 = GreaterEq(101325.0,data->localData[0]->realVars[192] /* MatStm5.Pbubl variable */);
  tmp11 = (modelica_boolean)tmp9;
  if(tmp11)
  {
    tmp12 = jacobian->seedVars[4] /* MatStm5.compMolFrac.SeedNLSJac1[3,2] SEED_VAR */;
  }
  else
  {
    tmp10 = GreaterEq(101325.0,data->localData[0]->realVars[193] /* MatStm5.Pdew variable */);
    tmp12 = (tmp10?jacobian->seedVars[4] /* MatStm5.compMolFrac.SeedNLSJac1[3,2] SEED_VAR */ - ((data->localData[0]->realVars[187] /* MatStm5.K[2] variable */) * (jacobian->seedVars[2] /* MatStm5.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */)):jacobian->seedVars[2] /* MatStm5.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */);
  }
...
equation index: 137
type: SIMPLE_ASSIGN
$res3._$pDERNLSJac1._dummyVarNLSJac1 = MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,1] + MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,1]
*/
void mixer1_eqFunction_137(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[2] /* $res3.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_VAR */ = jacobian->tmpVars[5] /* MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,1] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[0] /* MatStm5.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,1] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 138
type: SIMPLE_ASSIGN
$res4._$pDERNLSJac1._dummyVarNLSJac1 = if 101325.0 >= MatStm5.Pbubl then MatStm5.compMolFrac.SeedNLSJac1[2,1] + MatStm5.compMolFrac.SeedNLSJac1[2,2] else MatStm5.compMolFrac.SeedNLSJac1[3,1] + MatStm5.compMolFrac.SeedNLSJac1[3,2]
*/
void mixer1_eqFunction_138(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp13 = GreaterEq(101325.0,data->localData[0]->realVars[192] /* MatStm5.Pbubl variable */);
  jacobian->resultVars[3] /* $res4.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_VAR */ = (tmp13?jacobian->seedVars[1] /* MatStm5.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */ + jacobian->seedVars[2] /* MatStm5.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */:jacobian->seedVars[3] /* MatStm5.compMolFrac.SeedNLSJac1[3,1] SEED_VAR */ + jacobian->seedVars[4] /* MatStm5.compMolFrac.SeedNLSJac1[3,2] SEED_VAR */);
  TRACE_POP
}
...
void mixer1_eqFunction_139(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp17;
  tmp14 = GreaterEq(101325.0,data->localData[0]->realVars[192] /* MatStm5.Pbubl variable */);
  tmp16 = (modelica_boolean)tmp14;
  if(tmp16)
  {
    tmp17 = jacobian->seedVars[3] /* MatStm5.compMolFrac.SeedNLSJac1[3,1] SEED_VAR */;
  }
  else
  {
    tmp15 = GreaterEq(101325.0,data->localData[0]->realVars[193] /* MatStm5.Pdew variable */);
    tmp17 = (tmp15?jacobian->seedVars[3] /* MatStm5.compMolFrac.SeedNLSJac1[3,1] SEED_VAR */ - ((data->localData[0]->realVars[186] /* MatStm5.K[1] variable */) * (jacobian->seedVars[1] /* MatStm5.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */)):jacobian->seedVars[1] /* MatStm5.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */);
  }
...
void mixer1_eqFunction_293(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* MatStm3.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[3,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[50] /* MatStm3.compMolFrac[3,1] variable */) * (jacobian->seedVars[0] /* MatStm3.totMolFlo.SeedNLSJac3[3] SEED_VAR */) + (jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac3[3,1] SEED_VAR */) * (data->localData[0]->realVars[91] /* MatStm3.totMolFlo[3] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_294(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm3.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[3,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[51] /* MatStm3.compMolFrac[3,2] variable */) * (jacobian->seedVars[0] /* MatStm3.totMolFlo.SeedNLSJac3[3] SEED_VAR */) + (jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac3[3,2] SEED_VAR */) * (data->localData[0]->realVars[91] /* MatStm3.totMolFlo[3] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_298(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* MatStm3.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[48] /* MatStm3.compMolFrac[2,1] variable */) * (jacobian->tmpVars[4] /* MatStm3.totMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */) * (data->localData[0]->realVars[90] /* MatStm3.totMolFlo[2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_299(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* MatStm3.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[49] /* MatStm3.compMolFrac[2,2] variable */) * (jacobian->tmpVars[4] /* MatStm3.totMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */) * (data->localData[0]->realVars[90] /* MatStm3.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 301
type: SIMPLE_ASSIGN
$res2._$pDERNLSJac3._dummyVarNLSJac3 = if 101325.0 >= MatStm3.Pbubl then MatStm3.compMolFrac.SeedNLSJac3[3,1] else if 101325.0 >= MatStm3.Pdew then MatStm3.compMolFrac.SeedNLSJac3[3,1] - MatStm3.K[1] * MatStm3.compMolFrac.SeedNLSJac3[2,1] else MatStm3.compMolFrac.SeedNLSJac3[2,1]
*/
void mixer1_eqFunction_301(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp21;
  tmp18 = GreaterEq(101325.0,data->localData[0]->realVars[11] /* MatStm3.Pbubl variable */);
  ...
  {
    tmp19 = GreaterEq(101325.0,data->localData[0]->realVars[12] /* MatStm3.Pdew variable */);
    tmp21 = (tmp19?jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac3[3,1] SEED_VAR */ - ((data->localData[0]->realVars[5] /* MatStm3.K[1] variable */) * (jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */)):jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */);
  }
...
equation index: 302
type: SIMPLE_ASSIGN
$res3._$pDERNLSJac3._dummyVarNLSJac3 = if 101325.0 >= MatStm3.Pbubl then MatStm3.compMolFrac.SeedNLSJac3[2,1] + MatStm3.compMolFrac.SeedNLSJac3[2,2] else MatStm3.compMolFrac.SeedNLSJac3[3,1] + MatStm3.compMolFrac.SeedNLSJac3[3,2]
*/
void mixer1_eqFunction_302(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp22 = GreaterEq(101325.0,data->localData[0]->realVars[11] /* MatStm3.Pbubl variable */);
...
equation index: 303
type: SIMPLE_ASSIGN
$res4._$pDERNLSJac3._dummyVarNLSJac3 = if 101325.0 >= MatStm3.Pbubl then MatStm3.compMolFrac.SeedNLSJac3[3,2] else if 101325.0 >= MatStm3.Pdew then MatStm3.compMolFrac.SeedNLSJac3[3,2] - MatStm3.K[2] * MatStm3.compMolFrac.SeedNLSJac3[2,2] else MatStm3.compMolFrac.SeedNLSJac3[2,2]
*/
void mixer1_eqFunction_303(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp26;
  tmp23 = GreaterEq(101325.0,data->localData[0]->realVars[11] /* MatStm3.Pbubl variable */);
  ...
  {
    tmp24 = GreaterEq(101325.0,data->localData[0]->realVars[12] /* MatStm3.Pdew variable */);
    tmp26 = (tmp24?jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac3[3,2] SEED_VAR */ - ((data->localData[0]->realVars[6] /* MatStm3.K[2] variable */) * (jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */)):jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */);
  }
...
void mixer1_eqFunction_347(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[229] /* MatStm5.compMolFrac[2,1] variable */) * (jacobian->seedVars[0] /* MatStm5.totMolFlo.SeedNLSJac4[2] SEED_VAR */) + (jacobian->seedVars[1] /* MatStm5.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */) * (data->localData[0]->realVars[271] /* MatStm5.totMolFlo[2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_348(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[230] /* MatStm5.compMolFrac[2,2] variable */) * (jacobian->seedVars[0] /* MatStm5.totMolFlo.SeedNLSJac4[2] SEED_VAR */) + (jacobian->seedVars[4] /* MatStm5.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */) * (data->localData[0]->realVars[271] /* MatStm5.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 349
type: SIMPLE_ASSIGN
MatStm5._liqPhasMolFrac._$pDERNLSJac4._dummyVarNLSJac4 = 0.01 * MatStm5.totMolFlo.SeedNLSJac4[2]
*/
void mixer1_eqFunction_349(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[2] /* MatStm5.liqPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_DIFF_VAR */ = (0.01) * (jacobian->seedVars[0] /* MatStm5.totMolFlo.SeedNLSJac4[2] SEED_VAR */);
  TRACE_POP
}
...
equation index: 350
type: SIMPLE_ASSIGN
Mixer1._inVapPhasMolFrac._$pDERNLSJac4._dummyVarNLSJac4[2] = -MatStm5.liqPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4
*/
void mixer1_eqFunction_350(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2] JACOBIAN_DIFF_VAR */ = (-jacobian->tmpVars[2] /* MatStm5.liqPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 351
type: SIMPLE_ASSIGN
MatStm5._totMolFlo._$pDERNLSJac4._dummyVarNLSJac4[3] = 100.0 * Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2]
*/
void mixer1_eqFunction_351(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* MatStm5.totMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3] JACOBIAN_DIFF_VAR */ = (100.0) * (jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2] JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void mixer1_eqFunction_352(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[231] /* MatStm5.compMolFrac[3,1] variable */) * (jacobian->tmpVars[4] /* MatStm5.totMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[2] /* MatStm5.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */) * (data->localData[0]->realVars[272] /* MatStm5.totMolFlo[3] variable */);
  TRACE_POP
}
...
equation index: 354
type: SIMPLE_ASSIGN
$res1._$pDERNLSJac4._dummyVarNLSJac4 = MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,2] + MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,2]
*/
void mixer1_eqFunction_354(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[0] /* $res1.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_VAR */ = jacobian->tmpVars[6] /* MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,2] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[1] /* MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,2] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 355
type: SIMPLE_ASSIGN
$res2._$pDERNLSJac4._dummyVarNLSJac4 = if 101325.0 >= MatStm5.Pbubl then MatStm5.compMolFrac.SeedNLSJac4[3,2] else if 101325.0 >= MatStm5.Pdew then MatStm5.compMolFrac.SeedNLSJac4[3,2] - MatStm5.K[2] * MatStm5.compMolFrac.SeedNLSJac4[2,2] else MatStm5.compMolFrac.SeedNLSJac4[2,2]
*/
void mixer1_eqFunction_355(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp29)
  {
    tmp30 = jacobian->seedVars[3] /* MatStm5.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */;
  }
  else
  {
    tmp28 = GreaterEq(101325.0,data->localData[0]->realVars[193] /* MatStm5.Pdew variable */);
    tmp30 = (tmp28?jacobian->seedVars[3] /* MatStm5.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */ - ((data->localData[0]->realVars[187] /* MatStm5.K[2] variable */) * (jacobian->seedVars[4] /* MatStm5.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */)):jacobian->seedVars[4] /* MatStm5.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */);
  }
...
equation index: 356
type: SIMPLE_ASSIGN
$res3._$pDERNLSJac4._dummyVarNLSJac4 = if 101325.0 >= MatStm5.Pbubl then MatStm5.compMolFrac.SeedNLSJac4[2,1] + MatStm5.compMolFrac.SeedNLSJac4[2,2] else MatStm5.compMolFrac.SeedNLSJac4[3,1] + MatStm5.compMolFrac.SeedNLSJac4[3,2]
*/
void mixer1_eqFunction_356(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[2] /* $res3.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_VAR */ = (tmp31?jacobian->seedVars[1] /* MatStm5.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */ + jacobian->seedVars[4] /* MatStm5.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */:jacobian->seedVars[2] /* MatStm5.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */ + jacobian->seedVars[3] /* MatStm5.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */);
  TRACE_POP
}
...
void mixer1_eqFunction_357(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[3] /* $res4.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_VAR */ = jacobian->tmpVars[5] /* MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,1] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[0] /* MatStm5.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,1] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 358
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac4._dummyVarNLSJac4 = if 101325.0 >= MatStm5.Pbubl then MatStm5.compMolFrac.SeedNLSJac4[3,1] else if 101325.0 >= MatStm5.Pdew then MatStm5.compMolFrac.SeedNLSJac4[3,1] - MatStm5.K[1] * MatStm5.compMolFrac.SeedNLSJac4[2,1] else MatStm5.compMolFrac.SeedNLSJac4[2,1]
*/
void mixer1_eqFunction_358(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp35;
  tmp32 = GreaterEq(101325.0,data->localData[0]->realVars[192] /* MatStm5.Pbubl variable */);
  tmp34 = (modelica_boolean)tmp32;
  if(tmp34)
  {
    tmp35 = jacobian->seedVars[2] /* MatStm5.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */;
  }
  else
  {
    tmp33 = GreaterEq(101325.0,data->localData[0]->realVars[193] /* MatStm5.Pdew variable */);
    tmp35 = (tmp33?jacobian->seedVars[2] /* MatStm5.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */ - ((data->localData[0]->realVars[186] /* MatStm5.K[1] variable */) * (jacobian->seedVars[1] /* MatStm5.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */)):jacobian->seedVars[1] /* MatStm5.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */);
  }
