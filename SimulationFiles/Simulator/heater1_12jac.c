...
void heater1_eqFunction_46(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* MatStm1.totMolFlo.$pDERNLSJac0.dummyVarNLSJac0[2] JACOBIAN_DIFF_VAR */ = (200.0) * (jacobian->tmpVars[2] /* MatStm1.liqPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void heater1_eqFunction_50(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  else
  {
    ...
    tmp3 = (tmp1?jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac0[3,2] SEED_VAR */ - ((data->localData[0]->realVars[12] /* MatStm1.K[2] variable */) * (jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */)):jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */);
  }
...
void heater1_eqFunction_52(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp7)
  {
    tmp8 = jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac0[3,1] SEED_VAR */;
  }
  else
  {
    tmp6 = GreaterEq(101325.0,data->localData[0]->realVars[18] /* MatStm1.Pdew variable */);
    tmp8 = (tmp6?jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac0[3,1] SEED_VAR */ - ((data->localData[0]->realVars[11] /* MatStm1.K[1] variable */) * (jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */)):jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */);
  }
...
void heater1_eqFunction_197(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm1.compMolFlo.$pDERNLSJac2.dummyVarNLSJac2[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[55] /* MatStm1.compMolFrac[2,2] variable */) * (jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac2[2] SEED_VAR */) + (jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac2[2,2] SEED_VAR */) * (data->localData[0]->realVars[96] /* MatStm1.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 198
type: SIMPLE_ASSIGN
MatStm1._liqPhasMolFrac._$pDERNLSJac2._dummyVarNLSJac2 = 0.005 * MatStm1.totMolFlo.SeedNLSJac2[2]
*/
void heater1_eqFunction_198(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[2] /* MatStm1.liqPhasMolFrac.$pDERNLSJac2.dummyVarNLSJac2 JACOBIAN_DIFF_VAR */ = (0.005) * (jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac2[2] SEED_VAR */);
  TRACE_POP
}
...
equation index: 199
type: SIMPLE_ASSIGN
MatStm1._totMolFlo._$pDERNLSJac2._dummyVarNLSJac2[3] = (-200.0) * MatStm1.liqPhasMolFrac.$pDERNLSJac2.dummyVarNLSJac2
*/
void heater1_eqFunction_199(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* MatStm1.totMolFlo.$pDERNLSJac2.dummyVarNLSJac2[3] JACOBIAN_DIFF_VAR */ = (-200.0) * (jacobian->tmpVars[2] /* MatStm1.liqPhasMolFrac.$pDERNLSJac2.dummyVarNLSJac2 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void heater1_eqFunction_201(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* MatStm1.compMolFlo.$pDERNLSJac2.dummyVarNLSJac2[3,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[57] /* MatStm1.compMolFrac[3,2] variable */) * (jacobian->tmpVars[3] /* MatStm1.totMolFlo.$pDERNLSJac2.dummyVarNLSJac2[3] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac2[3,2] SEED_VAR */) * (data->localData[0]->realVars[97] /* MatStm1.totMolFlo[3] variable */);
  TRACE_POP
}
...
void heater1_eqFunction_204(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp12;
  tmp9 = GreaterEq(101325.0,data->localData[0]->realVars[17] /* MatStm1.Pbubl variable */);
  tmp11 = (modelica_boolean)tmp9;
  if(tmp11)
  {
    tmp12 = jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac2[3,1] SEED_VAR */;
  }
  else
  {
    tmp10 = GreaterEq(101325.0,data->localData[0]->realVars[18] /* MatStm1.Pdew variable */);
    tmp12 = (tmp10?jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac2[3,1] SEED_VAR */ - ((data->localData[0]->realVars[11] /* MatStm1.K[1] variable */) * (jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac2[2,1] SEED_VAR */)):jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac2[2,1] SEED_VAR */);
  }
...
void heater1_eqFunction_205(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp13 = GreaterEq(101325.0,data->localData[0]->realVars[17] /* MatStm1.Pbubl variable */);
  jacobian->resultVars[3] /* $res4.$pDERNLSJac2.dummyVarNLSJac2 JACOBIAN_VAR */ = (tmp13?jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac2[2,1] SEED_VAR */ + jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac2[2,2] SEED_VAR */:jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac2[3,1] SEED_VAR */ + jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac2[3,2] SEED_VAR */);
  TRACE_POP
}
...
void heater1_eqFunction_206(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp17;
  tmp14 = GreaterEq(101325.0,data->localData[0]->realVars[17] /* MatStm1.Pbubl variable */);
  tmp16 = (modelica_boolean)tmp14;
  if(tmp16)
  {
    tmp17 = jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac2[3,2] SEED_VAR */;
  }
  else
  {
    tmp15 = GreaterEq(101325.0,data->localData[0]->realVars[18] /* MatStm1.Pdew variable */);
    tmp17 = (tmp15?jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac2[3,2] SEED_VAR */ - ((data->localData[0]->realVars[12] /* MatStm1.K[2] variable */) * (jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac2[2,2] SEED_VAR */)):jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac2[2,2] SEED_VAR */);
  }
