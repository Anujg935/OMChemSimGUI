...
vars: {MatStm2._totMolFlo[2], MatStm2._compMolFrac[3,2], MatStm2._compMolFrac[2,1], MatStm2._compMolFrac[3,1], MatStm2._compMolFrac[2,2]}
...
void Flowsheet_eqFunction_305(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[0] = data->localData[0]->realVars[181] /* MatStm2.totMolFlo[2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[1] = data->localData[0]->realVars[142] /* MatStm2.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[2] = data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[3] = data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[4] = data->localData[0]->realVars[140] /* MatStm2.compMolFrac[2,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[181] /* MatStm2.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[0];
  data->localData[0]->realVars[142] /* MatStm2.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[1];
  data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[2];
  data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[3];
  data->localData[0]->realVars[140] /* MatStm2.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[4];
  TRACE_POP
}
/*
equation index: 306
...
void Flowsheet_eqFunction_313(DATA *data, threadData_t *threadData)
{
  ...
  if(!(((tmp6 > 0) && (tmp5 > tmp7)) || ((tmp6 < 0) && (tmp5 < tmp7))))
  {
    ...
    for($Pi = ((modelica_integer) 1); in_range_integer($Pi, tmp5, tmp7); $Pi += tmp6)
    {
      ...
      real_array_create(&tmp4, (modelica_real*)&data->localData[0]->realVars[98] /* MatStm2.MW[1] variable */, 1, 3);
...
vars: {MatStm3._totMolFlo[3], MatStm3._compMolFrac[3,2], MatStm3._compMolFrac[2,2], MatStm3._compMolFrac[3,1], MatStm3._compMolFrac[2,1]}
...
void Flowsheet_eqFunction_359(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[1] = data->localData[0]->realVars[232] /* MatStm3.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[2] = data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[3] = data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[4] = data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,1] variable */;
  ...
  data->localData[0]->realVars[232] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[1];
  data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[2];
  data->localData[0]->realVars[231] /* MatStm3.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[3];
  data->localData[0]->realVars[229] /* MatStm3.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[4];
  TRACE_POP
}
/*
equation index: 360
...
eqns: {389, 390, 391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 418, 417, 416, 415, 414, 413}
*/
void Flowsheet_eqFunction_419(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 419 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  data->simulationInfo->nonlinearSystemData[5].nlsxOld[4] = data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */;
  ...
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,419};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 419 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
  ...
  data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[5].nlsx[4];
...
void Flowsheet_eqFunction_430(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving linear system 430 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  ...
  if (retValue > 0){
    ...
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving linear system 430 failed at time=%.15g.\nFor more information please use -lv LOG_LS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
#define _OMC_LIT_RESOURCE_1_dir_data "C:/OMChemSimGUI/SimulationFiles/Simulator"
...
void Flowsheet_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{5334fb3d-2f75-4ea6-88a7-e9b3bf137e9c}";
