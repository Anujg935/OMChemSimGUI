...
void Mixer1_eqFunction_81(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp5;
  tmp2 = GreaterEq(101325.0,data->localData[0]->realVars[192] /* MatStm3.Pbubl variable */);
  ...
  {
    tmp3 = GreaterEq(101325.0,data->localData[0]->realVars[193] /* MatStm3.Pdew variable */);
    tmp5 = (tmp3?jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac0[3,2] SEED_VAR */ - ((data->localData[0]->realVars[187] /* MatStm3.K[2] variable */) * (jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */)):jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */);
  }
...
void Mixer1_eqFunction_85(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp9)
  {
    tmp10 = jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac0[3,1] SEED_VAR */;
  }
  else
  {
    tmp8 = GreaterEq(101325.0,data->localData[0]->realVars[193] /* MatStm3.Pdew variable */);
    tmp10 = (tmp8?jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac0[3,1] SEED_VAR */ - ((data->localData[0]->realVars[186] /* MatStm3.K[1] variable */) * (jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */)):jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */);
  }
...
equation index: 136
type: SIMPLE_ASSIGN
$res2._$pDERNLSJac1._dummyVarNLSJac1 = if 101200.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac1[3,2] else if 101200.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac1[3,2] - MatStm2.K[2] * MatStm2.compMolFrac.SeedNLSJac1[2,2] else MatStm2.compMolFrac.SeedNLSJac1[2,2]
*/
void Mixer1_eqFunction_136(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp14;
  tmp11 = GreaterEq(101200.0,data->localData[0]->realVars[102] /* MatStm2.Pbubl variable */);
  ...
  {
    tmp12 = GreaterEq(101200.0,data->localData[0]->realVars[103] /* MatStm2.Pdew variable */);
    tmp14 = (tmp12?jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac1[3,2] SEED_VAR */ - ((data->localData[0]->realVars[97] /* MatStm2.K[2] variable */) * (jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */)):jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */);
  }
...
equation index: 138
type: SIMPLE_ASSIGN
$res4._$pDERNLSJac1._dummyVarNLSJac1 = if 101200.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac1[2,1] + MatStm2.compMolFrac.SeedNLSJac1[2,2] else MatStm2.compMolFrac.SeedNLSJac1[3,1] + MatStm2.compMolFrac.SeedNLSJac1[3,2]
*/
void Mixer1_eqFunction_138(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp15 = GreaterEq(101200.0,data->localData[0]->realVars[102] /* MatStm2.Pbubl variable */);
...
equation index: 139
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac1._dummyVarNLSJac1 = if 101200.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac1[3,1] else if 101200.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac1[3,1] - MatStm2.K[1] * MatStm2.compMolFrac.SeedNLSJac1[2,1] else MatStm2.compMolFrac.SeedNLSJac1[2,1]
*/
void Mixer1_eqFunction_139(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp19;
  tmp16 = GreaterEq(101200.0,data->localData[0]->realVars[102] /* MatStm2.Pbubl variable */);
  ...
  {
    tmp17 = GreaterEq(101200.0,data->localData[0]->realVars[103] /* MatStm2.Pdew variable */);
    tmp19 = (tmp17?jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac1[3,1] SEED_VAR */ - ((data->localData[0]->realVars[96] /* MatStm2.K[1] variable */) * (jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */)):jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */);
  }
...
void Mixer1_eqFunction_301(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp22)
  {
    tmp23 = jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac3[3,1] SEED_VAR */;
  }
  else
  {
    tmp21 = GreaterEq(101325.0,data->localData[0]->realVars[193] /* MatStm3.Pdew variable */);
    tmp23 = (tmp21?jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac3[3,1] SEED_VAR */ - ((data->localData[0]->realVars[186] /* MatStm3.K[1] variable */) * (jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */)):jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */);
  }
...
void Mixer1_eqFunction_302(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp24 = GreaterEq(101325.0,data->localData[0]->realVars[192] /* MatStm3.Pbubl variable */);
  jacobian->resultVars[2] /* $res3.$pDERNLSJac3.dummyVarNLSJac3 JACOBIAN_VAR */ = (tmp24?jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */ + jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */:jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac3[3,1] SEED_VAR */ + jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac3[3,2] SEED_VAR */);
  TRACE_POP
}
...
void Mixer1_eqFunction_303(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp28;
  tmp25 = GreaterEq(101325.0,data->localData[0]->realVars[192] /* MatStm3.Pbubl variable */);
  tmp27 = (modelica_boolean)tmp25;
  if(tmp27)
  {
    tmp28 = jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac3[3,2] SEED_VAR */;
  }
  else
  {
    tmp26 = GreaterEq(101325.0,data->localData[0]->realVars[193] /* MatStm3.Pdew variable */);
    tmp28 = (tmp26?jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac3[3,2] SEED_VAR */ - ((data->localData[0]->realVars[187] /* MatStm3.K[2] variable */) * (jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */)):jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */);
  }
...
equation index: 355
type: SIMPLE_ASSIGN
$res2._$pDERNLSJac4._dummyVarNLSJac4 = if 101200.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac4[3,2] else if 101200.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac4[3,2] - MatStm2.K[2] * MatStm2.compMolFrac.SeedNLSJac4[2,2] else MatStm2.compMolFrac.SeedNLSJac4[2,2]
*/
void Mixer1_eqFunction_355(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp32;
  tmp29 = GreaterEq(101200.0,data->localData[0]->realVars[102] /* MatStm2.Pbubl variable */);
  tmp31 = (modelica_boolean)tmp29;
  if(tmp31)
  {
    tmp32 = jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */;
  }
  else
  {
    tmp30 = GreaterEq(101200.0,data->localData[0]->realVars[103] /* MatStm2.Pdew variable */);
    tmp32 = (tmp30?jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */ - ((data->localData[0]->realVars[97] /* MatStm2.K[2] variable */) * (jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */)):jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */);
  }
  jacobian->resultVars[1] /* $res2.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_VAR */ = tmp32;
  TRACE_POP
}
...
equation index: 356
type: SIMPLE_ASSIGN
$res3._$pDERNLSJac4._dummyVarNLSJac4 = if 101200.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac4[2,1] + MatStm2.compMolFrac.SeedNLSJac4[2,2] else MatStm2.compMolFrac.SeedNLSJac4[3,1] + MatStm2.compMolFrac.SeedNLSJac4[3,2]
*/
void Mixer1_eqFunction_356(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  tmp33 = GreaterEq(101200.0,data->localData[0]->realVars[102] /* MatStm2.Pbubl variable */);
  jacobian->resultVars[2] /* $res3.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_VAR */ = (tmp33?jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */ + jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */:jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */ + jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */);
  TRACE_POP
}
...
equation index: 358
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac4._dummyVarNLSJac4 = if 101200.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac4[3,1] else if 101200.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac4[3,1] - MatStm2.K[1] * MatStm2.compMolFrac.SeedNLSJac4[2,1] else MatStm2.compMolFrac.SeedNLSJac4[2,1]
*/
void Mixer1_eqFunction_358(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp37;
  tmp34 = GreaterEq(101200.0,data->localData[0]->realVars[102] /* MatStm2.Pbubl variable */);
  tmp36 = (modelica_boolean)tmp34;
  if(tmp36)
  {
    tmp37 = jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */;
  }
  else
  {
    tmp35 = GreaterEq(101200.0,data->localData[0]->realVars[103] /* MatStm2.Pdew variable */);
    tmp37 = (tmp35?jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */ - ((data->localData[0]->realVars[96] /* MatStm2.K[1] variable */) * (jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */)):jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */);
  }
  jacobian->resultVars[4] /* $res5.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_VAR */ = tmp37;
  TRACE_POP
}
