...
void Mixer1_eqFunction_348(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm3.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */) * (jacobian->seedVars[0] /* MatStm3.totMolFlo.SeedNLSJac4[2] SEED_VAR */) + (jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */) * (data->localData[0]->realVars[271] /* MatStm3.totMolFlo[2] variable */);
  TRACE_POP
}
...
void Mixer1_eqFunction_355(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  else
  {
    ...
    tmp30 = (tmp28?jacobian->seedVars[3] /* MatStm3.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */ - ((data->localData[0]->realVars[187] /* MatStm3.K[2] variable */) * (jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */)):jacobian->seedVars[4] /* MatStm3.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */);
  }
...
void Mixer1_eqFunction_358(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  else
  {
    ...
    tmp35 = (tmp33?jacobian->seedVars[2] /* MatStm3.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */ - ((data->localData[0]->realVars[186] /* MatStm3.K[1] variable */) * (jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */)):jacobian->seedVars[1] /* MatStm3.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */);
  }
