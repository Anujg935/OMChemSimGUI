...
void Flowsheet_eqFunction_6(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[9] /* MatStm1.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp0, 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_7(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[8] /* MatStm1.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp1, 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_8(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[28] /* MatStm1.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[170], tmp2, tmp3, data->simulationInfo->realParameter[180], 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_9(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[26] /* MatStm1.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[170], tmp4, tmp5, data->simulationInfo->realParameter[180], 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_10(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[52] /* MatStm1.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp6, 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_11(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[50] /* MatStm1.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp7, 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_12(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[27] /* MatStm1.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[169], tmp8, tmp9, data->simulationInfo->realParameter[179], 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_13(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[25] /* MatStm1.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[169], tmp10, tmp11, data->simulationInfo->realParameter[179], 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_14(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[51] /* MatStm1.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp12, 320.0);
  TRACE_POP
}
...
void Flowsheet_eqFunction_15(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[49] /* MatStm1.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp13, 320.0);
  TRACE_POP
}
...
equation index: 20
type: SIMPLE_ASSIGN
MatStm1._Pbubl = MatStm1.compMolFrac[1,1] * exp(MatStm1.comp[1].VP[2] + 0.003125 * MatStm1.comp[1].VP[3] + MatStm1.comp[1].VP[4] * 5.768320995793772 + MatStm1.comp[1].VP[5] * 320.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp(MatStm1.comp[2].VP[2] + 0.003125 * MatStm1.comp[2].VP[3] + MatStm1.comp[2].VP[4] * 5.768320995793772 + MatStm1.comp[2].VP[5] * 320.0 ^ MatStm1.comp[2].VP[6])
*/
...
equation index: 21
type: SIMPLE_ASSIGN
MatStm1._Pdew = 1.0 / (MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - 0.003125 * MatStm1.comp[1].VP[3] - MatStm1.comp[1].VP[4] * 5.768320995793772 - MatStm1.comp[1].VP[5] * 320.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - 0.003125 * MatStm1.comp[2].VP[3] - MatStm1.comp[2].VP[4] * 5.768320995793772 - MatStm1.comp[2].VP[5] * 320.0 ^ MatStm1.comp[2].VP[6]))
*/
void Flowsheet_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[7] /* MatStm1.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[41] /* MatStm1.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[188]) - ((0.003125) * (data->simulationInfo->realParameter[189])) - ((data->simulationInfo->realParameter[190]) * (5.768320995793772)) - ((data->simulationInfo->realParameter[191]) * (tmp30)))) + (data->localData[0]->realVars[42] /* MatStm1.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[194]) - ((0.003125) * (data->simulationInfo->realParameter[195])) - ((data->simulationInfo->realParameter[196]) * (5.768320995793772)) - ((data->simulationInfo->realParameter[197]) * (tmp37)))),"MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - 0.003125 * MatStm1.comp[1].VP[3] - MatStm1.comp[1].VP[4] * 5.768320995793772 - MatStm1.comp[1].VP[5] * 320.0 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - 0.003125 * MatStm1.comp[2].VP[3] - MatStm1.comp[2].VP[4] * 5.768320995793772 - MatStm1.comp[2].VP[5] * 320.0 ^ MatStm1.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
eqns: {26, 27, 28, 29, 30, 31, 32, 37, 36, 35, 34, 33}
*/
void Flowsheet_eqFunction_50(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[1] = data->localData[0]->realVars[45] /* MatStm1.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[2] = data->localData[0]->realVars[43] /* MatStm1.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[3] = data->localData[0]->realVars[46] /* MatStm1.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[4] = data->localData[0]->realVars[44] /* MatStm1.compMolFrac[2,2] variable */;
  ...
  data->localData[0]->realVars[45] /* MatStm1.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[1];
  data->localData[0]->realVars[43] /* MatStm1.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[2];
  data->localData[0]->realVars[46] /* MatStm1.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[3];
  data->localData[0]->realVars[44] /* MatStm1.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[4];
  TRACE_POP
}
...
void Flowsheet_eqFunction_78(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving linear system 78 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  ...
  if (retValue > 0){
    ...
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving linear system 78 failed at time=%.15g.\nFor more information please use -lv LOG_LS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
void Flowsheet_eqFunction_95(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[10] /* MatStm1.T variable */ = 320.0;
  TRACE_POP
}
