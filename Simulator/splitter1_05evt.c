...
int splitter1_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  tmp0 = GreaterEqZC(101325.0, data->localData[0]->realVars[192] /* MatStm5.Pbubl variable */, data->simulationInfo->storedRelations[0]);
  gout[0] = (tmp0) ? 1 : -1;
  tmp1 = GreaterEqZC(101325.0, data->localData[0]->realVars[193] /* MatStm5.Pdew variable */, data->simulationInfo->storedRelations[1]);
  gout[1] = (tmp1) ? 1 : -1;
  tmp2 = GreaterEqZC(101325.0, data->localData[0]->realVars[104] /* MatStm4.Pbubl variable */, data->simulationInfo->storedRelations[2]);
  gout[2] = (tmp2) ? 1 : -1;
  tmp3 = GreaterEqZC(101325.0, data->localData[0]->realVars[105] /* MatStm4.Pdew variable */, data->simulationInfo->storedRelations[3]);
  gout[3] = (tmp3) ? 1 : -1;
...
int splitter1_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    tmp4 = GreaterEqZC(101325.0, data->localData[0]->realVars[192] /* MatStm5.Pbubl variable */, data->simulationInfo->storedRelations[0]);
    data->simulationInfo->relations[0] = tmp4;
    tmp5 = GreaterEqZC(101325.0, data->localData[0]->realVars[193] /* MatStm5.Pdew variable */, data->simulationInfo->storedRelations[1]);
    data->simulationInfo->relations[1] = tmp5;
    tmp6 = GreaterEqZC(101325.0, data->localData[0]->realVars[104] /* MatStm4.Pbubl variable */, data->simulationInfo->storedRelations[2]);
    data->simulationInfo->relations[2] = tmp6;
    tmp7 = GreaterEqZC(101325.0, data->localData[0]->realVars[105] /* MatStm4.Pdew variable */, data->simulationInfo->storedRelations[3]);
    data->simulationInfo->relations[3] = tmp7;
  } else {
    data->simulationInfo->relations[0] = (101325.0 >= data->localData[0]->realVars[192] /* MatStm5.Pbubl variable */);
    data->simulationInfo->relations[1] = (101325.0 >= data->localData[0]->realVars[193] /* MatStm5.Pdew variable */);
    data->simulationInfo->relations[2] = (101325.0 >= data->localData[0]->realVars[104] /* MatStm4.Pbubl variable */);
    data->simulationInfo->relations[3] = (101325.0 >= data->localData[0]->realVars[105] /* MatStm4.Pdew variable */);
  }
