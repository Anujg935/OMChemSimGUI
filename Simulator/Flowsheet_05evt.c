...
int Flowsheet_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  gout[1] = (tmp813) ? 1 : -1;
  tmp814 = GreaterEqZC(101325.0, data->localData[0]->realVars[195] /* MatStm3.Pbubl variable */, data->simulationInfo->storedRelations[2]);
  gout[2] = (tmp814) ? 1 : -1;
  tmp815 = GreaterEqZC(101325.0, data->localData[0]->realVars[196] /* MatStm3.Pdew variable */, data->simulationInfo->storedRelations[3]);
  gout[3] = (tmp815) ? 1 : -1;
  tmp816 = GreaterEqZC(101325.0, data->localData[0]->realVars[107] /* MatStm2.Pbubl variable */, data->simulationInfo->storedRelations[4]);
  gout[4] = (tmp816) ? 1 : -1;
  tmp817 = GreaterEqZC(101325.0, data->localData[0]->realVars[108] /* MatStm2.Pdew variable */, data->simulationInfo->storedRelations[5]);
  gout[5] = (tmp817) ? 1 : -1;
...
int Flowsheet_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    ...
    tmp820 = GreaterEqZC(101325.0, data->localData[0]->realVars[195] /* MatStm3.Pbubl variable */, data->simulationInfo->storedRelations[2]);
    data->simulationInfo->relations[2] = tmp820;
    tmp821 = GreaterEqZC(101325.0, data->localData[0]->realVars[196] /* MatStm3.Pdew variable */, data->simulationInfo->storedRelations[3]);
    data->simulationInfo->relations[3] = tmp821;
    tmp822 = GreaterEqZC(101325.0, data->localData[0]->realVars[107] /* MatStm2.Pbubl variable */, data->simulationInfo->storedRelations[4]);
    data->simulationInfo->relations[4] = tmp822;
    tmp823 = GreaterEqZC(101325.0, data->localData[0]->realVars[108] /* MatStm2.Pdew variable */, data->simulationInfo->storedRelations[5]);
