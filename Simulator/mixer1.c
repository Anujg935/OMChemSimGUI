...
void mixer1_eqFunction_277(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[41] /* MatStm1.compMolFlo[1,2] variable */ = (190.0) * (data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */);
  TRACE_POP
}
/*
equation index: 278
...
void mixer1_eqFunction_279(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[40] /* MatStm1.compMolFlo[1,1] variable */ = (190.0) * (data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */);
  TRACE_POP
}
/*
equation index: 280
...
vars: {MatStm5._totMolFlo[3], MatStm5._compMolFrac[3,2], MatStm5._compMolFrac[2,2], MatStm5._compMolFrac[3,1], MatStm5._compMolFrac[2,1]}
...
void mixer1_eqFunction_305(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[0] = data->localData[0]->realVars[272] /* MatStm5.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[1] = data->localData[0]->realVars[232] /* MatStm5.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[2] = data->localData[0]->realVars[230] /* MatStm5.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[3] = data->localData[0]->realVars[231] /* MatStm5.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[4] = data->localData[0]->realVars[229] /* MatStm5.compMolFrac[2,1] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[272] /* MatStm5.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[0];
  data->localData[0]->realVars[232] /* MatStm5.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[1];
  data->localData[0]->realVars[230] /* MatStm5.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[2];
  data->localData[0]->realVars[231] /* MatStm5.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[3];
  data->localData[0]->realVars[229] /* MatStm5.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[4];
  TRACE_POP
}
/*
equation index: 306
...
void mixer1_eqFunction_315(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[218] /* MatStm5.compMolEntr[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_SId(threadData, data->simulationInfo->realParameter[398], tmp2, tmp3, data->simulationInfo->realParameter[494], data->simulationInfo->realParameter[496], 300.0, 101325.0, data->localData[0]->realVars[230] /* MatStm5.compMolFrac[2,2] variable */, data->localData[0]->realVars[232] /* MatStm5.compMolFrac[3,2] variable */ ,&data->localData[0]->realVars[220] /* MatStm5.compMolEntr[3,2] variable */);
  TRACE_POP
}
/*
equation index: 316
...
void mixer1_eqFunction_325(DATA *data, threadData_t *threadData)
{
  ...
  int retValue;
  double aux_x[5] = { data->localData[1]->realVars[207] /* MatStm5.compMasFrac[3,1] variable */,data->localData[1]->realVars[203] /* MatStm5.compMasFrac[1,1] variable */,data->localData[1]->realVars[206] /* MatStm5.compMasFrac[2,2] variable */,data->localData[1]->realVars[205] /* MatStm5.compMasFrac[2,1] variable */,data->localData[1]->realVars[208] /* MatStm5.compMasFrac[3,2] variable */ };
  if(ACTIVE_STREAM(LOG_DT))
  {
  ...
  /* write solution */
  data->localData[0]->realVars[207] /* MatStm5.compMasFrac[3,1] variable */ = aux_x[0];
  data->localData[0]->realVars[203] /* MatStm5.compMasFrac[1,1] variable */ = aux_x[1];
  data->localData[0]->realVars[206] /* MatStm5.compMasFrac[2,2] variable */ = aux_x[2];
  data->localData[0]->realVars[205] /* MatStm5.compMasFrac[2,1] variable */ = aux_x[3];
  data->localData[0]->realVars[208] /* MatStm5.compMasFrac[3,2] variable */ = aux_x[4];
  TRACE_POP
}
/*
equation index: 326
...
void mixer1_eqFunction_326(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[255] /* MatStm5.phasMolSpHeat[1] variable */ = (data->localData[0]->realVars[246] /* MatStm5.liqPhasMolFrac variable */) * (data->localData[0]->realVars[256] /* MatStm5.phasMolSpHeat[2] variable */) + (data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */) * (data->localData[0]->realVars[257] /* MatStm5.phasMolSpHeat[3] variable */);
  TRACE_POP
}
/*
equation index: 327
...
void mixer1_eqFunction_329(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[249] /* MatStm5.phasMolEnth[1] variable */ = (data->localData[0]->realVars[246] /* MatStm5.liqPhasMolFrac variable */) * (data->localData[0]->realVars[250] /* MatStm5.phasMolEnth[2] variable */) + (data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */) * (data->localData[0]->realVars[251] /* MatStm5.phasMolEnth[3] variable */);
  TRACE_POP
}
/*
equation index: 330
...
void mixer1_eqFunction_332(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[252] /* MatStm5.phasMolEntr[1] variable */ = (data->localData[0]->realVars[246] /* MatStm5.liqPhasMolFrac variable */) * (data->localData[0]->realVars[253] /* MatStm5.phasMolEntr[2] variable */) + (data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */) * (data->localData[0]->realVars[254] /* MatStm5.phasMolEntr[3] variable */);
  TRACE_POP
}
/*
equation index: 333
...
vars: {MatStm4._totMolFlo[2], MatStm4._compMolFrac[2,2], MatStm4._compMolFrac[3,2], MatStm4._compMolFrac[2,1], MatStm4._compMolFrac[3,1]}
...
void mixer1_eqFunction_359(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[0] = data->localData[0]->realVars[181] /* MatStm4.totMolFlo[2] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[1] = data->localData[0]->realVars[140] /* MatStm4.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[2] = data->localData[0]->realVars[142] /* MatStm4.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[3] = data->localData[0]->realVars[139] /* MatStm4.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[4] = data->localData[0]->realVars[141] /* MatStm4.compMolFrac[3,1] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[181] /* MatStm4.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[0];
  data->localData[0]->realVars[140] /* MatStm4.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[1];
  data->localData[0]->realVars[142] /* MatStm4.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[2];
  data->localData[0]->realVars[139] /* MatStm4.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[3];
  data->localData[0]->realVars[141] /* MatStm4.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[4];
  TRACE_POP
}
/*
equation index: 360
...
void mixer1_eqFunction_360(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[109] /* MatStm4.compMasFlo[2,1] variable */ = (data->localData[0]->realVars[133] /* MatStm4.compMolFlo[2,1] variable */) * (data->simulationInfo->realParameter[321]);
  TRACE_POP
}
/*
equation index: 361
...
void mixer1_eqFunction_361(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[111] /* MatStm4.compMasFlo[3,1] variable */ = (data->localData[0]->realVars[135] /* MatStm4.compMolFlo[3,1] variable */) * (data->simulationInfo->realParameter[321]);
  TRACE_POP
}
/*
equation index: 362
...
void mixer1_eqFunction_362(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[127] /* MatStm4.compMolEntr[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_SId(threadData, data->simulationInfo->realParameter[239], tmp0, tmp1, data->simulationInfo->realParameter[335], data->simulationInfo->realParameter[337], 300.0, 101325.0, data->localData[0]->realVars[139] /* MatStm4.compMolFrac[2,1] variable */, data->localData[0]->realVars[141] /* MatStm4.compMolFrac[3,1] variable */ ,&data->localData[0]->realVars[129] /* MatStm4.compMolEntr[3,1] variable */);
  TRACE_POP
}
/*
equation index: 363
...
void mixer1_eqFunction_363(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[167] /* MatStm4.phasMolSpHeat[3] variable */ = (data->localData[0]->realVars[141] /* MatStm4.compMolFrac[3,1] variable */) * (data->localData[0]->realVars[147] /* MatStm4.compMolSpHeat[3,1] variable */) + (data->localData[0]->realVars[142] /* MatStm4.compMolFrac[3,2] variable */) * (data->localData[0]->realVars[148] /* MatStm4.compMolSpHeat[3,2] variable */);
  TRACE_POP
}
/*
equation index: 364
...
void mixer1_eqFunction_364(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[161] /* MatStm4.phasMolEnth[3] variable */ = (data->localData[0]->realVars[141] /* MatStm4.compMolFrac[3,1] variable */) * (data->localData[0]->realVars[123] /* MatStm4.compMolEnth[3,1] variable */) + (data->localData[0]->realVars[142] /* MatStm4.compMolFrac[3,2] variable */) * (data->localData[0]->realVars[124] /* MatStm4.compMolEnth[3,2] variable */);
  TRACE_POP
}
/*
equation index: 365
...
void mixer1_eqFunction_365(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[112] /* MatStm4.compMasFlo[3,2] variable */ = (data->localData[0]->realVars[136] /* MatStm4.compMolFlo[3,2] variable */) * (data->simulationInfo->realParameter[322]);
  TRACE_POP
}
/*
equation index: 366
...
void mixer1_eqFunction_366(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[110] /* MatStm4.compMasFlo[2,2] variable */ = (data->localData[0]->realVars[134] /* MatStm4.compMolFlo[2,2] variable */) * (data->simulationInfo->realParameter[322]);
  TRACE_POP
}
/*
equation index: 367
...
void mixer1_eqFunction_367(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[128] /* MatStm4.compMolEntr[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_SId(threadData, data->simulationInfo->realParameter[240], tmp2, tmp3, data->simulationInfo->realParameter[336], data->simulationInfo->realParameter[338], 300.0, 101325.0, data->localData[0]->realVars[140] /* MatStm4.compMolFrac[2,2] variable */, data->localData[0]->realVars[142] /* MatStm4.compMolFrac[3,2] variable */ ,&data->localData[0]->realVars[130] /* MatStm4.compMolEntr[3,2] variable */);
  TRACE_POP
}
/*
equation index: 368
...
void mixer1_eqFunction_368(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[164] /* MatStm4.phasMolEntr[3] variable */ = (data->localData[0]->realVars[141] /* MatStm4.compMolFrac[3,1] variable */) * (data->localData[0]->realVars[129] /* MatStm4.compMolEntr[3,1] variable */) + (data->localData[0]->realVars[142] /* MatStm4.compMolFrac[3,2] variable */) * (data->localData[0]->realVars[130] /* MatStm4.compMolEntr[3,2] variable */);
  TRACE_POP
}
/*
equation index: 369
...
void mixer1_eqFunction_369(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[166] /* MatStm4.phasMolSpHeat[2] variable */ = (data->localData[0]->realVars[139] /* MatStm4.compMolFrac[2,1] variable */) * (data->localData[0]->realVars[145] /* MatStm4.compMolSpHeat[2,1] variable */) + (data->localData[0]->realVars[140] /* MatStm4.compMolFrac[2,2] variable */) * (data->localData[0]->realVars[146] /* MatStm4.compMolSpHeat[2,2] variable */);
  TRACE_POP
}
/*
equation index: 370
...
void mixer1_eqFunction_370(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[160] /* MatStm4.phasMolEnth[2] variable */ = (data->localData[0]->realVars[139] /* MatStm4.compMolFrac[2,1] variable */) * (data->localData[0]->realVars[121] /* MatStm4.compMolEnth[2,1] variable */) + (data->localData[0]->realVars[140] /* MatStm4.compMolFrac[2,2] variable */) * (data->localData[0]->realVars[122] /* MatStm4.compMolEnth[2,2] variable */);
  TRACE_POP
}
/*
equation index: 371
...
void mixer1_eqFunction_371(DATA *data, threadData_t *threadData)
{
  ...
  modelica_integer tmp8;
  modelica_integer tmp9;
  data->localData[0]->realVars[100] /* MatStm4.MW[3] variable */ = data->modelData->realVarsData[100].attribute /* MatStm4.MW[3] variable */.start;

  data->localData[0]->realVars[99] /* MatStm4.MW[2] variable */ = data->modelData->realVarsData[99].attribute /* MatStm4.MW[2] variable */.start;

  data->localData[0]->realVars[98] /* MatStm4.MW[1] variable */ = data->modelData->realVarsData[98].attribute /* MatStm4.MW[1] variable */.start;
  ...
  if(!(((tmp8 > 0) && (tmp7 > tmp9)) || ((tmp8 < 0) && (tmp7 < tmp9))))
  {
    ...
    for($Pi = ((modelica_integer) 1); in_range_integer($Pi, tmp7, tmp9); $Pi += tmp8)
    {
      array_alloc_scalar_real_array(&tmp4, 3, (modelica_real)data->localData[0]->realVars[98] /* MatStm4.MW[1] variable */ + ((&data->localData[0]->realVars[137] /* MatStm4.compMolFrac[1,1] variable */)[calc_base_index_dims_subs(2, 3, 2, ((modelica_integer) 1), (modelica_integer)$Pi)]) * ((&data->simulationInfo->realParameter[321])[calc_base_index_dims_subs(1, 2, (modelica_integer)$Pi)]), (modelica_real)data->localData[0]->realVars[99] /* MatStm4.MW[2] variable */ + ((&data->localData[0]->realVars[137] /* MatStm4.compMolFrac[1,1] variable */)[calc_base_index_dims_subs(2, 3, 2, ((modelica_integer) 2), (modelica_integer)$Pi)]) * ((&data->simulationInfo->realParameter[321])[calc_base_index_dims_subs(1, 2, (modelica_integer)$Pi)]), (modelica_real)data->localData[0]->realVars[100] /* MatStm4.MW[3] variable */ + ((&data->localData[0]->realVars[137] /* MatStm4.compMolFrac[1,1] variable */)[calc_base_index_dims_subs(2, 3, 2, ((modelica_integer) 3), (modelica_integer)$Pi)]) * ((&data->simulationInfo->realParameter[321])[calc_base_index_dims_subs(1, 2, (modelica_integer)$Pi)]));
      create_index_spec(&tmp5, 1, (1), (int*)0, 'W');
      real_array_create(&tmp6, (modelica_real*)&data->localData[0]->realVars[98] /* MatStm4.MW[1] variable */, 1, 3);
      indexed_assign_real_array(tmp4, &tmp6, &tmp5);
    }
  }
  TRACE_POP
...
void mixer1_eqFunction_372(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[178] /* MatStm4.totMasFlo[2] variable */ = (data->localData[0]->realVars[181] /* MatStm4.totMolFlo[2] variable */) * (data->localData[0]->realVars[99] /* MatStm4.MW[2] variable */);
  TRACE_POP
}
/*
equation index: 373
...
void mixer1_eqFunction_373(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[179] /* MatStm4.totMasFlo[3] variable */ = (data->localData[0]->realVars[182] /* MatStm4.totMolFlo[3] variable */) * (data->localData[0]->realVars[100] /* MatStm4.MW[3] variable */);
  TRACE_POP
}
/*
equation index: 374
...
void mixer1_eqFunction_374(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[177] /* MatStm4.totMasFlo[1] variable */ = (90.0) * (data->localData[0]->realVars[98] /* MatStm4.MW[1] variable */);
  TRACE_POP
}
/*
equation index: 375
...
void mixer1_eqFunction_375(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[114] /* MatStm4.compMasFrac[1,2] variable */ = DIVISION_SIM(data->localData[0]->realVars[108] /* MatStm4.compMasFlo[1,2] variable */,data->localData[0]->realVars[177] /* MatStm4.totMasFlo[1] variable */,"MatStm4.totMasFlo[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 376
...
void mixer1_eqFunction_376(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[155] /* MatStm4.liqPhasMasFrac variable */ = DIVISION_SIM(data->localData[0]->realVars[178] /* MatStm4.totMasFlo[2] variable */,data->localData[0]->realVars[177] /* MatStm4.totMasFlo[1] variable */,"MatStm4.totMasFlo[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 377
...
void mixer1_eqFunction_377(DATA *data, threadData_t *threadData)
{
  ...
  /* Linear equation system */
  int retValue;
  double aux_x[5] = { data->localData[1]->realVars[117] /* MatStm4.compMasFrac[3,1] variable */,data->localData[1]->realVars[115] /* MatStm4.compMasFrac[2,1] variable */,data->localData[1]->realVars[118] /* MatStm4.compMasFrac[3,2] variable */,data->localData[1]->realVars[116] /* MatStm4.compMasFrac[2,2] variable */,data->localData[1]->realVars[113] /* MatStm4.compMasFrac[1,1] variable */ };
  if(ACTIVE_STREAM(LOG_DT))
  {
  ...
  /* write solution */
  data->localData[0]->realVars[117] /* MatStm4.compMasFrac[3,1] variable */ = aux_x[0];
  data->localData[0]->realVars[115] /* MatStm4.compMasFrac[2,1] variable */ = aux_x[1];
  data->localData[0]->realVars[118] /* MatStm4.compMasFrac[3,2] variable */ = aux_x[2];
  data->localData[0]->realVars[116] /* MatStm4.compMasFrac[2,2] variable */ = aux_x[3];
  data->localData[0]->realVars[113] /* MatStm4.compMasFrac[1,1] variable */ = aux_x[4];
  TRACE_POP
}
/*
equation index: 378
...
void mixer1_eqFunction_378(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[183] /* MatStm4.vapPhasMasFrac variable */ = DIVISION_SIM(data->localData[0]->realVars[179] /* MatStm4.totMasFlo[3] variable */,data->localData[0]->realVars[177] /* MatStm4.totMasFlo[1] variable */,"MatStm4.totMasFlo[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 379
...
void mixer1_eqFunction_379(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[163] /* MatStm4.phasMolEntr[2] variable */ = (data->localData[0]->realVars[139] /* MatStm4.compMolFrac[2,1] variable */) * (data->localData[0]->realVars[127] /* MatStm4.compMolEntr[2,1] variable */) + (data->localData[0]->realVars[140] /* MatStm4.compMolFrac[2,2] variable */) * (data->localData[0]->realVars[128] /* MatStm4.compMolEntr[2,2] variable */);
  TRACE_POP
}
/*
equation index: 380
...
void mixer1_eqFunction_380(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[165] /* MatStm4.phasMolSpHeat[1] variable */ = (data->localData[0]->realVars[156] /* MatStm4.liqPhasMolFrac variable */) * (data->localData[0]->realVars[166] /* MatStm4.phasMolSpHeat[2] variable */) + (data->localData[0]->realVars[277] /* Mixer1.inVapPhasMolFrac[2] variable */) * (data->localData[0]->realVars[167] /* MatStm4.phasMolSpHeat[3] variable */);
  TRACE_POP
}
/*
equation index: 381
...
void mixer1_eqFunction_381(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[143] /* MatStm4.compMolSpHeat[1,1] variable */ = (data->localData[0]->realVars[137] /* MatStm4.compMolFrac[1,1] variable */) * (data->localData[0]->realVars[165] /* MatStm4.phasMolSpHeat[1] variable */);
  TRACE_POP
}
/*
equation index: 382
...
void mixer1_eqFunction_382(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[144] /* MatStm4.compMolSpHeat[1,2] variable */ = (data->localData[0]->realVars[138] /* MatStm4.compMolFrac[1,2] variable */) * (data->localData[0]->realVars[165] /* MatStm4.phasMolSpHeat[1] variable */);
  TRACE_POP
}
/*
equation index: 383
...
void mixer1_eqFunction_383(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[159] /* MatStm4.phasMolEnth[1] variable */ = (data->localData[0]->realVars[156] /* MatStm4.liqPhasMolFrac variable */) * (data->localData[0]->realVars[160] /* MatStm4.phasMolEnth[2] variable */) + (data->localData[0]->realVars[277] /* Mixer1.inVapPhasMolFrac[2] variable */) * (data->localData[0]->realVars[161] /* MatStm4.phasMolEnth[3] variable */);
  TRACE_POP
}
/*
equation index: 384
...
void mixer1_eqFunction_384(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[119] /* MatStm4.compMolEnth[1,1] variable */ = (data->localData[0]->realVars[137] /* MatStm4.compMolFrac[1,1] variable */) * (data->localData[0]->realVars[159] /* MatStm4.phasMolEnth[1] variable */);
  TRACE_POP
}
/*
equation index: 385
...
void mixer1_eqFunction_385(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[120] /* MatStm4.compMolEnth[1,2] variable */ = (data->localData[0]->realVars[138] /* MatStm4.compMolFrac[1,2] variable */) * (data->localData[0]->realVars[159] /* MatStm4.phasMolEnth[1] variable */);
  TRACE_POP
}
/*
equation index: 386
...
void mixer1_eqFunction_386(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[68] /* MatStm1.phasMolEnth[1] variable */ = (0.5263157894736842) * (data->localData[0]->realVars[249] /* MatStm5.phasMolEnth[1] variable */) + (0.4736842105263158) * (data->localData[0]->realVars[159] /* MatStm4.phasMolEnth[1] variable */);
  TRACE_POP
}
...
vars: {MatStm1._totMolFlo[3], MatStm1._T, MatStm1._compMolFrac[2,2], MatStm1._compMolFrac[3,2], MatStm1._compMolFrac[3,1], MatStm1._compMolFrac[2,1]}
...
void mixer1_eqFunction_417(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[5].nlsxOld[0] = data->localData[0]->realVars[91] /* MatStm1.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[5].nlsxOld[1] = data->localData[0]->realVars[15] /* MatStm1.T variable */;
  data->simulationInfo->nonlinearSystemData[5].nlsxOld[2] = data->localData[0]->realVars[49] /* MatStm1.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[5].nlsxOld[3] = data->localData[0]->realVars[51] /* MatStm1.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[5].nlsxOld[4] = data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[5].nlsxOld[5] = data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[91] /* MatStm1.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[5].nlsx[0];
  data->localData[0]->realVars[15] /* MatStm1.T variable */ = data->simulationInfo->nonlinearSystemData[5].nlsx[1];
  data->localData[0]->realVars[49] /* MatStm1.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[5].nlsx[2];
  data->localData[0]->realVars[51] /* MatStm1.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[5].nlsx[3];
  data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[5].nlsx[4];
  data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[5].nlsx[5];
  TRACE_POP
}
/*
equation index: 418
...
void mixer1_eqFunction_418(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[18] /* MatStm1.compMasFlo[2,1] variable */ = (data->localData[0]->realVars[42] /* MatStm1.compMolFlo[2,1] variable */) * (data->simulationInfo->realParameter[163]);
  TRACE_POP
}
/*
equation index: 419
...
void mixer1_eqFunction_419(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[20] /* MatStm1.compMasFlo[3,1] variable */ = (data->localData[0]->realVars[44] /* MatStm1.compMolFlo[3,1] variable */) * (data->simulationInfo->realParameter[163]);
  TRACE_POP
}
/*
equation index: 420
...
void mixer1_eqFunction_422(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[86] /* MatStm1.totMasFlo[1] variable */ = (190.0) * (data->localData[0]->realVars[7] /* MatStm1.MW[1] variable */);
  TRACE_POP
}
/*
equation index: 423
...
void mixer1_eqFunction_425(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[19] /* MatStm1.compMasFlo[2,2] variable */ = (data->localData[0]->realVars[43] /* MatStm1.compMolFlo[2,2] variable */) * (data->simulationInfo->realParameter[164]);
  TRACE_POP
}
/*
equation index: 426
...
void mixer1_eqFunction_426(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[21] /* MatStm1.compMasFlo[3,2] variable */ = (data->localData[0]->realVars[45] /* MatStm1.compMolFlo[3,2] variable */) * (data->simulationInfo->realParameter[164]);
  TRACE_POP
}
/*
equation index: 427
...
void mixer1_eqFunction_429(DATA *data, threadData_t *threadData)
{
  ...
  /* Linear equation system */
  int retValue;
  double aux_x[5] = { data->localData[1]->realVars[25] /* MatStm1.compMasFrac[2,2] variable */,data->localData[1]->realVars[27] /* MatStm1.compMasFrac[3,2] variable */,data->localData[1]->realVars[22] /* MatStm1.compMasFrac[1,1] variable */,data->localData[1]->realVars[24] /* MatStm1.compMasFrac[2,1] variable */,data->localData[1]->realVars[26] /* MatStm1.compMasFrac[3,1] variable */ };
  if(ACTIVE_STREAM(LOG_DT))
  {
  ...
  /* write solution */
  data->localData[0]->realVars[25] /* MatStm1.compMasFrac[2,2] variable */ = aux_x[0];
  data->localData[0]->realVars[27] /* MatStm1.compMasFrac[3,2] variable */ = aux_x[1];
  data->localData[0]->realVars[22] /* MatStm1.compMasFrac[1,1] variable */ = aux_x[2];
...
void mixer1_eqFunction_430(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[57] /* MatStm1.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp6, data->localData[0]->realVars[15] /* MatStm1.T variable */);
  TRACE_POP
}
/*
equation index: 431
...
void mixer1_eqFunction_431(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[55] /* MatStm1.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp7, data->localData[0]->realVars[15] /* MatStm1.T variable */);
  TRACE_POP
}
/*
equation index: 432
...
void mixer1_eqFunction_433(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[56] /* MatStm1.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp10, data->localData[0]->realVars[15] /* MatStm1.T variable */);
  TRACE_POP
}
/*
equation index: 434
...
void mixer1_eqFunction_435(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[54] /* MatStm1.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp11, data->localData[0]->realVars[15] /* MatStm1.T variable */);
  TRACE_POP
}
/*
equation index: 436
...
void mixer1_eqFunction_437(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[74] /* MatStm1.phasMolSpHeat[1] variable */ = (data->localData[0]->realVars[65] /* MatStm1.liqPhasMolFrac variable */) * (data->localData[0]->realVars[75] /* MatStm1.phasMolSpHeat[2] variable */) + (data->localData[0]->realVars[93] /* MatStm1.vapPhasMolFrac variable */) * (data->localData[0]->realVars[76] /* MatStm1.phasMolSpHeat[3] variable */);
  TRACE_POP
}
/*
equation index: 438
...
void mixer1_eqFunction_448(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[162] /* MatStm4.phasMolEntr[1] variable */ = (data->localData[0]->realVars[156] /* MatStm4.liqPhasMolFrac variable */) * (data->localData[0]->realVars[163] /* MatStm4.phasMolEntr[2] variable */) + (data->localData[0]->realVars[277] /* Mixer1.inVapPhasMolFrac[2] variable */) * (data->localData[0]->realVars[164] /* MatStm4.phasMolEntr[3] variable */);
  TRACE_POP
}
/*
equation index: 449
...
void mixer1_eqFunction_449(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[125] /* MatStm4.compMolEntr[1,1] variable */ = (data->localData[0]->realVars[137] /* MatStm4.compMolFrac[1,1] variable */) * (data->localData[0]->realVars[162] /* MatStm4.phasMolEntr[1] variable */);
  TRACE_POP
}
/*
equation index: 450
...
void mixer1_eqFunction_450(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[126] /* MatStm4.compMolEntr[1,2] variable */ = (data->localData[0]->realVars[138] /* MatStm4.compMolFrac[1,2] variable */) * (data->localData[0]->realVars[162] /* MatStm4.phasMolEntr[1] variable */);
  TRACE_POP
}
...
#define _OMC_LIT_RESOURCE_3_dir_data "C:/Users/anbil/Desktop/FOSSEE/Fellowship2019/workspace/OMChemSimGUI/Simulator/Simulator"
...
#define _OMC_LIT_RESOURCE_4_dir_data "C:/Users/anbil/Desktop/FOSSEE/Fellowship2019/workspace/OMChemSimGUI/Simulator"
...
void mixer1_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{142d765c-12d4-4293-af88-de091eecbdd0}";
