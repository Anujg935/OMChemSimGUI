...
void mixer1_eqFunction_305(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[1] = data->localData[0]->realVars[232] /* MatStm3.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[3].nlsxOld[2] = data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */;
  ...
  data->localData[0]->realVars[232] /* MatStm3.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[1];
  data->localData[0]->realVars[230] /* MatStm3.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[3].nlsx[2];
...
void mixer1_eqFunction_325(DATA *data, threadData_t *threadData)
{
  ...
  /* write solution */
  data->localData[0]->realVars[207] /* MatStm3.compMasFrac[3,1] variable */ = aux_x[0];
...
vars: {MatStm2._totMolFlo[2], MatStm2._compMolFrac[2,2], MatStm2._compMolFrac[3,2], MatStm2._compMolFrac[2,1], MatStm2._compMolFrac[3,1]}
...
void mixer1_eqFunction_359(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[1] = data->localData[0]->realVars[140] /* MatStm2.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[2] = data->localData[0]->realVars[142] /* MatStm2.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[3] = data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[4].nlsxOld[4] = data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,1] variable */;
  ...
  data->localData[0]->realVars[140] /* MatStm2.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[1];
  data->localData[0]->realVars[142] /* MatStm2.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[2];
  data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[3];
  data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[4].nlsx[4];
  TRACE_POP
}
/*
equation index: 360
...
void mixer1_eqFunction_377(DATA *data, threadData_t *threadData)
{
  ...
  /* write solution */
  data->localData[0]->realVars[117] /* MatStm2.compMasFrac[3,1] variable */ = aux_x[0];
  data->localData[0]->realVars[115] /* MatStm2.compMasFrac[2,1] variable */ = aux_x[1];
  data->localData[0]->realVars[118] /* MatStm2.compMasFrac[3,2] variable */ = aux_x[2];
  data->localData[0]->realVars[116] /* MatStm2.compMasFrac[2,2] variable */ = aux_x[3];
  data->localData[0]->realVars[113] /* MatStm2.compMasFrac[1,1] variable */ = aux_x[4];
  TRACE_POP
}
/*
equation index: 378
...
void mixer1_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{bab9d3b2-61a1-4fd4-906d-080bb2b312a8}";
