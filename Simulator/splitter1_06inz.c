...
equation index: 16
type: SIMPLE_ASSIGN
MatStm1._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm1.comp[2].VP[1], MatStm1.comp[2].VP[2], MatStm1.comp[2].VP[3], MatStm1.comp[2].VP[4], MatStm1.comp[2].VP[5], MatStm1.comp[2].VP[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[17] /* MatStm1.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp0, 310.0000000000001);
  TRACE_POP
}
...
equation index: 17
type: SIMPLE_ASSIGN
MatStm1._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm1.comp[1].VP[1], MatStm1.comp[1].VP[2], MatStm1.comp[1].VP[3], MatStm1.comp[1].VP[4], MatStm1.comp[1].VP[5], MatStm1.comp[1].VP[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_17(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[16] /* MatStm1.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp1, 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[36] /* MatStm1.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[170], tmp2, tmp3, data->simulationInfo->realParameter[180], 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_19(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[34] /* MatStm1.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[170], tmp4, tmp5, data->simulationInfo->realParameter[180], 310.0000000000001);
  TRACE_POP
}
...
equation index: 20
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm1.comp[2].VapCp[1], MatStm1.comp[2].VapCp[2], MatStm1.comp[2].VapCp[3], MatStm1.comp[2].VapCp[4], MatStm1.comp[2].VapCp[5], MatStm1.comp[2].VapCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_20(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[60] /* MatStm1.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp6, 310.0000000000001);
  TRACE_POP
}
...
equation index: 21
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm1.comp[2].LiqCp[1], MatStm1.comp[2].LiqCp[2], MatStm1.comp[2].LiqCp[3], MatStm1.comp[2].LiqCp[4], MatStm1.comp[2].LiqCp[5], MatStm1.comp[2].LiqCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[58] /* MatStm1.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp7, 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[35] /* MatStm1.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[169], tmp8, tmp9, data->simulationInfo->realParameter[179], 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_23(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[33] /* MatStm1.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[169], tmp10, tmp11, data->simulationInfo->realParameter[179], 310.0000000000001);
  TRACE_POP
}
...
equation index: 24
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm1.comp[1].VapCp[1], MatStm1.comp[1].VapCp[2], MatStm1.comp[1].VapCp[3], MatStm1.comp[1].VapCp[4], MatStm1.comp[1].VapCp[5], MatStm1.comp[1].VapCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[59] /* MatStm1.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp12, 310.0000000000001);
  TRACE_POP
}
...
equation index: 25
type: SIMPLE_ASSIGN
MatStm1._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm1.comp[1].LiqCp[1], MatStm1.comp[1].LiqCp[2], MatStm1.comp[1].LiqCp[3], MatStm1.comp[1].LiqCp[4], MatStm1.comp[1].LiqCp[5], MatStm1.comp[1].LiqCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_25(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[57] /* MatStm1.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp13, 310.0000000000001);
  TRACE_POP
}
...
equation index: 26
type: SIMPLE_ASSIGN
MatStm4._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm4.comp[2].VP[1], MatStm4.comp[2].VP[2], MatStm4.comp[2].VP[3], MatStm4.comp[2].VP[4], MatStm4.comp[2].VP[5], MatStm4.comp[2].VP[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[107] /* MatStm4.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp14, 310.0000000000001);
  TRACE_POP
}
...
equation index: 27
type: SIMPLE_ASSIGN
MatStm4._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm4.comp[1].VP[1], MatStm4.comp[1].VP[2], MatStm4.comp[1].VP[3], MatStm4.comp[1].VP[4], MatStm4.comp[1].VP[5], MatStm4.comp[1].VP[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[106] /* MatStm4.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp15, 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[125] /* MatStm4.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[328], tmp16, tmp17, data->simulationInfo->realParameter[338], 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_29(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[123] /* MatStm4.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[328], tmp18, tmp19, data->simulationInfo->realParameter[338], 310.0000000000001);
  TRACE_POP
}
...
equation index: 30
type: SIMPLE_ASSIGN
MatStm4._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm4.comp[2].VapCp[1], MatStm4.comp[2].VapCp[2], MatStm4.comp[2].VapCp[3], MatStm4.comp[2].VapCp[4], MatStm4.comp[2].VapCp[5], MatStm4.comp[2].VapCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_30(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[149] /* MatStm4.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp20, 310.0000000000001);
  TRACE_POP
}
...
equation index: 31
type: SIMPLE_ASSIGN
MatStm4._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm4.comp[2].LiqCp[1], MatStm4.comp[2].LiqCp[2], MatStm4.comp[2].LiqCp[3], MatStm4.comp[2].LiqCp[4], MatStm4.comp[2].LiqCp[5], MatStm4.comp[2].LiqCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_31(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[147] /* MatStm4.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp21, 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_32(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[124] /* MatStm4.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[327], tmp22, tmp23, data->simulationInfo->realParameter[337], 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_33(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[122] /* MatStm4.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[327], tmp24, tmp25, data->simulationInfo->realParameter[337], 310.0000000000001);
  TRACE_POP
}
...
equation index: 34
type: SIMPLE_ASSIGN
MatStm4._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm4.comp[1].VapCp[1], MatStm4.comp[1].VapCp[2], MatStm4.comp[1].VapCp[3], MatStm4.comp[1].VapCp[4], MatStm4.comp[1].VapCp[5], MatStm4.comp[1].VapCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_34(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[148] /* MatStm4.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp26, 310.0000000000001);
  TRACE_POP
}
...
equation index: 35
type: SIMPLE_ASSIGN
MatStm4._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm4.comp[1].LiqCp[1], MatStm4.comp[1].LiqCp[2], MatStm4.comp[1].LiqCp[3], MatStm4.comp[1].LiqCp[4], MatStm4.comp[1].LiqCp[5], MatStm4.comp[1].LiqCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_35(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[146] /* MatStm4.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp27, 310.0000000000001);
  TRACE_POP
}
...
equation index: 36
type: SIMPLE_ASSIGN
MatStm5._Psat[2] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm5.comp[2].VP[1], MatStm5.comp[2].VP[2], MatStm5.comp[2].VP[3], MatStm5.comp[2].VP[4], MatStm5.comp[2].VP[5], MatStm5.comp[2].VP[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[195] /* MatStm5.Psat[2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp28, 310.0000000000001);
  TRACE_POP
}
...
equation index: 37
type: SIMPLE_ASSIGN
MatStm5._Psat[1] = Simulator.Files.Thermodynamic_Functions.Psat({MatStm5.comp[1].VP[1], MatStm5.comp[1].VP[2], MatStm5.comp[1].VP[3], MatStm5.comp[1].VP[4], MatStm5.comp[1].VP[5], MatStm5.comp[1].VP[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_37(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[194] /* MatStm5.Psat[1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_Psat(threadData, tmp29, 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[213] /* MatStm5.compMolEnth[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[486], tmp30, tmp31, data->simulationInfo->realParameter[496], 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_39(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[211] /* MatStm5.compMolEnth[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[486], tmp32, tmp33, data->simulationInfo->realParameter[496], 310.0000000000001);
  TRACE_POP
}
...
equation index: 40
type: SIMPLE_ASSIGN
MatStm5._compMolSpHeat[3,2] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm5.comp[2].VapCp[1], MatStm5.comp[2].VapCp[2], MatStm5.comp[2].VapCp[3], MatStm5.comp[2].VapCp[4], MatStm5.comp[2].VapCp[5], MatStm5.comp[2].VapCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_40(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[237] /* MatStm5.compMolSpHeat[3,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp34, 310.0000000000001);
  TRACE_POP
}
...
equation index: 41
type: SIMPLE_ASSIGN
MatStm5._compMolSpHeat[2,2] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm5.comp[2].LiqCp[1], MatStm5.comp[2].LiqCp[2], MatStm5.comp[2].LiqCp[3], MatStm5.comp[2].LiqCp[4], MatStm5.comp[2].LiqCp[5], MatStm5.comp[2].LiqCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_41(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[235] /* MatStm5.compMolSpHeat[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp35, 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_42(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[212] /* MatStm5.compMolEnth[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HVapId(threadData, data->simulationInfo->realParameter[485], tmp36, tmp37, data->simulationInfo->realParameter[495], 310.0000000000001);
  TRACE_POP
}
...
void splitter1_eqFunction_43(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[210] /* MatStm5.compMolEnth[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_HLiqId(threadData, data->simulationInfo->realParameter[485], tmp38, tmp39, data->simulationInfo->realParameter[495], 310.0000000000001);
  TRACE_POP
}
...
equation index: 44
type: SIMPLE_ASSIGN
MatStm5._compMolSpHeat[3,1] = Simulator.Files.Thermodynamic_Functions.VapCpId({MatStm5.comp[1].VapCp[1], MatStm5.comp[1].VapCp[2], MatStm5.comp[1].VapCp[3], MatStm5.comp[1].VapCp[4], MatStm5.comp[1].VapCp[5], MatStm5.comp[1].VapCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_44(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[236] /* MatStm5.compMolSpHeat[3,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_VapCpId(threadData, tmp40, 310.0000000000001);
  TRACE_POP
}
...
equation index: 45
type: SIMPLE_ASSIGN
MatStm5._compMolSpHeat[2,1] = Simulator.Files.Thermodynamic_Functions.LiqCpId({MatStm5.comp[1].LiqCp[1], MatStm5.comp[1].LiqCp[2], MatStm5.comp[1].LiqCp[3], MatStm5.comp[1].LiqCp[4], MatStm5.comp[1].LiqCp[5], MatStm5.comp[1].LiqCp[6]}, 310.0000000000001)
*/
void splitter1_eqFunction_45(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[234] /* MatStm5.compMolSpHeat[2,1] variable */ = omc_Simulator_Files_Thermodynamic__Functions_LiqCpId(threadData, tmp41, 310.0000000000001);
  TRACE_POP
}
...
equation index: 46
type: SIMPLE_ASSIGN
MatStm1._compMolFrac[1,1] = 0.45
*/
void splitter1_eqFunction_46(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,46};
  data->localData[0]->realVars[49] /* MatStm1.compMolFrac[1,1] variable */ = 0.45;
  TRACE_POP
}
...
void splitter1_eqFunction_47(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[43] /* MatStm1.compMolFlo[1,1] variable */ = (200.0) * (data->localData[0]->realVars[49] /* MatStm1.compMolFrac[1,1] variable */);
  TRACE_POP
}
...
equation index: 48
type: SIMPLE_ASSIGN
MatStm1._compMolFrac[1,2] = 0.55
*/
void splitter1_eqFunction_48(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,48};
  data->localData[0]->realVars[50] /* MatStm1.compMolFrac[1,2] variable */ = 0.55;
  TRACE_POP
}
...
void splitter1_eqFunction_49(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[44] /* MatStm1.compMolFlo[1,2] variable */ = (200.0) * (data->localData[0]->realVars[50] /* MatStm1.compMolFrac[1,2] variable */);
  TRACE_POP
}
...
equation index: 50
type: SIMPLE_ASSIGN
MatStm1._Pbubl = MatStm1.compMolFrac[1,1] * exp(MatStm1.comp[1].VP[2] + MatStm1.comp[1].VP[3] / 310.0000000000001 + MatStm1.comp[1].VP[4] * 5.736572297479192 + MatStm1.comp[1].VP[5] * 310.0000000000001 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp(MatStm1.comp[2].VP[2] + MatStm1.comp[2].VP[3] / 310.0000000000001 + MatStm1.comp[2].VP[4] * 5.736572297479192 + MatStm1.comp[2].VP[5] * 310.0000000000001 ^ MatStm1.comp[2].VP[6])
*/
...
equation index: 51
type: SIMPLE_ASSIGN
MatStm1._Pdew = 1.0 / (MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 310.0000000000001 - MatStm1.comp[1].VP[4] * 5.736572297479192 - MatStm1.comp[1].VP[5] * 310.0000000000001 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 310.0000000000001 - MatStm1.comp[2].VP[4] * 5.736572297479192 - MatStm1.comp[2].VP[5] * 310.0000000000001 ^ MatStm1.comp[2].VP[6]))
*/
void splitter1_eqFunction_51(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[15] /* MatStm1.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[49] /* MatStm1.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[188]) - (DIVISION_SIM(data->simulationInfo->realParameter[189],310.0000000000001,"310.0000000000001",equationIndexes)) - ((data->simulationInfo->realParameter[190]) * (5.736572297479192)) - ((data->simulationInfo->realParameter[191]) * (tmp58)))) + (data->localData[0]->realVars[50] /* MatStm1.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[194]) - (DIVISION_SIM(data->simulationInfo->realParameter[195],310.0000000000001,"310.0000000000001",equationIndexes)) - ((data->simulationInfo->realParameter[196]) * (5.736572297479192)) - ((data->simulationInfo->realParameter[197]) * (tmp65)))),"MatStm1.compMolFrac[1,1] * exp((-MatStm1.comp[1].VP[2]) - MatStm1.comp[1].VP[3] / 310.0000000000001 - MatStm1.comp[1].VP[4] * 5.736572297479192 - MatStm1.comp[1].VP[5] * 310.0000000000001 ^ MatStm1.comp[1].VP[6]) + MatStm1.compMolFrac[1,2] * exp((-MatStm1.comp[2].VP[2]) - MatStm1.comp[2].VP[3] / 310.0000000000001 - MatStm1.comp[2].VP[4] * 5.736572297479192 - MatStm1.comp[2].VP[5] * 310.0000000000001 ^ MatStm1.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
void splitter1_eqFunction_80(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[0] = data->localData[0]->realVars[94] /* MatStm1.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[1] = data->localData[0]->realVars[51] /* MatStm1.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[2] = data->localData[0]->realVars[53] /* MatStm1.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[3] = data->localData[0]->realVars[54] /* MatStm1.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[4] = data->localData[0]->realVars[52] /* MatStm1.compMolFrac[2,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[94] /* MatStm1.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[0];
  data->localData[0]->realVars[51] /* MatStm1.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[1];
  data->localData[0]->realVars[53] /* MatStm1.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[2];
  data->localData[0]->realVars[54] /* MatStm1.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[3];
  data->localData[0]->realVars[52] /* MatStm1.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[0].nlsx[4];
  TRACE_POP
}
...
type: ALGORITHM
  ...
  (MatStm1.compMolEntr[2,2], MatStm1.compMolEntr[3,2]) := Simulator.Files.Thermodynamic_Functions.SId(MatStm1.comp[2].AS, {MatStm1.comp[2].VapCp[1], MatStm1.comp[2].VapCp[2], MatStm1.comp[2].VapCp[3], MatStm1.comp[2].VapCp[4], MatStm1.comp[2].VapCp[5], MatStm1.comp[2].VapCp[6]}, {MatStm1.comp[2].HOV[1], MatStm1.comp[2].HOV[2], MatStm1.comp[2].HOV[3], MatStm1.comp[2].HOV[4], MatStm1.comp[2].HOV[5], MatStm1.comp[2].HOV[6]}, MatStm1.comp[2].Tb, MatStm1.comp[2].Tc, 310.0000000000001, 101325.0, MatStm1.compMolFrac[2,2], MatStm1.compMolFrac[3,2]);
*/
void splitter1_eqFunction_83(DATA *data, threadData_t *threadData)
{
  ...
  array_alloc_scalar_real_array(&tmp0, 6, (modelica_real)data->simulationInfo->realParameter[205], (modelica_real)data->simulationInfo->realParameter[206], (modelica_real)data->simulationInfo->realParameter[207], (modelica_real)data->simulationInfo->realParameter[208], (modelica_real)data->simulationInfo->realParameter[209], (modelica_real)data->simulationInfo->realParameter[210]);
  array_alloc_scalar_real_array(&tmp1, 6, (modelica_real)data->simulationInfo->realParameter[105], (modelica_real)data->simulationInfo->realParameter[106], (modelica_real)data->simulationInfo->realParameter[107], (modelica_real)data->simulationInfo->realParameter[108], (modelica_real)data->simulationInfo->realParameter[109], (modelica_real)data->simulationInfo->realParameter[110]);
  data->localData[0]->realVars[40] /* MatStm1.compMolEntr[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_SId(threadData, data->simulationInfo->realParameter[82], tmp0, tmp1, data->simulationInfo->realParameter[178], data->simulationInfo->realParameter[180], 310.0000000000001, 101325.0, data->localData[0]->realVars[52] /* MatStm1.compMolFrac[2,2] variable */, data->localData[0]->realVars[54] /* MatStm1.compMolFrac[3,2] variable */ ,&data->localData[0]->realVars[42] /* MatStm1.compMolEntr[3,2] variable */);
  TRACE_POP
}
...
void splitter1_eqFunction_108(DATA *data, threadData_t *threadData)
{
  ...
  int retValue;
  double aux_x[5] = { data->localData[1]->realVars[30] /* MatStm1.compMasFrac[3,2] variable */,data->localData[1]->realVars[28] /* MatStm1.compMasFrac[2,2] variable */,data->localData[1]->realVars[25] /* MatStm1.compMasFrac[1,1] variable */,data->localData[1]->realVars[29] /* MatStm1.compMasFrac[3,1] variable */,data->localData[1]->realVars[27] /* MatStm1.compMasFrac[2,1] variable */ };
  if(ACTIVE_STREAM(LOG_DT))
  {
  ...
  data->localData[0]->realVars[29] /* MatStm1.compMasFrac[3,1] variable */ = aux_x[3];
  data->localData[0]->realVars[27] /* MatStm1.compMasFrac[2,1] variable */ = aux_x[4];
  TRACE_POP
}
...
equation index: 128
type: SIMPLE_ASSIGN
MatStm4._Pbubl = MatStm4.compMolFrac[1,1] * exp(MatStm4.comp[1].VP[2] + MatStm4.comp[1].VP[3] / 310.0000000000001 + MatStm4.comp[1].VP[4] * 5.736572297479192 + MatStm4.comp[1].VP[5] * 310.0000000000001 ^ MatStm4.comp[1].VP[6]) + MatStm4.compMolFrac[1,2] * exp(MatStm4.comp[2].VP[2] + MatStm4.comp[2].VP[3] / 310.0000000000001 + MatStm4.comp[2].VP[4] * 5.736572297479192 + MatStm4.comp[2].VP[5] * 310.0000000000001 ^ MatStm4.comp[2].VP[6])
*/
...
equation index: 129
type: SIMPLE_ASSIGN
MatStm4._Pdew = 1.0 / (MatStm4.compMolFrac[1,1] * exp((-MatStm4.comp[1].VP[2]) - MatStm4.comp[1].VP[3] / 310.0000000000001 - MatStm4.comp[1].VP[4] * 5.736572297479192 - MatStm4.comp[1].VP[5] * 310.0000000000001 ^ MatStm4.comp[1].VP[6]) + MatStm4.compMolFrac[1,2] * exp((-MatStm4.comp[2].VP[2]) - MatStm4.comp[2].VP[3] / 310.0000000000001 - MatStm4.comp[2].VP[4] * 5.736572297479192 - MatStm4.comp[2].VP[5] * 310.0000000000001 ^ MatStm4.comp[2].VP[6]))
*/
void splitter1_eqFunction_129(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[105] /* MatStm4.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[138] /* MatStm4.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[346]) - (DIVISION_SIM(data->simulationInfo->realParameter[347],310.0000000000001,"310.0000000000001",equationIndexes)) - ((data->simulationInfo->realParameter[348]) * (5.736572297479192)) - ((data->simulationInfo->realParameter[349]) * (tmp29)))) + (data->localData[0]->realVars[139] /* MatStm4.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[352]) - (DIVISION_SIM(data->simulationInfo->realParameter[353],310.0000000000001,"310.0000000000001",equationIndexes)) - ((data->simulationInfo->realParameter[354]) * (5.736572297479192)) - ((data->simulationInfo->realParameter[355]) * (tmp36)))),"MatStm4.compMolFrac[1,1] * exp((-MatStm4.comp[1].VP[2]) - MatStm4.comp[1].VP[3] / 310.0000000000001 - MatStm4.comp[1].VP[4] * 5.736572297479192 - MatStm4.comp[1].VP[5] * 310.0000000000001 ^ MatStm4.comp[1].VP[6]) + MatStm4.compMolFrac[1,2] * exp((-MatStm4.comp[2].VP[2]) - MatStm4.comp[2].VP[3] / 310.0000000000001 - MatStm4.comp[2].VP[4] * 5.736572297479192 - MatStm4.comp[2].VP[5] * 310.0000000000001 ^ MatStm4.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
vars: {MatStm4._totMolFlo[2], MatStm4._compMolFrac[3,1], MatStm4._compMolFrac[3,2], MatStm4._compMolFrac[2,2], MatStm4._compMolFrac[2,1]}
...
void splitter1_eqFunction_154(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[0] = data->localData[0]->realVars[181] /* MatStm4.totMolFlo[2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[1] = data->localData[0]->realVars[142] /* MatStm4.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[2] = data->localData[0]->realVars[143] /* MatStm4.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[3] = data->localData[0]->realVars[141] /* MatStm4.compMolFrac[2,2] variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[4] = data->localData[0]->realVars[140] /* MatStm4.compMolFrac[2,1] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[181] /* MatStm4.totMolFlo[2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[0];
  data->localData[0]->realVars[142] /* MatStm4.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[1];
  data->localData[0]->realVars[143] /* MatStm4.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[2];
  data->localData[0]->realVars[141] /* MatStm4.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[3];
  data->localData[0]->realVars[140] /* MatStm4.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[4];
  TRACE_POP
}
...
type: ALGORITHM
  ...
  (MatStm4.compMolEntr[2,2], MatStm4.compMolEntr[3,2]) := Simulator.Files.Thermodynamic_Functions.SId(MatStm4.comp[2].AS, {MatStm4.comp[2].VapCp[1], MatStm4.comp[2].VapCp[2], MatStm4.comp[2].VapCp[3], MatStm4.comp[2].VapCp[4], MatStm4.comp[2].VapCp[5], MatStm4.comp[2].VapCp[6]}, {MatStm4.comp[2].HOV[1], MatStm4.comp[2].HOV[2], MatStm4.comp[2].HOV[3], MatStm4.comp[2].HOV[4], MatStm4.comp[2].HOV[5], MatStm4.comp[2].HOV[6]}, MatStm4.comp[2].Tb, MatStm4.comp[2].Tc, 310.0000000000001, 101325.0, MatStm4.compMolFrac[2,2], MatStm4.compMolFrac[3,2]);
*/
void splitter1_eqFunction_162(DATA *data, threadData_t *threadData)
{
  ...
  array_alloc_scalar_real_array(&tmp2, 6, (modelica_real)data->simulationInfo->realParameter[363], (modelica_real)data->simulationInfo->realParameter[364], (modelica_real)data->simulationInfo->realParameter[365], (modelica_real)data->simulationInfo->realParameter[366], (modelica_real)data->simulationInfo->realParameter[367], (modelica_real)data->simulationInfo->realParameter[368]);
  array_alloc_scalar_real_array(&tmp3, 6, (modelica_real)data->simulationInfo->realParameter[263], (modelica_real)data->simulationInfo->realParameter[264], (modelica_real)data->simulationInfo->realParameter[265], (modelica_real)data->simulationInfo->realParameter[266], (modelica_real)data->simulationInfo->realParameter[267], (modelica_real)data->simulationInfo->realParameter[268]);
  data->localData[0]->realVars[129] /* MatStm4.compMolEntr[2,2] variable */ = omc_Simulator_Files_Thermodynamic__Functions_SId(threadData, data->simulationInfo->realParameter[240], tmp2, tmp3, data->simulationInfo->realParameter[336], data->simulationInfo->realParameter[338], 310.0000000000001, 101325.0, data->localData[0]->realVars[141] /* MatStm4.compMolFrac[2,2] variable */, data->localData[0]->realVars[143] /* MatStm4.compMolFrac[3,2] variable */ ,&data->localData[0]->realVars[131] /* MatStm4.compMolEntr[3,2] variable */);
  TRACE_POP
}
...
equation index: 187
type: SIMPLE_ASSIGN
MatStm5._Pbubl = MatStm5.compMolFrac[1,1] * exp(MatStm5.comp[1].VP[2] + MatStm5.comp[1].VP[3] / 310.0000000000001 + MatStm5.comp[1].VP[4] * 5.736572297479192 + MatStm5.comp[1].VP[5] * 310.0000000000001 ^ MatStm5.comp[1].VP[6]) + MatStm5.compMolFrac[1,2] * exp(MatStm5.comp[2].VP[2] + MatStm5.comp[2].VP[3] / 310.0000000000001 + MatStm5.comp[2].VP[4] * 5.736572297479192 + MatStm5.comp[2].VP[5] * 310.0000000000001 ^ MatStm5.comp[2].VP[6])
*/
...
equation index: 188
type: SIMPLE_ASSIGN
MatStm5._Pdew = 1.0 / (MatStm5.compMolFrac[1,1] * exp((-MatStm5.comp[1].VP[2]) - MatStm5.comp[1].VP[3] / 310.0000000000001 - MatStm5.comp[1].VP[4] * 5.736572297479192 - MatStm5.comp[1].VP[5] * 310.0000000000001 ^ MatStm5.comp[1].VP[6]) + MatStm5.compMolFrac[1,2] * exp((-MatStm5.comp[2].VP[2]) - MatStm5.comp[2].VP[3] / 310.0000000000001 - MatStm5.comp[2].VP[4] * 5.736572297479192 - MatStm5.comp[2].VP[5] * 310.0000000000001 ^ MatStm5.comp[2].VP[6]))
*/
void splitter1_eqFunction_188(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[193] /* MatStm5.Pdew variable */ = DIVISION_SIM(1.0,(data->localData[0]->realVars[226] /* MatStm5.compMolFrac[1,1] variable */) * (exp((-data->simulationInfo->realParameter[504]) - (DIVISION_SIM(data->simulationInfo->realParameter[505],310.0000000000001,"310.0000000000001",equationIndexes)) - ((data->simulationInfo->realParameter[506]) * (5.736572297479192)) - ((data->simulationInfo->realParameter[507]) * (tmp26)))) + (data->localData[0]->realVars[227] /* MatStm5.compMolFrac[1,2] variable */) * (exp((-data->simulationInfo->realParameter[510]) - (DIVISION_SIM(data->simulationInfo->realParameter[511],310.0000000000001,"310.0000000000001",equationIndexes)) - ((data->simulationInfo->realParameter[512]) * (5.736572297479192)) - ((data->simulationInfo->realParameter[513]) * (tmp33)))),"MatStm5.compMolFrac[1,1] * exp((-MatStm5.comp[1].VP[2]) - MatStm5.comp[1].VP[3] / 310.0000000000001 - MatStm5.comp[1].VP[4] * 5.736572297479192 - MatStm5.comp[1].VP[5] * 310.0000000000001 ^ MatStm5.comp[1].VP[6]) + MatStm5.compMolFrac[1,2] * exp((-MatStm5.comp[2].VP[2]) - MatStm5.comp[2].VP[3] / 310.0000000000001 - MatStm5.comp[2].VP[4] * 5.736572297479192 - MatStm5.comp[2].VP[5] * 310.0000000000001 ^ MatStm5.comp[2].VP[6])",equationIndexes);
  TRACE_POP
}
...
vars: {MatStm5._totMolFlo[3], MatStm5._compMolFrac[2,1], MatStm5._compMolFrac[3,1], MatStm5._compMolFrac[3,2], MatStm5._compMolFrac[2,2]}
...
void splitter1_eqFunction_213(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[0] = data->localData[0]->realVars[270] /* MatStm5.totMolFlo[3] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[1] = data->localData[0]->realVars[228] /* MatStm5.compMolFrac[2,1] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[2] = data->localData[0]->realVars[230] /* MatStm5.compMolFrac[3,1] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[3] = data->localData[0]->realVars[231] /* MatStm5.compMolFrac[3,2] variable */;
  data->simulationInfo->nonlinearSystemData[2].nlsxOld[4] = data->localData[0]->realVars[229] /* MatStm5.compMolFrac[2,2] variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[270] /* MatStm5.totMolFlo[3] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[0];
  data->localData[0]->realVars[228] /* MatStm5.compMolFrac[2,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[1];
  data->localData[0]->realVars[230] /* MatStm5.compMolFrac[3,1] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[2];
  data->localData[0]->realVars[231] /* MatStm5.compMolFrac[3,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[3];
  data->localData[0]->realVars[229] /* MatStm5.compMolFrac[2,2] variable */ = data->simulationInfo->nonlinearSystemData[2].nlsx[4];
  TRACE_POP
}
...
type: ALGORITHM
  ...
  (MatStm5.compMolEntr[2,2], MatStm5.compMolEntr[3,2]) := Simulator.Files.Thermodynamic_Functions.SId(MatStm5.comp[2].AS, {MatStm5.comp[2].VapCp[1], MatStm5.comp[2].VapCp[2], MatStm5.comp[2].VapCp[3], MatStm5.comp[2].VapCp[4], MatStm5.comp[2].VapCp[5], MatStm5.comp[2].VapCp[6]}, {MatStm5.comp[2].HOV[1], MatStm5.comp[2].HOV[2], MatStm5.comp[2].HOV[3], MatStm5.comp[2].HOV[4], MatStm5.comp[2].HOV[5], MatStm5.comp[2].HOV[6]}, MatStm5.comp[2].Tb, MatStm5.comp[2].Tc, 310.0000000000001, 101325.0, MatStm5.compMolFrac[2,2], MatStm5.compMolFrac[3,2]);
*/
...
equation index: 290
type: SIMPLE_ASSIGN
MatStm1._T = 310.0000000000001
*/
void splitter1_eqFunction_290(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,290};
  data->localData[0]->realVars[18] /* MatStm1.T variable */ = 310.0000000000001;
  TRACE_POP
}
...
void splitter1_eqFunction_291(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[92] /* MatStm1.totMolFlo[1] variable */ = 200.0;
  TRACE_POP
}
OMC_DISABLE_OPT
void splitter1_functionInitialEquations_0(DATA *data, threadData_t *threadData)
