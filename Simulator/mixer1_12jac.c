...
void mixer1_eqFunction_75(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm2.compMolFlo.$pDERNLSJac0.dummyVarNLSJac0[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,2] variable */) * (jacobian->seedVars[0] /* MatStm2.totMolFlo.SeedNLSJac0[2] SEED_VAR */) + (jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */) * (data->localData[0]->realVars[180] /* MatStm2.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 77
type: SIMPLE_ASSIGN
Mixer1._inVapPhasMolFrac._$pDERNLSJac0._dummyVarNLSJac0[1] = -MatStm2.liqPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0
*/
void mixer1_eqFunction_77(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0[1] JACOBIAN_DIFF_VAR */ = (-jacobian->tmpVars[2] /* MatStm2.liqPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 78
type: SIMPLE_ASSIGN
MatStm2._totMolFlo._$pDERNLSJac0._dummyVarNLSJac0[3] = 100.0 * Mixer1.inVapPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0[1]
*/
void mixer1_eqFunction_78(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* MatStm2.totMolFlo.$pDERNLSJac0.dummyVarNLSJac0[3] JACOBIAN_DIFF_VAR */ = (100.0) * (jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0[1] JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 81
type: SIMPLE_ASSIGN
$res1._$pDERNLSJac0._dummyVarNLSJac0 = if 101325.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac0[3,2] else if 101325.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac0[2,2] + MatStm2.compMolFrac[1,2] * Mixer1.inVapPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0[1] * (-1.0 + MatStm2.K[2]) / (1.0 + Mixer1.inVapPhasMolFrac[1] * (-1.0 + MatStm2.K[2])) ^ 2.0 else MatStm2.compMolFrac.SeedNLSJac0[2,2]
*/
void mixer1_eqFunction_81(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp5)
  {
    tmp6 = jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac0[3,2] SEED_VAR */;
  }
  else
  {
    ...
    if(tmp3)
    {
      tmp2 = 1.0 + (data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */) * (-1.0 + data->localData[0]->realVars[96] /* MatStm2.K[2] variable */);
      tmp4 = jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */ + DIVISION((data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */) * ((jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0[1] JACOBIAN_DIFF_VAR */) * (-1.0 + data->localData[0]->realVars[96] /* MatStm2.K[2] variable */)),(tmp2 * tmp2),"(1.0 + Mixer1.inVapPhasMolFrac[1] * (-1.0 + MatStm2.K[2])) ^ 2.0");
    }
    else
    {
      tmp4 = jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac0[2,2] SEED_VAR */;
    }
    tmp6 = tmp4;
  }
...
void mixer1_eqFunction_83(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp10;
  tmp7 = GreaterEq(101325.0,data->localData[0]->realVars[101] /* MatStm2.Pbubl variable */);
  tmp9 = (modelica_boolean)tmp7;
  if(tmp9)
  {
    tmp10 = jacobian->tmpVars[4] /* MatStm2.totMolFlo.$pDERNLSJac0.dummyVarNLSJac0[3] JACOBIAN_DIFF_VAR */;
  }
  else
  {
    tmp8 = GreaterEq(101325.0,data->localData[0]->realVars[102] /* MatStm2.Pdew variable */);
    tmp10 = (tmp8?jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac0[3,1] SEED_VAR */ + jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac0[3,2] SEED_VAR */:jacobian->seedVars[0] /* MatStm2.totMolFlo.SeedNLSJac0[2] SEED_VAR */);
  }
...
equation index: 85
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac0._dummyVarNLSJac0 = if 101325.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac0[3,1] else if 101325.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac0[2,1] + MatStm2.compMolFrac[1,1] * Mixer1.inVapPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0[1] * (-1.0 + MatStm2.K[1]) / (1.0 + Mixer1.inVapPhasMolFrac[1] * (-1.0 + MatStm2.K[1])) ^ 2.0 else MatStm2.compMolFrac.SeedNLSJac0[2,1]
*/
void mixer1_eqFunction_85(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp16)
  {
    tmp17 = jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac0[3,1] SEED_VAR */;
  }
  else
  {
    ...
    if(tmp14)
    {
      tmp13 = 1.0 + (data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */) * (-1.0 + data->localData[0]->realVars[95] /* MatStm2.K[1] variable */);
      tmp15 = jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */ + DIVISION((data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */) * ((jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac0.dummyVarNLSJac0[1] JACOBIAN_DIFF_VAR */) * (-1.0 + data->localData[0]->realVars[95] /* MatStm2.K[1] variable */)),(tmp13 * tmp13),"(1.0 + Mixer1.inVapPhasMolFrac[1] * (-1.0 + MatStm2.K[1])) ^ 2.0");
    }
    else
    {
      tmp15 = jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac0[2,1] SEED_VAR */;
    }
    tmp17 = tmp15;
  }
...
void mixer1_eqFunction_128(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */) * (jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac1[2] SEED_VAR */) + (jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */) * (data->localData[0]->realVars[90] /* MatStm1.totMolFlo[2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_129(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[49] /* MatStm1.compMolFrac[2,2] variable */) * (jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac1[2] SEED_VAR */) + (jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */) * (data->localData[0]->realVars[90] /* MatStm1.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 131
type: SIMPLE_ASSIGN
Mixer1._inVapPhasMolFrac._$pDERNLSJac1._dummyVarNLSJac1[2] = -MatStm1.liqPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1
*/
void mixer1_eqFunction_131(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2] JACOBIAN_DIFF_VAR */ = (-jacobian->tmpVars[2] /* MatStm1.liqPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 132
type: SIMPLE_ASSIGN
MatStm1._totMolFlo._$pDERNLSJac1._dummyVarNLSJac1[3] = 100.0 * Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2]
*/
void mixer1_eqFunction_132(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* MatStm1.totMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3] JACOBIAN_DIFF_VAR */ = (100.0) * (jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2] JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void mixer1_eqFunction_133(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[51] /* MatStm1.compMolFrac[3,2] variable */) * (jacobian->tmpVars[4] /* MatStm1.totMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac1[3,2] SEED_VAR */) * (data->localData[0]->realVars[91] /* MatStm1.totMolFlo[3] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_134(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */) * (jacobian->tmpVars[4] /* MatStm1.totMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac1[3,1] SEED_VAR */) * (data->localData[0]->realVars[91] /* MatStm1.totMolFlo[3] variable */);
  TRACE_POP
}
...
equation index: 135
type: SIMPLE_ASSIGN
$res1._$pDERNLSJac1._dummyVarNLSJac1 = if 101325.0 >= MatStm1.Pbubl then MatStm1.compMolFrac.SeedNLSJac1[3,2] else if 101325.0 >= MatStm1.Pdew then MatStm1.compMolFrac.SeedNLSJac1[2,2] + MatStm1.compMolFrac[1,2] * Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2] * (-1.0 + MatStm1.K[2]) / (1.0 + Mixer1.inVapPhasMolFrac[2] * (-1.0 + MatStm1.K[2])) ^ 2.0 else MatStm1.compMolFrac.SeedNLSJac1[2,2]
*/
void mixer1_eqFunction_135(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp24;
  tmp18 = GreaterEq(101325.0,data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */);
  tmp23 = (modelica_boolean)tmp18;
  if(tmp23)
  {
    tmp24 = jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac1[3,2] SEED_VAR */;
  }
  else
  {
    tmp19 = GreaterEq(101325.0,data->localData[0]->realVars[12] /* MatStm1.Pdew variable */);
    tmp21 = (modelica_boolean)tmp19;
    if(tmp21)
    {
      tmp20 = 1.0 + (data->localData[0]->realVars[277] /* Mixer1.inVapPhasMolFrac[2] variable */) * (-1.0 + data->localData[0]->realVars[6] /* MatStm1.K[2] variable */);
      tmp22 = jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */ + DIVISION((data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) * ((jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2] JACOBIAN_DIFF_VAR */) * (-1.0 + data->localData[0]->realVars[6] /* MatStm1.K[2] variable */)),(tmp20 * tmp20),"(1.0 + Mixer1.inVapPhasMolFrac[2] * (-1.0 + MatStm1.K[2])) ^ 2.0");
    }
    else
    {
      tmp22 = jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac1[2,2] SEED_VAR */;
    }
    tmp24 = tmp22;
  }
...
void mixer1_eqFunction_136(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[1] /* $res2.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_VAR */ = jacobian->tmpVars[6] /* MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,1] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[0] /* MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,1] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 137
type: SIMPLE_ASSIGN
$res3._$pDERNLSJac1._dummyVarNLSJac1 = if 101325.0 >= MatStm1.Pbubl then MatStm1.totMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3] else if 101325.0 >= MatStm1.Pdew then MatStm1.compMolFrac.SeedNLSJac1[3,1] + MatStm1.compMolFrac.SeedNLSJac1[3,2] else MatStm1.totMolFlo.SeedNLSJac1[2]
*/
void mixer1_eqFunction_137(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp27)
  {
    tmp28 = jacobian->tmpVars[4] /* MatStm1.totMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3] JACOBIAN_DIFF_VAR */;
  }
  else
  {
    tmp26 = GreaterEq(101325.0,data->localData[0]->realVars[12] /* MatStm1.Pdew variable */);
    tmp28 = (tmp26?jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac1[3,1] SEED_VAR */ + jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac1[3,2] SEED_VAR */:jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac1[2] SEED_VAR */);
  }
...
equation index: 138
type: SIMPLE_ASSIGN
$res4._$pDERNLSJac1._dummyVarNLSJac1 = MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,2] + MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,2]
*/
void mixer1_eqFunction_138(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[3] /* $res4.$pDERNLSJac1.dummyVarNLSJac1 JACOBIAN_VAR */ = jacobian->tmpVars[5] /* MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[3,2] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[1] /* MatStm1.compMolFlo.$pDERNLSJac1.dummyVarNLSJac1[2,2] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 139
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac1._dummyVarNLSJac1 = if 101325.0 >= MatStm1.Pbubl then MatStm1.compMolFrac.SeedNLSJac1[3,1] else if 101325.0 >= MatStm1.Pdew then MatStm1.compMolFrac.SeedNLSJac1[2,1] + MatStm1.compMolFrac[1,1] * Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2] * (-1.0 + MatStm1.K[1]) / (1.0 + Mixer1.inVapPhasMolFrac[2] * (-1.0 + MatStm1.K[1])) ^ 2.0 else MatStm1.compMolFrac.SeedNLSJac1[2,1]
*/
void mixer1_eqFunction_139(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp35;
  tmp29 = GreaterEq(101325.0,data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */);
  tmp34 = (modelica_boolean)tmp29;
  if(tmp34)
  {
    tmp35 = jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac1[3,1] SEED_VAR */;
  }
  else
  {
    tmp30 = GreaterEq(101325.0,data->localData[0]->realVars[12] /* MatStm1.Pdew variable */);
    tmp32 = (modelica_boolean)tmp30;
    if(tmp32)
    {
      tmp31 = 1.0 + (data->localData[0]->realVars[277] /* Mixer1.inVapPhasMolFrac[2] variable */) * (-1.0 + data->localData[0]->realVars[5] /* MatStm1.K[1] variable */);
      tmp33 = jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */ + DIVISION((data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) * ((jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac1.dummyVarNLSJac1[2] JACOBIAN_DIFF_VAR */) * (-1.0 + data->localData[0]->realVars[5] /* MatStm1.K[1] variable */)),(tmp31 * tmp31),"(1.0 + Mixer1.inVapPhasMolFrac[2] * (-1.0 + MatStm1.K[1])) ^ 2.0");
    }
    else
    {
      tmp33 = jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac1[2,1] SEED_VAR */;
    }
    tmp35 = tmp33;
  }
...
void mixer1_eqFunction_293(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[3,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[141] /* MatStm2.compMolFrac[3,2] variable */) * (jacobian->seedVars[0] /* MatStm2.totMolFlo.SeedNLSJac3[3] SEED_VAR */) + (jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac3[3,2] SEED_VAR */) * (data->localData[0]->realVars[181] /* MatStm2.totMolFlo[3] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_294(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[3,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[140] /* MatStm2.compMolFrac[3,1] variable */) * (jacobian->seedVars[0] /* MatStm2.totMolFlo.SeedNLSJac3[3] SEED_VAR */) + (jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac3[3,1] SEED_VAR */) * (data->localData[0]->realVars[181] /* MatStm2.totMolFlo[3] variable */);
  TRACE_POP
}
...
equation index: 295
type: SIMPLE_ASSIGN
Mixer1._inVapPhasMolFrac._$pDERNLSJac3._dummyVarNLSJac3[1] = 0.01 * MatStm2.totMolFlo.SeedNLSJac3[3]
*/
void mixer1_eqFunction_295(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[2] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3[1] JACOBIAN_DIFF_VAR */ = (0.01) * (jacobian->seedVars[0] /* MatStm2.totMolFlo.SeedNLSJac3[3] SEED_VAR */);
  TRACE_POP
}
...
equation index: 296
type: SIMPLE_ASSIGN
MatStm2._liqPhasMolFrac._$pDERNLSJac3._dummyVarNLSJac3 = -Mixer1.inVapPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3[1]
*/
void mixer1_eqFunction_296(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* MatStm2.liqPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3 JACOBIAN_DIFF_VAR */ = (-jacobian->tmpVars[2] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3[1] JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 297
type: SIMPLE_ASSIGN
MatStm2._totMolFlo._$pDERNLSJac3._dummyVarNLSJac3[2] = 100.0 * MatStm2.liqPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3
*/
void mixer1_eqFunction_297(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* MatStm2.totMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2] JACOBIAN_DIFF_VAR */ = (100.0) * (jacobian->tmpVars[3] /* MatStm2.liqPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void mixer1_eqFunction_298(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[139] /* MatStm2.compMolFrac[2,2] variable */) * (jacobian->tmpVars[4] /* MatStm2.totMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */) * (data->localData[0]->realVars[180] /* MatStm2.totMolFlo[2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_299(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[138] /* MatStm2.compMolFrac[2,1] variable */) * (jacobian->tmpVars[4] /* MatStm2.totMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */) * (data->localData[0]->realVars[180] /* MatStm2.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 300
type: SIMPLE_ASSIGN
$res1._$pDERNLSJac3._dummyVarNLSJac3 = if 101325.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac3[3,1] else if 101325.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac3[2,1] + MatStm2.compMolFrac[1,1] * Mixer1.inVapPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3[1] * (-1.0 + MatStm2.K[1]) / (1.0 + Mixer1.inVapPhasMolFrac[1] * (-1.0 + MatStm2.K[1])) ^ 2.0 else MatStm2.compMolFrac.SeedNLSJac3[2,1]
*/
void mixer1_eqFunction_300(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp42;
  tmp36 = GreaterEq(101325.0,data->localData[0]->realVars[101] /* MatStm2.Pbubl variable */);
  tmp41 = (modelica_boolean)tmp36;
  if(tmp41)
  {
    tmp42 = jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac3[3,1] SEED_VAR */;
  }
  else
  {
    tmp37 = GreaterEq(101325.0,data->localData[0]->realVars[102] /* MatStm2.Pdew variable */);
    tmp39 = (modelica_boolean)tmp37;
    if(tmp39)
    {
      tmp38 = 1.0 + (data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */) * (-1.0 + data->localData[0]->realVars[95] /* MatStm2.K[1] variable */);
      tmp40 = jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */ + DIVISION((data->localData[0]->realVars[136] /* MatStm2.compMolFrac[1,1] variable */) * ((jacobian->tmpVars[2] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3[1] JACOBIAN_DIFF_VAR */) * (-1.0 + data->localData[0]->realVars[95] /* MatStm2.K[1] variable */)),(tmp38 * tmp38),"(1.0 + Mixer1.inVapPhasMolFrac[1] * (-1.0 + MatStm2.K[1])) ^ 2.0");
    }
    else
    {
      tmp40 = jacobian->seedVars[4] /* MatStm2.compMolFrac.SeedNLSJac3[2,1] SEED_VAR */;
    }
    tmp42 = tmp40;
  }
...
equation index: 301
type: SIMPLE_ASSIGN
$res2._$pDERNLSJac3._dummyVarNLSJac3 = MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[3,1] + MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2,1]
*/
void mixer1_eqFunction_301(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[1] /* $res2.$pDERNLSJac3.dummyVarNLSJac3 JACOBIAN_VAR */ = jacobian->tmpVars[1] /* MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[3,1] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[6] /* MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2,1] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 302
type: SIMPLE_ASSIGN
$res3._$pDERNLSJac3._dummyVarNLSJac3 = if 101325.0 >= MatStm2.Pbubl then MatStm2.totMolFlo.SeedNLSJac3[3] else if 101325.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac3[3,1] + MatStm2.compMolFrac.SeedNLSJac3[3,2] else MatStm2.totMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2]
*/
void mixer1_eqFunction_302(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp46;
  tmp43 = GreaterEq(101325.0,data->localData[0]->realVars[101] /* MatStm2.Pbubl variable */);
  tmp45 = (modelica_boolean)tmp43;
  if(tmp45)
  {
    tmp46 = jacobian->seedVars[0] /* MatStm2.totMolFlo.SeedNLSJac3[3] SEED_VAR */;
  }
  else
  {
    tmp44 = GreaterEq(101325.0,data->localData[0]->realVars[102] /* MatStm2.Pdew variable */);
    tmp46 = (tmp44?jacobian->seedVars[3] /* MatStm2.compMolFrac.SeedNLSJac3[3,1] SEED_VAR */ + jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac3[3,2] SEED_VAR */:jacobian->tmpVars[4] /* MatStm2.totMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2] JACOBIAN_DIFF_VAR */);
  }
...
void mixer1_eqFunction_303(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[3] /* $res4.$pDERNLSJac3.dummyVarNLSJac3 JACOBIAN_VAR */ = jacobian->tmpVars[0] /* MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[3,2] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[5] /* MatStm2.compMolFlo.$pDERNLSJac3.dummyVarNLSJac3[2,2] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 304
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac3._dummyVarNLSJac3 = if 101325.0 >= MatStm2.Pbubl then MatStm2.compMolFrac.SeedNLSJac3[3,2] else if 101325.0 >= MatStm2.Pdew then MatStm2.compMolFrac.SeedNLSJac3[2,2] + MatStm2.compMolFrac[1,2] * Mixer1.inVapPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3[1] * (-1.0 + MatStm2.K[2]) / (1.0 + Mixer1.inVapPhasMolFrac[1] * (-1.0 + MatStm2.K[2])) ^ 2.0 else MatStm2.compMolFrac.SeedNLSJac3[2,2]
*/
void mixer1_eqFunction_304(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp53;
  tmp47 = GreaterEq(101325.0,data->localData[0]->realVars[101] /* MatStm2.Pbubl variable */);
  tmp52 = (modelica_boolean)tmp47;
  if(tmp52)
  {
    tmp53 = jacobian->seedVars[1] /* MatStm2.compMolFrac.SeedNLSJac3[3,2] SEED_VAR */;
  }
  else
  {
    tmp48 = GreaterEq(101325.0,data->localData[0]->realVars[102] /* MatStm2.Pdew variable */);
    tmp50 = (modelica_boolean)tmp48;
    if(tmp50)
    {
      tmp49 = 1.0 + (data->localData[0]->realVars[276] /* Mixer1.inVapPhasMolFrac[1] variable */) * (-1.0 + data->localData[0]->realVars[96] /* MatStm2.K[2] variable */);
      tmp51 = jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */ + DIVISION((data->localData[0]->realVars[137] /* MatStm2.compMolFrac[1,2] variable */) * ((jacobian->tmpVars[2] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac3.dummyVarNLSJac3[1] JACOBIAN_DIFF_VAR */) * (-1.0 + data->localData[0]->realVars[96] /* MatStm2.K[2] variable */)),(tmp49 * tmp49),"(1.0 + Mixer1.inVapPhasMolFrac[1] * (-1.0 + MatStm2.K[2])) ^ 2.0");
    }
    else
    {
      tmp51 = jacobian->seedVars[2] /* MatStm2.compMolFrac.SeedNLSJac3[2,2] SEED_VAR */;
    }
    tmp53 = tmp51;
  }
...
void mixer1_eqFunction_347(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[49] /* MatStm1.compMolFrac[2,2] variable */) * (jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac4[2] SEED_VAR */) + (jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */) * (data->localData[0]->realVars[90] /* MatStm1.totMolFlo[2] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_348(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[48] /* MatStm1.compMolFrac[2,1] variable */) * (jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac4[2] SEED_VAR */) + (jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */) * (data->localData[0]->realVars[90] /* MatStm1.totMolFlo[2] variable */);
  TRACE_POP
}
...
equation index: 349
type: SIMPLE_ASSIGN
MatStm1._liqPhasMolFrac._$pDERNLSJac4._dummyVarNLSJac4 = 0.01 * MatStm1.totMolFlo.SeedNLSJac4[2]
*/
void mixer1_eqFunction_349(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[2] /* MatStm1.liqPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_DIFF_VAR */ = (0.01) * (jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac4[2] SEED_VAR */);
  TRACE_POP
}
...
equation index: 350
type: SIMPLE_ASSIGN
Mixer1._inVapPhasMolFrac._$pDERNLSJac4._dummyVarNLSJac4[2] = -MatStm1.liqPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4
*/
void mixer1_eqFunction_350(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2] JACOBIAN_DIFF_VAR */ = (-jacobian->tmpVars[2] /* MatStm1.liqPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 351
type: SIMPLE_ASSIGN
MatStm1._totMolFlo._$pDERNLSJac4._dummyVarNLSJac4[3] = 100.0 * Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2]
*/
void mixer1_eqFunction_351(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* MatStm1.totMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3] JACOBIAN_DIFF_VAR */ = (100.0) * (jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2] JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void mixer1_eqFunction_352(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,2] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[51] /* MatStm1.compMolFrac[3,2] variable */) * (jacobian->tmpVars[4] /* MatStm1.totMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */) * (data->localData[0]->realVars[91] /* MatStm1.totMolFlo[3] variable */);
  TRACE_POP
}
...
void mixer1_eqFunction_353(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,1] JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[50] /* MatStm1.compMolFrac[3,1] variable */) * (jacobian->tmpVars[4] /* MatStm1.totMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3] JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */) * (data->localData[0]->realVars[91] /* MatStm1.totMolFlo[3] variable */);
  TRACE_POP
}
...
equation index: 354
type: SIMPLE_ASSIGN
$res1._$pDERNLSJac4._dummyVarNLSJac4 = MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,1] + MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,1]
*/
void mixer1_eqFunction_354(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[0] /* $res1.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_VAR */ = jacobian->tmpVars[6] /* MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,1] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[1] /* MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,1] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 355
type: SIMPLE_ASSIGN
$res2._$pDERNLSJac4._dummyVarNLSJac4 = if 101325.0 >= MatStm1.Pbubl then MatStm1.compMolFrac.SeedNLSJac4[3,1] else if 101325.0 >= MatStm1.Pdew then MatStm1.compMolFrac.SeedNLSJac4[2,1] + MatStm1.compMolFrac[1,1] * Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2] * (-1.0 + MatStm1.K[1]) / (1.0 + Mixer1.inVapPhasMolFrac[2] * (-1.0 + MatStm1.K[1])) ^ 2.0 else MatStm1.compMolFrac.SeedNLSJac4[2,1]
*/
void mixer1_eqFunction_355(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp60;
  tmp54 = GreaterEq(101325.0,data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */);
  tmp59 = (modelica_boolean)tmp54;
  if(tmp59)
  {
    tmp60 = jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */;
  }
  else
  {
    tmp55 = GreaterEq(101325.0,data->localData[0]->realVars[12] /* MatStm1.Pdew variable */);
    tmp57 = (modelica_boolean)tmp55;
    if(tmp57)
    {
      tmp56 = 1.0 + (data->localData[0]->realVars[277] /* Mixer1.inVapPhasMolFrac[2] variable */) * (-1.0 + data->localData[0]->realVars[5] /* MatStm1.K[1] variable */);
      tmp58 = jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */ + DIVISION((data->localData[0]->realVars[46] /* MatStm1.compMolFrac[1,1] variable */) * ((jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2] JACOBIAN_DIFF_VAR */) * (-1.0 + data->localData[0]->realVars[5] /* MatStm1.K[1] variable */)),(tmp56 * tmp56),"(1.0 + Mixer1.inVapPhasMolFrac[2] * (-1.0 + MatStm1.K[1])) ^ 2.0");
    }
    else
    {
      tmp58 = jacobian->seedVars[3] /* MatStm1.compMolFrac.SeedNLSJac4[2,1] SEED_VAR */;
    }
    tmp60 = tmp58;
  }
...
equation index: 356
type: SIMPLE_ASSIGN
$res3._$pDERNLSJac4._dummyVarNLSJac4 = if 101325.0 >= MatStm1.Pbubl then MatStm1.totMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3] else if 101325.0 >= MatStm1.Pdew then MatStm1.compMolFrac.SeedNLSJac4[3,1] + MatStm1.compMolFrac.SeedNLSJac4[3,2] else MatStm1.totMolFlo.SeedNLSJac4[2]
*/
void mixer1_eqFunction_356(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp64;
  tmp61 = GreaterEq(101325.0,data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */);
  tmp63 = (modelica_boolean)tmp61;
  if(tmp63)
  {
    tmp64 = jacobian->tmpVars[4] /* MatStm1.totMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3] JACOBIAN_DIFF_VAR */;
  }
  else
  {
    tmp62 = GreaterEq(101325.0,data->localData[0]->realVars[12] /* MatStm1.Pdew variable */);
    tmp64 = (tmp62?jacobian->seedVars[4] /* MatStm1.compMolFrac.SeedNLSJac4[3,1] SEED_VAR */ + jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */:jacobian->seedVars[0] /* MatStm1.totMolFlo.SeedNLSJac4[2] SEED_VAR */);
  }
...
equation index: 357
type: SIMPLE_ASSIGN
$res4._$pDERNLSJac4._dummyVarNLSJac4 = MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,2] + MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,2]
*/
void mixer1_eqFunction_357(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[3] /* $res4.$pDERNLSJac4.dummyVarNLSJac4 JACOBIAN_VAR */ = jacobian->tmpVars[5] /* MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[3,2] JACOBIAN_DIFF_VAR */ + jacobian->tmpVars[0] /* MatStm1.compMolFlo.$pDERNLSJac4.dummyVarNLSJac4[2,2] JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 358
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac4._dummyVarNLSJac4 = if 101325.0 >= MatStm1.Pbubl then MatStm1.compMolFrac.SeedNLSJac4[3,2] else if 101325.0 >= MatStm1.Pdew then MatStm1.compMolFrac.SeedNLSJac4[2,2] + MatStm1.compMolFrac[1,2] * Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2] * (-1.0 + MatStm1.K[2]) / (1.0 + Mixer1.inVapPhasMolFrac[2] * (-1.0 + MatStm1.K[2])) ^ 2.0 else MatStm1.compMolFrac.SeedNLSJac4[2,2]
*/
void mixer1_eqFunction_358(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  modelica_real tmp71;
  tmp65 = GreaterEq(101325.0,data->localData[0]->realVars[11] /* MatStm1.Pbubl variable */);
  tmp70 = (modelica_boolean)tmp65;
  if(tmp70)
  {
    tmp71 = jacobian->seedVars[2] /* MatStm1.compMolFrac.SeedNLSJac4[3,2] SEED_VAR */;
  }
  else
  {
    tmp66 = GreaterEq(101325.0,data->localData[0]->realVars[12] /* MatStm1.Pdew variable */);
    tmp68 = (modelica_boolean)tmp66;
    if(tmp68)
    {
      tmp67 = 1.0 + (data->localData[0]->realVars[277] /* Mixer1.inVapPhasMolFrac[2] variable */) * (-1.0 + data->localData[0]->realVars[6] /* MatStm1.K[2] variable */);
      tmp69 = jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */ + DIVISION((data->localData[0]->realVars[47] /* MatStm1.compMolFrac[1,2] variable */) * ((jacobian->tmpVars[3] /* Mixer1.inVapPhasMolFrac.$pDERNLSJac4.dummyVarNLSJac4[2] JACOBIAN_DIFF_VAR */) * (-1.0 + data->localData[0]->realVars[6] /* MatStm1.K[2] variable */)),(tmp67 * tmp67),"(1.0 + Mixer1.inVapPhasMolFrac[2] * (-1.0 + MatStm1.K[2])) ^ 2.0");
    }
    else
    {
      tmp69 = jacobian->seedVars[1] /* MatStm1.compMolFrac.SeedNLSJac4[2,2] SEED_VAR */;
    }
    tmp71 = tmp69;
  }
