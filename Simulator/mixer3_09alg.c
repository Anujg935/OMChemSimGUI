...
extern void mixer3_eqFunction_308(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_315(DATA* data, threadData_t *threadData);
extern void mixer3_eqFunction_316(DATA* data, threadData_t *threadData);
extern void mixer3_eqFunction_317(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_325(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_362(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_367(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_371(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_377(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_420(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_429(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_432(DATA* data, threadData_t *threadData);
...
extern void mixer3_eqFunction_440(DATA* data, threadData_t *threadData);
...
int mixer3_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  mixer3_function_savePreSynchronous(data, threadData);
